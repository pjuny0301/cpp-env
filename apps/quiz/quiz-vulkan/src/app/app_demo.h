...
struct app_render_report {
    ...
    std::size_t image_texture_frame_entry_count = 0;
    std::size_t image_texture_resource_packet_count = 0;
    std::size_t image_texture_resource_ready_count = 0;
    std::size_t image_texture_quad_packet_count = 0;
    std::size_t image_texture_quad_ready_count = 0;
    ...
    bool image_texture_upload_result_available = false;
    bool image_texture_handoff_ready = true;
    bool image_texture_resource_packets_ready = true;
    bool image_texture_quad_packets_ready = true;
    bool image_texture_draw_payloads_ready = true;
