...
static_assert(requires(
    ...
    { render::render_image_checked_row_stride_byte_count(image) } -> std::same_as<std::size_t>;
    { render::make_render_image_texture_upload_payload_layout_evidence(key, key.sampler, image) }
...
static_assert(requires(
    ...
    render::render_image_texture_staging_payload_plan_diff_status staging_payload_diff_status,
    ...
    render::render_image_texture_staging_payload_plan_diff staging_payload_diff,
    ...
    render::render_image_texture_upload_payload_layout_evidence upload_payload_layout,
    ...
    render::render_image_texture_frame_binding_summary_status texture_frame_binding_summary_status,
    render::render_image_texture_frame_binding_summary texture_frame_binding_summary,
    render::render_image_texture_frame_binding_summary_diff texture_frame_binding_summary_diff,
    ...
    render::render_image_renderer_resource_packet_descriptor_status renderer_resource_packet_descriptor_status,
    render::render_image_renderer_resource_packet_bridge_status renderer_resource_packet_bridge_status,
    render::render_image_renderer_resource_packet_descriptor renderer_resource_packet_descriptor,
    render::render_image_renderer_resource_packet_bridge renderer_resource_packet_bridge,
    ...
    render::render_image_texture_frame_resource_upload_handoff_delta
        texture_frame_resource_upload_handoff_delta,
    render::render_image_texture_frame_resource_sampler_handoff_delta
        texture_frame_resource_sampler_handoff_delta,
    render::render_image_texture_frame_resource_materialization_entry_diff
        texture_frame_resource_materialization_entry_diff,
    render::render_image_texture_frame_resource_materialization_diff
        texture_frame_resource_materialization_diff,
    ...
    { render::render_image_texture_staging_payload_plan_status_name(staging_payload_status) }
        -> std::same_as<std::string>;
    { render::render_image_texture_staging_payload_plan_diff_status_name(staging_payload_diff_status) }
        -> std::same_as<std::string>;
    ...
    { render::render_image_texture_staging_payload_plan_size_delta(std::size_t{}, std::size_t{1}) }
        -> std::same_as<std::int64_t>;
    { render::make_render_image_texture_staging_payload_plan_diff(
        &staging_payload_plan, &staging_payload_plan) }
        -> std::same_as<render::render_image_texture_staging_payload_plan_diff>;
    { render::diff_render_image_texture_staging_payload_plans(
        staging_payload_plan, staging_payload_plan) }
        -> std::same_as<render::render_image_texture_staging_payload_plan_diff>;
    ...
    { staging_payload_diff.status }
        -> std::same_as<render::render_image_texture_staging_payload_plan_diff_status&>;
    { staging_payload_diff.status_name } -> std::same_as<std::string&>;
    { staging_payload_diff.before_present } -> std::same_as<bool&>;
    { staging_payload_diff.after_present } -> std::same_as<bool&>;
    { staging_payload_diff.before_plan_status }
        -> std::same_as<render::render_image_texture_staging_payload_plan_status&>;
    { staging_payload_diff.after_plan_status }
        -> std::same_as<render::render_image_texture_staging_payload_plan_status&>;
    { staging_payload_diff.before_plan_status_name } -> std::same_as<std::string&>;
    { staging_payload_diff.after_plan_status_name } -> std::same_as<std::string&>;
    { staging_payload_diff.before_stable_texture_cache_key } -> std::same_as<std::string&>;
    { staging_payload_diff.after_stable_texture_cache_key } -> std::same_as<std::string&>;
    { staging_payload_diff.before_sampler_summary } -> std::same_as<std::string&>;
    { staging_payload_diff.after_sampler_summary } -> std::same_as<std::string&>;
    { staging_payload_diff.before_row_copy_count } -> std::same_as<std::size_t&>;
    { staging_payload_diff.after_row_copy_count } -> std::same_as<std::size_t&>;
    { staging_payload_diff.row_copy_count_delta } -> std::same_as<std::int64_t&>;
    { staging_payload_diff.before_alignment_byte_count } -> std::same_as<std::size_t&>;
    { staging_payload_diff.after_alignment_byte_count } -> std::same_as<std::size_t&>;
    { staging_payload_diff.alignment_byte_delta } -> std::same_as<std::int64_t&>;
    { staging_payload_diff.before_total_row_padding_byte_count } -> std::same_as<std::size_t&>;
    { staging_payload_diff.after_total_row_padding_byte_count } -> std::same_as<std::size_t&>;
    { staging_payload_diff.row_padding_byte_delta } -> std::same_as<std::int64_t&>;
    { staging_payload_diff.before_total_staging_byte_count } -> std::same_as<std::size_t&>;
    { staging_payload_diff.after_total_staging_byte_count } -> std::same_as<std::size_t&>;
    { staging_payload_diff.total_staging_byte_delta } -> std::same_as<std::int64_t&>;
    { staging_payload_diff.before_mip_level_reference_count } -> std::same_as<std::size_t&>;
    { staging_payload_diff.after_mip_level_reference_count } -> std::same_as<std::size_t&>;
    { staging_payload_diff.mip_level_reference_delta } -> std::same_as<std::int64_t&>;
    { staging_payload_diff.before_ready } -> std::same_as<bool&>;
    { staging_payload_diff.after_ready } -> std::same_as<bool&>;
    { staging_payload_diff.before_blocked } -> std::same_as<bool&>;
    { staging_payload_diff.after_blocked } -> std::same_as<bool&>;
    { staging_payload_diff.before_mipmap_plan_ready } -> std::same_as<bool&>;
    { staging_payload_diff.after_mipmap_plan_ready } -> std::same_as<bool&>;
    { staging_payload_diff.before_mipmaps_referenced } -> std::same_as<bool&>;
    { staging_payload_diff.after_mipmaps_referenced } -> std::same_as<bool&>;
    { staging_payload_diff.before_blocker_summary } -> std::same_as<std::string&>;
    { staging_payload_diff.after_blocker_summary } -> std::same_as<std::string&>;
    { staging_payload_diff.row_copy_count_changed } -> std::same_as<bool&>;
    { staging_payload_diff.alignment_changed } -> std::same_as<bool&>;
    { staging_payload_diff.padding_changed } -> std::same_as<bool&>;
    { staging_payload_diff.total_staging_byte_count_changed } -> std::same_as<bool&>;
    { staging_payload_diff.cache_key_changed } -> std::same_as<bool&>;
    { staging_payload_diff.sampler_changed } -> std::same_as<bool&>;
    { staging_payload_diff.mip_level_readiness_changed } -> std::same_as<bool&>;
    { staging_payload_diff.blocker_changed } -> std::same_as<bool&>;
    { staging_payload_diff.ready_regressed } -> std::same_as<bool&>;
    ...
    texture_color_space;
    { upload_payload_layout.texture_key } -> std::same_as<render::render_image_texture_key&>;
    { upload_payload_layout.key_diagnostic } -> std::same_as<render::render_image_texture_key_diagnostic&>;
    { upload_payload_layout.sampler } -> std::same_as<render::render_image_sampler_policy&>;
    { upload_payload_layout.stable_texture_cache_key } -> std::same_as<std::string&>;
    { upload_payload_layout.sampler_summary } -> std::same_as<std::string&>;
    { upload_payload_layout.pixel_format } -> std::same_as<render::render_image_pixel_format&>;
    { upload_payload_layout.color_space } -> std::same_as<render::render_image_texture_color_space&>;
    { upload_payload_layout.color_space_name } -> std::same_as<std::string&>;
    { upload_payload_layout.extent_width } -> std::same_as<std::size_t&>;
    { upload_payload_layout.extent_height } -> std::same_as<std::size_t&>;
    { upload_payload_layout.bytes_per_pixel } -> std::same_as<std::size_t&>;
    { upload_payload_layout.row_stride_byte_count } -> std::same_as<std::size_t&>;
    { upload_payload_layout.pixel_count } -> std::same_as<std::size_t&>;
    { upload_payload_layout.expected_byte_count } -> std::same_as<std::size_t&>;
    { upload_payload_layout.decoded_byte_count } -> std::same_as<std::size_t&>;
    { upload_payload_layout.staging_byte_count } -> std::same_as<std::size_t&>;
    { upload_payload_layout.decoded_payload } -> std::same_as<render::render_image_decoded_payload_evidence&>;
    { upload_payload_layout.cache_key_valid } -> std::same_as<bool&>;
    { upload_payload_layout.sampler_valid } -> std::same_as<bool&>;
    { upload_payload_layout.sampler_matches_texture_key } -> std::same_as<bool&>;
    { upload_payload_layout.rgba8_format } -> std::same_as<bool&>;
    { upload_payload_layout.nonzero_extent } -> std::same_as<bool&>;
    { upload_payload_layout.row_stride_consistent } -> std::same_as<bool&>;
    { upload_payload_layout.byte_count_consistent } -> std::same_as<bool&>;
    { upload_payload_layout.staging_byte_count_consistent } -> std::same_as<bool&>;
    { upload_payload_layout.upload_layout_ready } -> std::same_as<bool&>;
    { upload_payload_layout.diagnostic } -> std::same_as<std::string&>;
    { upload_payload_layout.ok() } -> std::same_as<bool>;
    { render::render_image_texture_upload_payload_layout_evidence_equal(
        upload_payload_layout, upload_payload_layout) } -> std::same_as<bool>;
    ...
    { upload_readiness.upload_payload_layout }
        -> std::same_as<render::render_image_texture_upload_payload_layout_evidence&>;
    ...
    { upload_request_snapshot.decoded_payload }
    ...
    { upload_operation_packet.mipmap_upload_plan }
        -> std::same_as<render::render_image_texture_mipmap_upload_plan&>;
    { upload_operation_packet.decoded_payload }
        -> std::same_as<render::render_image_decoded_payload_evidence&>;
    ...
    { render::render_image_texture_upload_result_staging_payload_byte_count(
        upload_result_diagnostics_snapshot) } -> std::same_as<std::size_t>;
    ...
    { upload_result_packet.decoded_payload }
        -> std::same_as<render::render_image_decoded_payload_evidence&>;
    ...
    { upload_result_packet_diff.staging_payload_plan_diff }
        -> std::same_as<render::render_image_texture_staging_payload_plan_diff&>;
    ...
    { upload_result_packet_diff.before_staging_payload_byte_count } -> std::same_as<std::size_t&>;
    { upload_result_packet_diff.after_staging_payload_byte_count } -> std::same_as<std::size_t&>;
    { upload_result_packet_diff.staging_payload_byte_delta } -> std::same_as<std::int64_t&>;
    ...
    { upload_result_diagnostics_snapshot_diff.staging_payload_plan_changed_count }
        -> std::same_as<std::size_t&>;
    { upload_result_diagnostics_snapshot_diff.staging_row_copy_count_changed_count }
        -> std::same_as<std::size_t&>;
    { upload_result_diagnostics_snapshot_diff.staging_alignment_changed_count }
        -> std::same_as<std::size_t&>;
    { upload_result_diagnostics_snapshot_diff.staging_padding_changed_count }
        -> std::same_as<std::size_t&>;
    { upload_result_diagnostics_snapshot_diff.staging_byte_count_changed_count }
        -> std::same_as<std::size_t&>;
    { upload_result_diagnostics_snapshot_diff.staging_cache_key_changed_count }
        -> std::same_as<std::size_t&>;
    { upload_result_diagnostics_snapshot_diff.staging_sampler_changed_count }
        -> std::same_as<std::size_t&>;
    { upload_result_diagnostics_snapshot_diff.staging_mip_level_readiness_changed_count }
        -> std::same_as<std::size_t&>;
    { upload_result_diagnostics_snapshot_diff.staging_blocker_changed_count }
        -> std::same_as<std::size_t&>;
    { upload_result_diagnostics_snapshot_diff.staging_regression_count }
        -> std::same_as<std::size_t&>;
    { upload_result_diagnostics_snapshot_diff.staging_recovery_count }
        -> std::same_as<std::size_t&>;
    ...
    { upload_result_diagnostics_snapshot_diff.before_staging_payload_byte_count }
        -> std::same_as<std::size_t&>;
    { upload_result_diagnostics_snapshot_diff.after_staging_payload_byte_count }
        -> std::same_as<std::size_t&>;
    { upload_result_diagnostics_snapshot_diff.staging_payload_byte_delta }
        -> std::same_as<std::int64_t&>;
    ...
    { upload_result_diagnostics_snapshot_diff.staging_payload_summary } -> std::same_as<std::string&>;
    ...
    { render::diff_render_image_texture_frame_upload_handoff_summaries(
        ...
        -> std::same_as<render::render_image_texture_frame_upload_handoff_summary_diff>;
    { render::render_image_texture_frame_binding_summary_status_name(texture_frame_binding_summary_status) }
        -> std::same_as<std::string>;
    { render::render_image_texture_frame_binding_summary_status_for(texture_frame_upload_handoff) }
        -> std::same_as<render::render_image_texture_frame_binding_summary_status>;
    { render::make_render_image_texture_frame_binding_summary(texture_frame_upload_handoff) }
        -> std::same_as<render::render_image_texture_frame_binding_summary>;
    { render::make_render_image_texture_frame_binding_summary(texture_frame, upload_result_diagnostics_snapshot) }
        -> std::same_as<render::render_image_texture_frame_binding_summary>;
    { render::diff_render_image_texture_frame_binding_summaries(
        texture_frame_binding_summary, texture_frame_binding_summary) }
        -> std::same_as<render::render_image_texture_frame_binding_summary_diff>;
    { render::diff_render_image_texture_frame_binding_summaries(
        texture_frame_upload_handoff, texture_frame_upload_handoff) }
        -> std::same_as<render::render_image_texture_frame_binding_summary_diff>;
    { render::render_image_texture_frame_resource_packet_status_name(texture_frame_resource_packet_status) }
        -> std::same_as<std::string>;
    { render::render_image_texture_frame_resource_packet_status_is_blocked(texture_frame_resource_packet_status) }
        -> std::same_as<bool>;
    { render::render_image_texture_frame_resource_packet_status_is_bindable(texture_frame_resource_packet_status) }
        -> std::same_as<bool>;
    { render::render_image_texture_frame_resource_packet_status_for(texture_frame_upload_handoff_entry) }
        -> std::same_as<render::render_image_texture_frame_resource_packet_status>;
    { render::make_render_image_texture_frame_resource_packet_plan_entry(texture_frame_upload_handoff_entry) }
        -> std::same_as<render::render_image_texture_frame_resource_packet_plan_entry>;
    { render::count_render_image_texture_frame_resource_packet_plan_entry(
        texture_frame_resource_packet_plan, texture_frame_resource_packet_entry) }
        -> std::same_as<void>;
    { render::finalize_render_image_texture_frame_resource_packet_plan(
        texture_frame_resource_packet_plan, texture_frame_binding_summary) }
        -> std::same_as<void>;
    { render::make_render_image_texture_frame_resource_packet_plan(texture_frame_upload_handoff) }
    ...
    { render::make_render_image_renderer_texture_quad_draw_payload_frame(
        ...
        -> std::same_as<render::render_image_renderer_texture_quad_draw_payload_frame>;
    { render::render_image_renderer_resource_packet_descriptor_status_name(
        renderer_resource_packet_descriptor_status) } -> std::same_as<std::string>;
    { render::render_image_renderer_resource_packet_bridge_status_name(
        renderer_resource_packet_bridge_status) } -> std::same_as<std::string>;
    { render::render_image_renderer_resource_packet_identity_for(
        renderer_texture_quad_draw_payload) } -> std::same_as<std::string>;
    { render::render_image_renderer_resource_packet_descriptor_status_for(
        renderer_texture_quad_draw_payload, std::string{}, bool{}) }
        -> std::same_as<render::render_image_renderer_resource_packet_descriptor_status>;
    { render::make_render_image_renderer_resource_packet_descriptor(
        renderer_texture_quad_draw_payload, std::size_t{}, bool{}) }
        -> std::same_as<render::render_image_renderer_resource_packet_descriptor>;
    { render::count_render_image_renderer_resource_packet_descriptor(
        renderer_resource_packet_bridge, renderer_resource_packet_descriptor) }
        -> std::same_as<void>;
    { render::finalize_render_image_renderer_resource_packet_bridge(
        renderer_resource_packet_bridge) } -> std::same_as<void>;
    { render::make_render_image_renderer_resource_packet_bridge(renderer_texture_quad_draw_payload_frame) }
        -> std::same_as<render::render_image_renderer_resource_packet_bridge>;
    ...
    { render::apply_render_image_texture_frame_resource_packet_consumption_to_renderer_texture_quad_packet(
        renderer_texture_quad_packet, texture_frame_resource_packet_consumption_entry) }
        -> std::same_as<void>;
    { render::make_render_image_renderer_texture_quad_packet_summary_with_resource_consumption(
        renderer_texture_quad_packet_summary, texture_frame_resource_packet_consumption_summary) }
        -> std::same_as<render::render_image_renderer_texture_quad_packet_summary>;
    ...
    { render::append_render_image_texture_frame_resource_materialization_request_indexes(
        std::declval<std::map<std::size_t, bool>&>(), texture_frame_resource_packet_materialization) }
        -> std::same_as<void>;
    ...
    { render::render_image_texture_frame_resource_cache_handoff_record_equal(
        ...
        -> std::same_as<bool>;
    { render::render_image_texture_frame_resource_upload_handoff_record_equal(
        texture_frame_resource_upload_handoff, texture_frame_resource_upload_handoff) }
        -> std::same_as<bool>;
    { render::render_image_texture_frame_resource_sampler_handoff_record_equal(
        texture_frame_resource_sampler_handoff, texture_frame_resource_sampler_handoff) }
        -> std::same_as<bool>;
    { render::render_image_texture_frame_resource_materialization_entry_equal(
        texture_frame_resource_packet_materialization_entry,
        texture_frame_resource_packet_materialization_entry) } -> std::same_as<bool>;
    { render::make_render_image_texture_frame_resource_cache_handoff_delta(
        &texture_frame_resource_cache_handoff,
        &texture_frame_resource_cache_handoff,
        std::size_t{}) } -> std::same_as<render::render_image_texture_frame_resource_cache_handoff_delta>;
    { render::make_render_image_texture_frame_resource_upload_handoff_delta(
        &texture_frame_resource_upload_handoff,
        &texture_frame_resource_upload_handoff,
        std::size_t{}) } -> std::same_as<render::render_image_texture_frame_resource_upload_handoff_delta>;
    { render::make_render_image_texture_frame_resource_sampler_handoff_delta(
        &texture_frame_resource_sampler_handoff,
        &texture_frame_resource_sampler_handoff,
        std::size_t{}) } -> std::same_as<render::render_image_texture_frame_resource_sampler_handoff_delta>;
    { render::make_render_image_texture_frame_resource_materialization_entry_diff(
        &texture_frame_resource_packet_materialization_entry,
        &texture_frame_resource_packet_materialization_entry,
        std::size_t{}) } -> std::same_as<render::render_image_texture_frame_resource_materialization_entry_diff>;
    { render::count_render_image_texture_frame_resource_materialization_diff_entry(
        texture_frame_resource_materialization_diff,
        texture_frame_resource_materialization_entry_diff) } -> std::same_as<void>;
    { render::diff_render_image_texture_frame_resource_materializations(
        texture_frame_resource_packet_materialization,
        texture_frame_resource_packet_materialization) }
        -> std::same_as<render::render_image_texture_frame_resource_materialization_diff>;
    ...
    texture_frame_binding_summary_status;
    ...
    { texture_frame_upload_handoff_entry.decoded_payload }
        -> std::same_as<render::render_image_decoded_payload_evidence&>;
    ...
    { texture_frame_binding_summary.status }
        -> std::same_as<render::render_image_texture_frame_binding_summary_status&>;
    { texture_frame_binding_summary.status_name } -> std::same_as<std::string&>;
    { texture_frame_binding_summary.frame_request_count } -> std::same_as<std::size_t&>;
    { texture_frame_binding_summary.handoff_entry_count } -> std::same_as<std::size_t&>;
    { texture_frame_binding_summary.requested_texture_count } -> std::same_as<std::size_t&>;
    { texture_frame_binding_summary.upload_backed_count } -> std::same_as<std::size_t&>;
    { texture_frame_binding_summary.placeholder_backed_count } -> std::same_as<std::size_t&>;
    { texture_frame_binding_summary.missing_upload_result_count } -> std::same_as<std::size_t&>;
    { texture_frame_binding_summary.missing_frame_binding_count } -> std::same_as<std::size_t&>;
    { texture_frame_binding_summary.retry_backoff_blocked_count } -> std::same_as<std::size_t&>;
    { texture_frame_binding_summary.blocked_count } -> std::same_as<std::size_t&>;
    { texture_frame_binding_summary.cache_reused_count } -> std::same_as<std::size_t&>;
    { texture_frame_binding_summary.uploaded_byte_count } -> std::same_as<std::size_t&>;
    { texture_frame_binding_summary.mip_level_count } -> std::same_as<std::size_t&>;
    { texture_frame_binding_summary.max_retry_after_queue_sequence_delta } -> std::same_as<std::size_t&>;
    { texture_frame_binding_summary.next_retry_sequence } -> std::same_as<std::size_t&>;
    { texture_frame_binding_summary.fully_upload_backed } -> std::same_as<bool&>;
    { texture_frame_binding_summary.placeholder_backed } -> std::same_as<bool&>;
    { texture_frame_binding_summary.missing_upload_result } -> std::same_as<bool&>;
    { texture_frame_binding_summary.missing_frame_binding } -> std::same_as<bool&>;
    { texture_frame_binding_summary.retry_backoff_blocked } -> std::same_as<bool&>;
    { texture_frame_binding_summary.blocked } -> std::same_as<bool&>;
    { texture_frame_binding_summary.renderer_handoff_ready } -> std::same_as<bool&>;
    { texture_frame_binding_summary.cache_reused } -> std::same_as<bool&>;
    { texture_frame_binding_summary.cache_key_summary } -> std::same_as<std::string&>;
    { texture_frame_binding_summary.sampler_summary } -> std::same_as<std::string&>;
    { texture_frame_binding_summary.retry_backoff_summary } -> std::same_as<std::string&>;
    { texture_frame_binding_summary.diagnostic } -> std::same_as<std::string&>;
    { texture_frame_binding_summary.ok() } -> std::same_as<bool>;
    { texture_frame_binding_summary_diff.before_status }
        -> std::same_as<render::render_image_texture_frame_binding_summary_status&>;
    { texture_frame_binding_summary_diff.after_status }
        -> std::same_as<render::render_image_texture_frame_binding_summary_status&>;
    { texture_frame_binding_summary_diff.before_status_name } -> std::same_as<std::string&>;
    { texture_frame_binding_summary_diff.after_status_name } -> std::same_as<std::string&>;
    { texture_frame_binding_summary_diff.before_requested_texture_count } -> std::same_as<std::size_t&>;
    { texture_frame_binding_summary_diff.after_requested_texture_count } -> std::same_as<std::size_t&>;
    { texture_frame_binding_summary_diff.requested_texture_delta } -> std::same_as<std::int64_t&>;
    { texture_frame_binding_summary_diff.before_upload_backed_count } -> std::same_as<std::size_t&>;
    { texture_frame_binding_summary_diff.after_upload_backed_count } -> std::same_as<std::size_t&>;
    { texture_frame_binding_summary_diff.upload_backed_delta } -> std::same_as<std::int64_t&>;
    { texture_frame_binding_summary_diff.placeholder_backed_delta } -> std::same_as<std::int64_t&>;
    { texture_frame_binding_summary_diff.missing_upload_result_delta } -> std::same_as<std::int64_t&>;
    { texture_frame_binding_summary_diff.missing_frame_binding_delta } -> std::same_as<std::int64_t&>;
    { texture_frame_binding_summary_diff.retry_backoff_blocked_delta } -> std::same_as<std::int64_t&>;
    { texture_frame_binding_summary_diff.blocked_delta } -> std::same_as<std::int64_t&>;
    { texture_frame_binding_summary_diff.uploaded_byte_delta } -> std::same_as<std::int64_t&>;
    { texture_frame_binding_summary_diff.status_changed } -> std::same_as<bool&>;
    { texture_frame_binding_summary_diff.upload_backing_changed } -> std::same_as<bool&>;
    { texture_frame_binding_summary_diff.placeholder_backing_changed } -> std::same_as<bool&>;
    { texture_frame_binding_summary_diff.missing_upload_result_changed } -> std::same_as<bool&>;
    { texture_frame_binding_summary_diff.missing_frame_binding_changed } -> std::same_as<bool&>;
    { texture_frame_binding_summary_diff.retry_backoff_changed } -> std::same_as<bool&>;
    { texture_frame_binding_summary_diff.blocker_changed } -> std::same_as<bool&>;
    { texture_frame_binding_summary_diff.cache_key_summary_changed } -> std::same_as<bool&>;
    { texture_frame_binding_summary_diff.sampler_summary_changed } -> std::same_as<bool&>;
    { texture_frame_binding_summary_diff.cache_key_or_sampler_changed } -> std::same_as<bool&>;
    { texture_frame_binding_summary_diff.has_changes } -> std::same_as<bool&>;
    { texture_frame_binding_summary_diff.has_regression } -> std::same_as<bool&>;
    { texture_frame_binding_summary_diff.changed_summary } -> std::same_as<std::string&>;
    { texture_frame_binding_summary_diff.regression_summary } -> std::same_as<std::string&>;
    { texture_frame_binding_summary_diff.diagnostic } -> std::same_as<std::string&>;
    { texture_frame_binding_summary_diff.ok() } -> std::same_as<bool>;
    { texture_frame_resource_packet_entry.request_index } -> std::same_as<std::size_t&>;
    { texture_frame_resource_packet_entry.status }
        -> std::same_as<render::render_image_texture_frame_resource_packet_status&>;
    { texture_frame_resource_packet_entry.status_name } -> std::same_as<std::string&>;
    { texture_frame_resource_packet_entry.handoff_status }
        -> std::same_as<render::render_image_texture_frame_upload_handoff_entry_status&>;
    { texture_frame_resource_packet_entry.render_image_uri } -> std::same_as<std::string&>;
    { texture_frame_resource_packet_entry.normalized_uri } -> std::same_as<std::string&>;
    { texture_frame_resource_packet_entry.cache_key } -> std::same_as<render::render_image_cache_key&>;
    { texture_frame_resource_packet_entry.sampler } -> std::same_as<render::render_image_sampler_policy&>;
    { texture_frame_resource_packet_entry.sampler_key } -> std::same_as<std::string&>;
    { texture_frame_resource_packet_entry.texture_key } -> std::same_as<render::render_image_texture_key&>;
    { texture_frame_resource_packet_entry.stable_texture_cache_key } -> std::same_as<std::string&>;
    { texture_frame_resource_packet_entry.texture_id } -> std::same_as<render::render_image_texture_id&>;
    { texture_frame_resource_packet_entry.texture_revision } -> std::same_as<render::render_image_revision&>;
    { texture_frame_resource_packet_entry.upload_request_id } -> std::same_as<std::uint64_t&>;
    { texture_frame_resource_packet_entry.upload_generation_id } -> std::same_as<std::uint64_t&>;
    { texture_frame_resource_packet_entry.mip_level_count } -> std::same_as<std::size_t&>;
    { texture_frame_resource_packet_entry.uploaded_byte_count } -> std::same_as<std::size_t&>;
    { texture_frame_resource_packet_entry.decoded_payload }
        -> std::same_as<render::render_image_decoded_payload_evidence&>;
    ...
    { texture_frame_resource_packet_entry.placeholder_backed } -> std::same_as<bool&>;
    { texture_frame_resource_packet_entry.blocked } -> std::same_as<bool&>;
    { texture_frame_resource_packet_entry.missing_upload_result } -> std::same_as<bool&>;
    { texture_frame_resource_packet_entry.missing_frame_binding } -> std::same_as<bool&>;
    { texture_frame_resource_packet_entry.retry_backoff_blocked } -> std::same_as<bool&>;
    { texture_frame_resource_packet_entry.renderer_handoff_ready } -> std::same_as<bool&>;
    { texture_frame_resource_packet_entry.cache_reused } -> std::same_as<bool&>;
    { texture_frame_resource_packet_entry.retry_after_queue_sequence_delta } -> std::same_as<std::size_t&>;
    { texture_frame_resource_packet_entry.next_retry_sequence } -> std::same_as<std::size_t&>;
    { texture_frame_resource_packet_entry.cache_key_summary } -> std::same_as<std::string&>;
    { texture_frame_resource_packet_entry.sampler_summary } -> std::same_as<std::string&>;
    { texture_frame_resource_packet_entry.retry_backoff_summary } -> std::same_as<std::string&>;
    { texture_frame_resource_packet_entry.diagnostic } -> std::same_as<std::string&>;
    { texture_frame_resource_packet_entry.ok() } -> std::same_as<bool>;
    { texture_frame_resource_packet_plan.binding_status }
        -> std::same_as<render::render_image_texture_frame_binding_summary_status&>;
    { texture_frame_resource_packet_plan.binding_status_name } -> std::same_as<std::string&>;
    { texture_frame_resource_packet_plan.frame_request_count } -> std::same_as<std::size_t&>;
    { texture_frame_resource_packet_plan.handoff_entry_count } -> std::same_as<std::size_t&>;
    { texture_frame_resource_packet_plan.requested_texture_count } -> std::same_as<std::size_t&>;
    { texture_frame_resource_packet_plan.bindable_packet_count } -> std::same_as<std::size_t&>;
    { texture_frame_resource_packet_plan.resource_packet_count } -> std::same_as<std::size_t&>;
    { texture_frame_resource_packet_plan.placeholder_backed_packet_count } -> std::same_as<std::size_t&>;
    { texture_frame_resource_packet_plan.blocked_packet_count } -> std::same_as<std::size_t&>;
    { texture_frame_resource_packet_plan.missing_upload_result_packet_count } -> std::same_as<std::size_t&>;
    { texture_frame_resource_packet_plan.missing_frame_binding_packet_count } -> std::same_as<std::size_t&>;
    { texture_frame_resource_packet_plan.retry_backoff_blocked_packet_count } -> std::same_as<std::size_t&>;
    { texture_frame_resource_packet_plan.unique_texture_cache_key_count } -> std::same_as<std::size_t&>;
    { texture_frame_resource_packet_plan.unique_sampler_key_count } -> std::same_as<std::size_t&>;
    { texture_frame_resource_packet_plan.resource_binding_ready } -> std::same_as<bool&>;
    { texture_frame_resource_packet_plan.fully_resource_backed } -> std::same_as<bool&>;
    { texture_frame_resource_packet_plan.placeholder_backed } -> std::same_as<bool&>;
    { texture_frame_resource_packet_plan.has_blockers } -> std::same_as<bool&>;
    { texture_frame_resource_packet_plan.has_retry_backoff } -> std::same_as<bool&>;
    { texture_frame_resource_packet_plan.renderer_handoff_ready } -> std::same_as<bool&>;
    { texture_frame_resource_packet_plan.entries }
        -> std::same_as<std::vector<render::render_image_texture_frame_resource_packet_plan_entry>&>;
    { texture_frame_resource_packet_plan.cache_key_summary } -> std::same_as<std::string&>;
    { texture_frame_resource_packet_plan.sampler_summary } -> std::same_as<std::string&>;
    ...
    { draw_list_texture_frame_composition_entry.decoded_payload_hash } -> std::same_as<std::uint64_t&>;
    { draw_list_texture_frame_composition_entry.decoded_byte_count } -> std::same_as<std::size_t&>;
    { draw_list_texture_frame_composition_entry.upload_layout_byte_count } -> std::same_as<std::size_t&>;
    { draw_list_texture_frame_composition_entry.upload_layout_row_stride_byte_count }
        -> std::same_as<std::size_t&>;
    { draw_list_texture_frame_composition_entry.staging_payload_byte_count } -> std::same_as<std::size_t&>;
    { draw_list_texture_frame_composition_entry.staging_row_copy_count } -> std::same_as<std::size_t&>;
    ...
    { draw_list_texture_frame_composition_entry.decoded_resource_evidence_present } -> std::same_as<bool&>;
    { draw_list_texture_frame_composition_entry.decoded_payload_valid } -> std::same_as<bool&>;
    { draw_list_texture_frame_composition_entry.upload_payload_layout_ready } -> std::same_as<bool&>;
    { draw_list_texture_frame_composition_entry.staging_payload_ready } -> std::same_as<bool&>;
    { draw_list_texture_frame_composition_entry.decoded_resource_ready } -> std::same_as<bool&>;
    { draw_list_texture_frame_composition_entry.decoded_resource_blocked } -> std::same_as<bool&>;
    ...
    { draw_list_texture_frame_composition_entry.decoded_resource_summary } -> std::same_as<std::string&>;
    { draw_list_texture_frame_composition_entry.decoded_resource_blocker_summary }
        -> std::same_as<std::string&>;
    ...
    { draw_list_texture_frame_composition.decoded_resource_ready_count } -> std::same_as<std::size_t&>;
    { draw_list_texture_frame_composition.decoded_resource_blocked_count } -> std::same_as<std::size_t&>;
    { draw_list_texture_frame_composition.decoded_payload_hash_count } -> std::same_as<std::size_t&>;
    { draw_list_texture_frame_composition.decoded_payload_byte_count } -> std::same_as<std::size_t&>;
    { draw_list_texture_frame_composition.staging_payload_byte_count } -> std::same_as<std::size_t&>;
    ...
    { draw_list_texture_frame_composition.has_decoded_resource_blockers } -> std::same_as<bool&>;
    ...
    { draw_list_texture_frame_composition.decoded_resource_summary } -> std::same_as<std::string&>;
    { draw_list_texture_frame_composition.decoded_resource_blocker_summary } -> std::same_as<std::string&>;
    ...
    { renderer_texture_quad_packet.decoded_payload_hash } -> std::same_as<std::uint64_t&>;
    { renderer_texture_quad_packet.decoded_byte_count } -> std::same_as<std::size_t&>;
    { renderer_texture_quad_packet.upload_layout_byte_count } -> std::same_as<std::size_t&>;
    { renderer_texture_quad_packet.upload_layout_row_stride_byte_count } -> std::same_as<std::size_t&>;
    { renderer_texture_quad_packet.staging_payload_byte_count } -> std::same_as<std::size_t&>;
    { renderer_texture_quad_packet.staging_row_copy_count } -> std::same_as<std::size_t&>;
    ...
    { renderer_texture_quad_packet.decoded_resource_evidence_present } -> std::same_as<bool&>;
    { renderer_texture_quad_packet.decoded_payload_valid } -> std::same_as<bool&>;
    { renderer_texture_quad_packet.upload_payload_layout_ready } -> std::same_as<bool&>;
    { renderer_texture_quad_packet.staging_payload_ready } -> std::same_as<bool&>;
    { renderer_texture_quad_packet.decoded_resource_ready } -> std::same_as<bool&>;
    { renderer_texture_quad_packet.decoded_resource_blocked } -> std::same_as<bool&>;
    ...
    { renderer_texture_quad_packet.decoded_resource_summary } -> std::same_as<std::string&>;
    { renderer_texture_quad_packet.decoded_resource_blocker_summary } -> std::same_as<std::string&>;
    ...
    { renderer_texture_quad_packet_summary.decoded_resource_evidence_count } -> std::same_as<std::size_t&>;
    { renderer_texture_quad_packet_summary.decoded_resource_ready_count } -> std::same_as<std::size_t&>;
    { renderer_texture_quad_packet_summary.decoded_resource_blocked_count } -> std::same_as<std::size_t&>;
    { renderer_texture_quad_packet_summary.decoded_payload_hash_count } -> std::same_as<std::size_t&>;
    { renderer_texture_quad_packet_summary.decoded_payload_byte_count } -> std::same_as<std::size_t&>;
    { renderer_texture_quad_packet_summary.upload_layout_byte_count } -> std::same_as<std::size_t&>;
    { renderer_texture_quad_packet_summary.staging_payload_byte_count } -> std::same_as<std::size_t&>;
    ...
    { renderer_texture_quad_packet_summary.has_decoded_resource_blockers } -> std::same_as<bool&>;
    ...
    { renderer_texture_quad_packet_summary.decoded_resource_summary } -> std::same_as<std::string&>;
    { renderer_texture_quad_packet_summary.decoded_resource_blocker_summary } -> std::same_as<std::string&>;
    ...
    { renderer_texture_quad_packet_diff_entry.before_decoded_payload_hash } -> std::same_as<std::uint64_t&>;
    { renderer_texture_quad_packet_diff_entry.after_decoded_payload_hash } -> std::same_as<std::uint64_t&>;
    { renderer_texture_quad_packet_diff_entry.before_decoded_byte_count } -> std::same_as<std::size_t&>;
    { renderer_texture_quad_packet_diff_entry.after_decoded_byte_count } -> std::same_as<std::size_t&>;
    { renderer_texture_quad_packet_diff_entry.decoded_byte_delta } -> std::same_as<std::int64_t&>;
    { renderer_texture_quad_packet_diff_entry.before_upload_layout_byte_count }
        -> std::same_as<std::size_t&>;
    { renderer_texture_quad_packet_diff_entry.after_upload_layout_byte_count }
        -> std::same_as<std::size_t&>;
    { renderer_texture_quad_packet_diff_entry.upload_layout_byte_delta } -> std::same_as<std::int64_t&>;
    { renderer_texture_quad_packet_diff_entry.before_staging_payload_byte_count }
        -> std::same_as<std::size_t&>;
    { renderer_texture_quad_packet_diff_entry.after_staging_payload_byte_count }
        -> std::same_as<std::size_t&>;
    { renderer_texture_quad_packet_diff_entry.staging_payload_byte_delta } -> std::same_as<std::int64_t&>;
    ...
    { renderer_texture_quad_packet_diff_entry.before_decoded_resource_ready } -> std::same_as<bool&>;
    { renderer_texture_quad_packet_diff_entry.after_decoded_resource_ready } -> std::same_as<bool&>;
    { renderer_texture_quad_packet_diff_entry.before_decoded_resource_blocked } -> std::same_as<bool&>;
    { renderer_texture_quad_packet_diff_entry.after_decoded_resource_blocked } -> std::same_as<bool&>;
    ...
    { renderer_texture_quad_packet_diff_entry.decoded_payload_hash_changed } -> std::same_as<bool&>;
    { renderer_texture_quad_packet_diff_entry.decoded_byte_count_changed } -> std::same_as<bool&>;
    { renderer_texture_quad_packet_diff_entry.upload_layout_byte_count_changed } -> std::same_as<bool&>;
    { renderer_texture_quad_packet_diff_entry.staging_payload_byte_count_changed } -> std::same_as<bool&>;
    { renderer_texture_quad_packet_diff_entry.decoded_resource_readiness_changed } -> std::same_as<bool&>;
    { renderer_texture_quad_packet_diff_entry.decoded_resource_blocker_changed } -> std::same_as<bool&>;
    ...
    { renderer_texture_quad_packet_diff_entry.before_decoded_resource_blocker_summary }
        -> std::same_as<std::string&>;
    { renderer_texture_quad_packet_diff_entry.after_decoded_resource_blocker_summary }
        -> std::same_as<std::string&>;
    ...
    { renderer_texture_quad_packet_summary_diff.uploaded_byte_count_changed_count }
        -> std::same_as<std::size_t&>;
    { renderer_texture_quad_packet_summary_diff.decoded_payload_hash_changed_count }
        -> std::same_as<std::size_t&>;
    { renderer_texture_quad_packet_summary_diff.decoded_byte_count_changed_count }
        -> std::same_as<std::size_t&>;
    { renderer_texture_quad_packet_summary_diff.upload_layout_byte_count_changed_count }
        -> std::same_as<std::size_t&>;
    { renderer_texture_quad_packet_summary_diff.staging_payload_byte_count_changed_count }
        -> std::same_as<std::size_t&>;
    { renderer_texture_quad_packet_summary_diff.decoded_resource_readiness_changed_count }
        -> std::same_as<std::size_t&>;
    { renderer_texture_quad_packet_summary_diff.decoded_resource_blocker_changed_count }
        -> std::same_as<std::size_t&>;
    ...
    { renderer_texture_quad_packet_summary_diff.has_decoded_resource_changes } -> std::same_as<bool&>;
    ...
    { renderer_texture_quad_packet_summary_diff.decoded_resource_change_summary } -> std::same_as<std::string&>;
    ...
    { renderer_texture_quad_draw_payload.decoded_payload_hash } -> std::same_as<std::uint64_t&>;
    { renderer_texture_quad_draw_payload.decoded_byte_count } -> std::same_as<std::size_t&>;
    { renderer_texture_quad_draw_payload.upload_layout_byte_count } -> std::same_as<std::size_t&>;
    { renderer_texture_quad_draw_payload.upload_layout_row_stride_byte_count } -> std::same_as<std::size_t&>;
    { renderer_texture_quad_draw_payload.staging_payload_byte_count } -> std::same_as<std::size_t&>;
    { renderer_texture_quad_draw_payload.staging_row_copy_count } -> std::same_as<std::size_t&>;
    ...
    { renderer_texture_quad_draw_payload.decoded_resource_evidence_present } -> std::same_as<bool&>;
    { renderer_texture_quad_draw_payload.decoded_payload_valid } -> std::same_as<bool&>;
    { renderer_texture_quad_draw_payload.upload_payload_layout_ready } -> std::same_as<bool&>;
    { renderer_texture_quad_draw_payload.staging_payload_ready } -> std::same_as<bool&>;
    { renderer_texture_quad_draw_payload.decoded_resource_ready } -> std::same_as<bool&>;
    { renderer_texture_quad_draw_payload.decoded_resource_blocked } -> std::same_as<bool&>;
    ...
    { renderer_texture_quad_draw_payload.decoded_resource_summary } -> std::same_as<std::string&>;
    { renderer_texture_quad_draw_payload.decoded_resource_blocker_summary } -> std::same_as<std::string&>;
    ...
    { renderer_texture_quad_draw_payload_frame.decoded_resource_evidence_payload_count }
        -> std::same_as<std::size_t&>;
    { renderer_texture_quad_draw_payload_frame.decoded_resource_ready_payload_count }
        -> std::same_as<std::size_t&>;
    { renderer_texture_quad_draw_payload_frame.decoded_resource_blocked_payload_count }
        -> std::same_as<std::size_t&>;
    { renderer_texture_quad_draw_payload_frame.decoded_payload_hash_count } -> std::same_as<std::size_t&>;
    { renderer_texture_quad_draw_payload_frame.decoded_payload_byte_count } -> std::same_as<std::size_t&>;
    { renderer_texture_quad_draw_payload_frame.upload_layout_byte_count } -> std::same_as<std::size_t&>;
    { renderer_texture_quad_draw_payload_frame.staging_payload_byte_count } -> std::same_as<std::size_t&>;
    ...
    { renderer_texture_quad_draw_payload_frame.has_decoded_resource_blockers } -> std::same_as<bool&>;
    ...
    { renderer_texture_quad_draw_payload_frame.decoded_resource_summary } -> std::same_as<std::string&>;
    { renderer_texture_quad_draw_payload_frame.decoded_resource_blocker_summary } -> std::same_as<std::string&>;
    ...
    { renderer_resource_packet_descriptor.descriptor_index } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_descriptor.source_payload_index } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_descriptor.source_packet_index } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_descriptor.frame_label } -> std::same_as<std::string&>;
    { renderer_resource_packet_descriptor.draw_command_index } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_descriptor.image_command_index } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_descriptor.texture_request_index } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_descriptor.node_id } -> std::same_as<render::render_node_id&>;
    { renderer_resource_packet_descriptor.parent_node_id } -> std::same_as<render::render_node_id&>;
    { renderer_resource_packet_descriptor.bounds } -> std::same_as<render::render_rect&>;
    { renderer_resource_packet_descriptor.content_bounds } -> std::same_as<render::render_rect&>;
    { renderer_resource_packet_descriptor.uri } -> std::same_as<std::string&>;
    { renderer_resource_packet_descriptor.alt_text } -> std::same_as<std::string&>;
    { renderer_resource_packet_descriptor.aspect_ratio } -> std::same_as<float&>;
    { renderer_resource_packet_descriptor.stable_draw_command_identity } -> std::same_as<std::string&>;
    { renderer_resource_packet_descriptor.stable_quad_packet_identity } -> std::same_as<std::string&>;
    { renderer_resource_packet_descriptor.texture_key } -> std::same_as<render::render_image_texture_key&>;
    { renderer_resource_packet_descriptor.placeholder_key } -> std::same_as<render::render_image_texture_key&>;
    { renderer_resource_packet_descriptor.stable_payload_identity } -> std::same_as<std::string&>;
    { renderer_resource_packet_descriptor.stable_resource_packet_identity } -> std::same_as<std::string&>;
    { renderer_resource_packet_descriptor.stable_texture_cache_key } -> std::same_as<std::string&>;
    { renderer_resource_packet_descriptor.upload_cache_stable_cache_key } -> std::same_as<std::string&>;
    { renderer_resource_packet_descriptor.upload_cache_requested_stable_cache_key }
        -> std::same_as<std::string&>;
    { renderer_resource_packet_descriptor.sampler } -> std::same_as<render::render_image_sampler_policy&>;
    { renderer_resource_packet_descriptor.sampler_key } -> std::same_as<std::string&>;
    { renderer_resource_packet_descriptor.texture_id } -> std::same_as<render::render_image_texture_id&>;
    { renderer_resource_packet_descriptor.texture_revision } -> std::same_as<render::render_image_revision&>;
    { renderer_resource_packet_descriptor.texture_width } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_descriptor.texture_height } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_descriptor.upload_request_id } -> std::same_as<std::uint64_t&>;
    { renderer_resource_packet_descriptor.upload_generation_id } -> std::same_as<std::uint64_t&>;
    { renderer_resource_packet_descriptor.uploaded_byte_count } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_descriptor.decoded_payload_hash } -> std::same_as<std::uint64_t&>;
    { renderer_resource_packet_descriptor.decoded_byte_count } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_descriptor.upload_layout_byte_count } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_descriptor.upload_layout_row_stride_byte_count } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_descriptor.staging_payload_byte_count } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_descriptor.staging_row_copy_count } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_descriptor.upload_cache_decoded_byte_count } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_descriptor.upload_cache_staging_byte_count } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_descriptor.upload_cache_uploaded_byte_count } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_descriptor.upload_cache_decoded_payload_hash } -> std::same_as<std::uint64_t&>;
    { renderer_resource_packet_descriptor.upload_cache_placeholder_reason }
        -> std::same_as<render::fake_image_texture_placeholder_reason&>;
    { renderer_resource_packet_descriptor.upload_cache_placeholder_reason_name } -> std::same_as<std::string&>;
    { renderer_resource_packet_descriptor.source_packet_status }
        -> std::same_as<render::render_image_renderer_texture_quad_packet_status&>;
    { renderer_resource_packet_descriptor.source_packet_status_name } -> std::same_as<std::string&>;
    { renderer_resource_packet_descriptor.resource_packet_status }
        -> std::same_as<render::render_image_texture_frame_resource_packet_status&>;
    { renderer_resource_packet_descriptor.resource_packet_status_name } -> std::same_as<std::string&>;
    { renderer_resource_packet_descriptor.source_payload_status }
        -> std::same_as<render::render_image_renderer_texture_quad_draw_payload_status&>;
    { renderer_resource_packet_descriptor.source_payload_status_name } -> std::same_as<std::string&>;
    { renderer_resource_packet_descriptor.upload_cache_payload_status }
        -> std::same_as<render::render_image_texture_pipeline_upload_cache_payload_status&>;
    { renderer_resource_packet_descriptor.upload_cache_payload_status_name } -> std::same_as<std::string&>;
    { renderer_resource_packet_descriptor.status }
        -> std::same_as<render::render_image_renderer_resource_packet_descriptor_status&>;
    { renderer_resource_packet_descriptor.status_name } -> std::same_as<std::string&>;
    { renderer_resource_packet_descriptor.renderer_ready } -> std::same_as<bool&>;
    { renderer_resource_packet_descriptor.real_texture } -> std::same_as<bool&>;
    { renderer_resource_packet_descriptor.placeholder_backed } -> std::same_as<bool&>;
    { renderer_resource_packet_descriptor.fallback_placeholder } -> std::same_as<bool&>;
    { renderer_resource_packet_descriptor.blocked } -> std::same_as<bool&>;
    { renderer_resource_packet_descriptor.missing_payload_identity } -> std::same_as<bool&>;
    { renderer_resource_packet_descriptor.duplicate_packet_identity } -> std::same_as<bool&>;
    { renderer_resource_packet_descriptor.decoded_resource_evidence_present } -> std::same_as<bool&>;
    { renderer_resource_packet_descriptor.decoded_payload_valid } -> std::same_as<bool&>;
    { renderer_resource_packet_descriptor.upload_payload_layout_ready } -> std::same_as<bool&>;
    { renderer_resource_packet_descriptor.staging_payload_ready } -> std::same_as<bool&>;
    { renderer_resource_packet_descriptor.decoded_resource_ready } -> std::same_as<bool&>;
    { renderer_resource_packet_descriptor.decoded_resource_blocked } -> std::same_as<bool&>;
    { renderer_resource_packet_descriptor.upload_cache_payload_evidence_present } -> std::same_as<bool&>;
    { renderer_resource_packet_descriptor.upload_cache_payload_identity_matched } -> std::same_as<bool&>;
    { renderer_resource_packet_descriptor.upload_cache_payload_ready } -> std::same_as<bool&>;
    { renderer_resource_packet_descriptor.upload_cache_placeholder_backed } -> std::same_as<bool&>;
    { renderer_resource_packet_descriptor.upload_cache_payload_blocked } -> std::same_as<bool&>;
    { renderer_resource_packet_descriptor.blocker_summary } -> std::same_as<std::string&>;
    { renderer_resource_packet_descriptor.decoded_resource_summary } -> std::same_as<std::string&>;
    { renderer_resource_packet_descriptor.decoded_resource_blocker_summary } -> std::same_as<std::string&>;
    { renderer_resource_packet_descriptor.upload_cache_payload_summary } -> std::same_as<std::string&>;
    { renderer_resource_packet_descriptor.upload_cache_payload_blocker_summary } -> std::same_as<std::string&>;
    { renderer_resource_packet_descriptor.diagnostic } -> std::same_as<std::string&>;
    { renderer_resource_packet_descriptor.ok() } -> std::same_as<bool>;
    { renderer_resource_packet_bridge.status }
        -> std::same_as<render::render_image_renderer_resource_packet_bridge_status&>;
    { renderer_resource_packet_bridge.status_name } -> std::same_as<std::string&>;
    { renderer_resource_packet_bridge.frame_label } -> std::same_as<std::string&>;
    { renderer_resource_packet_bridge.source_packet_count } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_bridge.source_payload_count } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_bridge.packet_count } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_bridge.ready_packet_count } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_bridge.placeholder_packet_count } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_bridge.fallback_placeholder_packet_count } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_bridge.blocked_packet_count } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_bridge.missing_payload_identity_count } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_bridge.duplicate_packet_identity_count } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_bridge.decoded_resource_evidence_packet_count } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_bridge.decoded_resource_ready_packet_count } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_bridge.decoded_resource_blocked_packet_count } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_bridge.upload_cache_payload_evidence_packet_count } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_bridge.upload_cache_payload_ready_packet_count } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_bridge.upload_cache_placeholder_packet_count } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_bridge.upload_cache_payload_blocked_packet_count } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_bridge.decoded_payload_hash_count } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_bridge.upload_cache_payload_hash_count } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_bridge.decoded_byte_count } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_bridge.staging_payload_byte_count } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_bridge.uploaded_byte_count } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_bridge.upload_cache_decoded_byte_count } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_bridge.upload_cache_staging_byte_count } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_bridge.upload_cache_uploaded_byte_count } -> std::same_as<std::size_t&>;
    { renderer_resource_packet_bridge.renderer_resource_packets_ready } -> std::same_as<bool&>;
    { renderer_resource_packet_bridge.has_placeholders } -> std::same_as<bool&>;
    { renderer_resource_packet_bridge.has_fallback_placeholders } -> std::same_as<bool&>;
    { renderer_resource_packet_bridge.has_blockers } -> std::same_as<bool&>;
    { renderer_resource_packet_bridge.has_duplicate_packet_identities } -> std::same_as<bool&>;
    { renderer_resource_packet_bridge.packets }
        -> std::same_as<std::vector<render::render_image_renderer_resource_packet_descriptor>&>;
    { renderer_resource_packet_bridge.resource_packet_identity_summary } -> std::same_as<std::string&>;
    { renderer_resource_packet_bridge.texture_cache_key_summary } -> std::same_as<std::string&>;
    { renderer_resource_packet_bridge.sampler_summary } -> std::same_as<std::string&>;
    { renderer_resource_packet_bridge.blocker_summary } -> std::same_as<std::string&>;
    { renderer_resource_packet_bridge.decoded_resource_summary } -> std::same_as<std::string&>;
    { renderer_resource_packet_bridge.decoded_resource_blocker_summary } -> std::same_as<std::string&>;
    { renderer_resource_packet_bridge.upload_cache_payload_summary } -> std::same_as<std::string&>;
    { renderer_resource_packet_bridge.upload_cache_payload_blocker_summary } -> std::same_as<std::string&>;
    { renderer_resource_packet_bridge.diagnostic } -> std::same_as<std::string&>;
    { renderer_resource_packet_bridge.ok() } -> std::same_as<bool>;
    ...
    { texture_frame_resource_upload_handoff.decoded_payload }
        -> std::same_as<render::render_image_decoded_payload_evidence&>;
    ...
    { texture_frame_resource_cache_handoff_delta.before_stable_texture_cache_key }
        -> std::same_as<std::string&>;
    { texture_frame_resource_cache_handoff_delta.after_stable_texture_cache_key }
        -> std::same_as<std::string&>;
    { texture_frame_resource_cache_handoff_delta.before_texture_id }
        -> std::same_as<render::render_image_texture_id&>;
    { texture_frame_resource_cache_handoff_delta.after_texture_id }
        -> std::same_as<render::render_image_texture_id&>;
    { texture_frame_resource_cache_handoff_delta.stable_texture_cache_key_changed }
        -> std::same_as<bool&>;
    { texture_frame_resource_cache_handoff_delta.texture_handle_changed } -> std::same_as<bool&>;
    { texture_frame_resource_cache_handoff_delta.changed } -> std::same_as<bool&>;
    { texture_frame_resource_cache_handoff_delta.diagnostic } -> std::same_as<std::string&>;
    { texture_frame_resource_cache_handoff_delta.ok() } -> std::same_as<bool>;
    { texture_frame_resource_upload_handoff_delta.request_index } -> std::same_as<std::size_t&>;
    { texture_frame_resource_upload_handoff_delta.before_upload_request_id }
        -> std::same_as<std::uint64_t&>;
    { texture_frame_resource_upload_handoff_delta.after_upload_request_id }
        -> std::same_as<std::uint64_t&>;
    { texture_frame_resource_upload_handoff_delta.upload_request_changed } -> std::same_as<bool&>;
    { texture_frame_resource_upload_handoff_delta.uploaded_byte_delta } -> std::same_as<std::int64_t&>;
    { texture_frame_resource_upload_handoff_delta.changed } -> std::same_as<bool&>;
    { texture_frame_resource_upload_handoff_delta.diagnostic } -> std::same_as<std::string&>;
    { texture_frame_resource_upload_handoff_delta.ok() } -> std::same_as<bool>;
    { texture_frame_resource_sampler_handoff_delta.request_index } -> std::same_as<std::size_t&>;
    { texture_frame_resource_sampler_handoff_delta.before_sampler }
        -> std::same_as<render::render_image_sampler_policy&>;
    { texture_frame_resource_sampler_handoff_delta.after_sampler }
        -> std::same_as<render::render_image_sampler_policy&>;
    { texture_frame_resource_sampler_handoff_delta.before_sampler_summary } -> std::same_as<std::string&>;
    { texture_frame_resource_sampler_handoff_delta.after_sampler_summary } -> std::same_as<std::string&>;
    { texture_frame_resource_sampler_handoff_delta.sampler_changed } -> std::same_as<bool&>;
    { texture_frame_resource_sampler_handoff_delta.sampler_key_changed } -> std::same_as<bool&>;
    { texture_frame_resource_sampler_handoff_delta.changed } -> std::same_as<bool&>;
    { texture_frame_resource_sampler_handoff_delta.diagnostic } -> std::same_as<std::string&>;
    { texture_frame_resource_sampler_handoff_delta.ok() } -> std::same_as<bool>;
    { texture_frame_resource_materialization_entry_diff.request_index } -> std::same_as<std::size_t&>;
    { texture_frame_resource_materialization_entry_diff.status }
        -> std::same_as<render::render_image_texture_frame_resource_materialization_diff_entry_status&>;
    { texture_frame_resource_materialization_entry_diff.status_name } -> std::same_as<std::string&>;
    { texture_frame_resource_materialization_entry_diff.before_present } -> std::same_as<bool&>;
    { texture_frame_resource_materialization_entry_diff.after_present } -> std::same_as<bool&>;
    { texture_frame_resource_materialization_entry_diff.before_materialization_status }
        -> std::same_as<render::render_image_texture_frame_resource_packet_materialization_status&>;
    { texture_frame_resource_materialization_entry_diff.after_materialization_status }
        -> std::same_as<render::render_image_texture_frame_resource_packet_materialization_status&>;
    { texture_frame_resource_materialization_entry_diff.cache_handoff_changed } -> std::same_as<bool&>;
    { texture_frame_resource_materialization_entry_diff.upload_handoff_changed } -> std::same_as<bool&>;
    { texture_frame_resource_materialization_entry_diff.sampler_handoff_changed } -> std::same_as<bool&>;
    { texture_frame_resource_materialization_entry_diff.cache_delta }
        -> std::same_as<render::render_image_texture_frame_resource_cache_handoff_delta&>;
    { texture_frame_resource_materialization_entry_diff.upload_delta }
        -> std::same_as<render::render_image_texture_frame_resource_upload_handoff_delta&>;
    { texture_frame_resource_materialization_entry_diff.sampler_delta }
    ...
    { texture_frame_resource_materialization_diff.before_frame_request_count } -> std::same_as<std::size_t&>;
    { texture_frame_resource_materialization_diff.after_frame_request_count } -> std::same_as<std::size_t&>;
    { texture_frame_resource_materialization_diff.frame_request_delta } -> std::same_as<std::int64_t&>;
    { texture_frame_resource_materialization_diff.before_materialized_packet_count }
        -> std::same_as<std::size_t&>;
    { texture_frame_resource_materialization_diff.after_materialized_packet_count }
        -> std::same_as<std::size_t&>;
    ...
    { texture_frame_resource_materialization_diff.upload_handoff_changed_count }
        -> std::same_as<std::size_t&>;
    { texture_frame_resource_materialization_diff.sampler_handoff_changed_count }
        -> std::same_as<std::size_t&>;
    { texture_frame_resource_materialization_diff.stable_texture_cache_key_changed_count }
        -> std::same_as<std::size_t&>;
    { texture_frame_resource_materialization_diff.upload_request_changed_count }
        -> std::same_as<std::size_t&>;
...
static_assert(!ExposesFakeImageTextureCacheSnapshot<render::render_image_texture_frame_binding_summary>);
...
static_assert(!ExposesFakeImageTextureCacheSnapshot<render::render_image_renderer_resource_packet_descriptor>);
static_assert(!ExposesFakeImageTextureCacheSnapshot<render::render_image_renderer_resource_packet_bridge>);
...
static_assert(
    !ExposesFakeImageTextureCacheSnapshot<render::render_image_texture_frame_resource_materialization_entry_diff>);
static_assert(!ExposesFakeImageTextureCacheSnapshot<render::render_image_texture_frame_resource_materialization_diff>);
...
static_assert(!ExposesFakeImageTextureUploadSnapshot<render::render_image_texture_frame_binding_summary>);
...
static_assert(!ExposesFakeImageTextureUploadSnapshot<render::render_image_renderer_resource_packet_descriptor>);
static_assert(!ExposesFakeImageTextureUploadSnapshot<render::render_image_renderer_resource_packet_bridge>);
...
static_assert(
    !ExposesFakeImageTextureUploadSnapshot<render::render_image_texture_frame_resource_materialization_entry_diff>);
static_assert(!ExposesFakeImageTextureUploadSnapshot<render::render_image_texture_frame_resource_materialization_diff>);
...
static_assert(!ExposesRenderImageDecoderDiagnostics<render::render_image_texture_frame_binding_summary>);
...
static_assert(!ExposesRenderImageDecoderDiagnostics<render::render_image_renderer_resource_packet_descriptor>);
static_assert(!ExposesRenderImageDecoderDiagnostics<render::render_image_renderer_resource_packet_bridge>);
...
static_assert(
    !ExposesRenderImageDecoderDiagnostics<render::render_image_texture_frame_resource_materialization_entry_diff>);
static_assert(!ExposesRenderImageDecoderDiagnostics<render::render_image_texture_frame_resource_materialization_diff>);
...
static_assert(!ExposesFakeImageTexturePipelineEntries<render::render_image_renderer_resource_packet_descriptor>);
static_assert(!ExposesFakeImageTexturePipelineEntries<render::render_image_renderer_resource_packet_bridge>);
