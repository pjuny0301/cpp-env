...
concept VulkanNativeSwapchainOperationInterface = requires(
    ...
    const render::vulkan_backend::vulkan_native_swapchain_destroy_execution_request& destroy_request,
    const render::vulkan_backend::vulkan_native_swapchain_images_execution_request& images_request,
    const render::vulkan_backend::vulkan_native_swapchain_acquire_execution_request& acquire_request,
    const render::vulkan_backend::vulkan_native_swapchain_image_view_targets_execution_request&
        image_view_request,
    const render::vulkan_backend::vulkan_native_swapchain_image_view_targets_destroy_request&
        image_view_destroy_request) {
    { operation.create_swapchain(create_request) }
        -> std::same_as<render::vulkan_backend::vulkan_native_swapchain_create_execution_result>;
    { operation.destroy_swapchain(destroy_request) }
        -> std::same_as<render::vulkan_backend::vulkan_native_swapchain_destroy_execution_result>;
    { operation.enumerate_swapchain_images(images_request) }
        -> std::same_as<render::vulkan_backend::vulkan_native_swapchain_images_execution_result>;
    { operation.acquire_next_image(acquire_request) }
        -> std::same_as<render::vulkan_backend::vulkan_native_swapchain_acquire_execution_result>;
    { operation.create_image_view_targets(image_view_request) } -> std::same_as<
        render::vulkan_backend::vulkan_native_swapchain_image_view_targets_execution_result>;
    { operation.destroy_image_view_targets(image_view_destroy_request) } -> std::same_as<
        render::vulkan_backend::vulkan_native_swapchain_image_view_targets_destroy_result>;
};

static_assert(VulkanNativeSwapchainOperationInterface<
              render::vulkan_backend::vulkan_native_swapchain_operation_interface>);
static_assert(VulkanNativeSwapchainOperationInterface<
              render::vulkan_backend::fake_vulkan_native_swapchain_operation>);
static_assert(VulkanNativeSwapchainOperationInterface<
              render::vulkan_backend::vulkan_native_swapchain_operation>);
static_assert(std::default_initializable<
              render::vulkan_backend::fake_vulkan_native_swapchain_operation>);
static_assert(std::constructible_from<
    render::vulkan_backend::fake_vulkan_native_swapchain_operation,
    render::vulkan_backend::fake_vulkan_native_swapchain_operation_options>);
static_assert(std::default_initializable<
              render::vulkan_backend::vulkan_native_swapchain_operation>);

template <typename T>
concept VulkanSdkHeaderProbeInterface = requires(
    T& probe,
    const render::vulkan_backend::vulkan_sdk_header_probe_request& request) {
    { probe.probe_headers(request) }
        -> std::same_as<render::vulkan_backend::vulkan_sdk_header_probe_result>;
};
...
template <typename T>
concept VulkanNativeFramebufferOperationInterface = requires(
    T& operation,
    const render::vulkan_backend::vulkan_native_framebuffer_targets_execution_request&
        create_request,
    const render::vulkan_backend::vulkan_native_framebuffer_targets_destroy_request&
        destroy_request) {
    { operation.create_framebuffer_targets(create_request) }
        -> std::same_as<render::vulkan_backend::vulkan_native_framebuffer_targets_execution_result>;
    { operation.destroy_framebuffer_targets(destroy_request) }
        -> std::same_as<render::vulkan_backend::vulkan_native_framebuffer_targets_destroy_result>;
};

static_assert(VulkanNativeFramebufferOperationInterface<
              render::vulkan_backend::vulkan_native_framebuffer_operation_interface>);
static_assert(VulkanNativeFramebufferOperationInterface<
              render::vulkan_backend::fake_vulkan_native_framebuffer_operation>);
static_assert(VulkanNativeFramebufferOperationInterface<
...
static_assert(std::constructible_from<
    render::vulkan_backend::fake_vulkan_native_framebuffer_operation,
    render::vulkan_backend::fake_vulkan_native_framebuffer_operation_options>);
static_assert(std::default_initializable<
              render::vulkan_backend::vulkan_native_framebuffer_operation>);
...
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_physical_device_dispatch_table_status::not_checked),
    render::vulkan_backend::vulkan_native_physical_device_dispatch_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_physical_device_dispatch_table_status::ready),
    render::vulkan_backend::vulkan_native_physical_device_dispatch_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_physical_device_dispatch_table_status::instance_unavailable),
    render::vulkan_backend::vulkan_native_physical_device_dispatch_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_physical_device_dispatch_table_status::get_instance_proc_address_unavailable),
    render::vulkan_backend::vulkan_native_physical_device_dispatch_table_status>);
static_assert(std::same_as<
...
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_physical_device_enumeration_status::ready),
    render::vulkan_backend::vulkan_native_physical_device_enumeration_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_physical_device_enumeration_status::dispatch_table_unavailable),
    render::vulkan_backend::vulkan_native_physical_device_enumeration_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_physical_device_enumeration_status::headers_unavailable),
    render::vulkan_backend::vulkan_native_physical_device_enumeration_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_physical_device_enumeration_status::enumeration_failed),
    render::vulkan_backend::vulkan_native_physical_device_enumeration_status>);
static_assert(std::same_as<
...
static_assert(std::same_as<
    ...
    render::vulkan_backend::vulkan_native_physical_device_selection_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_physical_device_selection_status::selected),
    render::vulkan_backend::vulkan_native_physical_device_selection_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_physical_device_selection_status::enumeration_unavailable),
    render::vulkan_backend::vulkan_native_physical_device_selection_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_physical_device_selection_status::no_devices),
    render::vulkan_backend::vulkan_native_physical_device_selection_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_physical_device_selection_status::missing_required_queue),
    render::vulkan_backend::vulkan_native_physical_device_selection_status>);

static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_device_dispatch_table_status::not_checked),
    render::vulkan_backend::vulkan_native_device_dispatch_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_device_dispatch_table_status::ready),
    render::vulkan_backend::vulkan_native_device_dispatch_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_device_dispatch_table_status::selection_unavailable),
    render::vulkan_backend::vulkan_native_device_dispatch_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_device_dispatch_table_status::get_instance_proc_address_unavailable),
    render::vulkan_backend::vulkan_native_device_dispatch_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_device_dispatch_table_status::missing_enumerate_device_extension_properties_symbol),
    render::vulkan_backend::vulkan_native_device_dispatch_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_device_dispatch_table_status::missing_create_device_symbol),
    render::vulkan_backend::vulkan_native_device_dispatch_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_device_dispatch_table_status::missing_get_device_queue_symbol),
    render::vulkan_backend::vulkan_native_device_dispatch_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_device_dispatch_table_status::missing_destroy_device_symbol),
    render::vulkan_backend::vulkan_native_device_dispatch_table_status>);

static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_device_extension_query_status::not_checked),
    render::vulkan_backend::vulkan_native_device_extension_query_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_device_extension_query_status::ready),
    render::vulkan_backend::vulkan_native_device_extension_query_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_device_extension_query_status::selection_unavailable),
    render::vulkan_backend::vulkan_native_device_extension_query_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_device_extension_query_status::dispatch_table_unavailable),
    render::vulkan_backend::vulkan_native_device_extension_query_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_device_extension_query_status::headers_unavailable),
    render::vulkan_backend::vulkan_native_device_extension_query_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_device_extension_query_status::enumeration_failed),
    render::vulkan_backend::vulkan_native_device_extension_query_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_device_extension_query_status::missing_required_extension),
    render::vulkan_backend::vulkan_native_device_extension_query_status>);

static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_device_create_status::not_requested),
    render::vulkan_backend::vulkan_native_device_create_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_device_create_status::created),
    render::vulkan_backend::vulkan_native_device_create_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_device_create_status::selection_unavailable),
    render::vulkan_backend::vulkan_native_device_create_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_device_create_status::dispatch_table_unavailable),
    render::vulkan_backend::vulkan_native_device_create_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_device_create_status::extension_query_unavailable),
    render::vulkan_backend::vulkan_native_device_create_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_device_create_status::missing_required_extension),
    render::vulkan_backend::vulkan_native_device_create_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_device_create_status::headers_unavailable),
    render::vulkan_backend::vulkan_native_device_create_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_device_create_status::creation_failed),
    render::vulkan_backend::vulkan_native_device_create_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_device_create_status::queue_unavailable),
    render::vulkan_backend::vulkan_native_device_create_status>);
...
static_assert(std::same_as<
    ...
    render::vulkan_backend::vulkan_native_entrypoint_stage>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_entrypoint_stage::swapchain_create),
    render::vulkan_backend::vulkan_native_entrypoint_stage>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_entrypoint_stage::swapchain_destroy),
    render::vulkan_backend::vulkan_native_entrypoint_stage>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_entrypoint_stage::swapchain_images),
    render::vulkan_backend::vulkan_native_entrypoint_stage>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_entrypoint_stage::swapchain_acquire),
    render::vulkan_backend::vulkan_native_entrypoint_stage>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_entrypoint_stage::image_view_create),
    render::vulkan_backend::vulkan_native_entrypoint_stage>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_entrypoint_stage::image_view_destroy),
    render::vulkan_backend::vulkan_native_entrypoint_stage>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_entrypoint_stage::framebuffer_create),
    render::vulkan_backend::vulkan_native_entrypoint_stage>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_entrypoint_stage::framebuffer_destroy),
    render::vulkan_backend::vulkan_native_entrypoint_stage>);
static_assert(std::same_as<
...
static_assert(std::same_as<
    ...
    render::vulkan_backend::vulkan_native_function_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_function_table_status::required_extension_unavailable),
    render::vulkan_backend::vulkan_native_function_table_status>);
static_assert(std::same_as<
...
static_assert(std::same_as<
    ...
    render::vulkan_backend::vulkan_native_function_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_function_table_status::missing_swapchain_create_symbol),
    render::vulkan_backend::vulkan_native_function_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_function_table_status::missing_swapchain_destroy_symbol),
    render::vulkan_backend::vulkan_native_function_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_function_table_status::missing_swapchain_images_symbol),
    render::vulkan_backend::vulkan_native_function_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_function_table_status::missing_swapchain_acquire_symbol),
    render::vulkan_backend::vulkan_native_function_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_function_table_status::missing_image_view_create_symbol),
    render::vulkan_backend::vulkan_native_function_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_function_table_status::missing_image_view_destroy_symbol),
    render::vulkan_backend::vulkan_native_function_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_function_table_status::missing_framebuffer_create_symbol),
    render::vulkan_backend::vulkan_native_function_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_function_table_status::missing_framebuffer_destroy_symbol),
    render::vulkan_backend::vulkan_native_function_table_status>);
static_assert(std::same_as<
...
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_sdk_header_probe_status::not_checked),
    render::vulkan_backend::vulkan_sdk_header_probe_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_sdk_header_probe_status::available),
    render::vulkan_backend::vulkan_sdk_header_probe_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_sdk_header_probe_status::unavailable),
    render::vulkan_backend::vulkan_sdk_header_probe_status>);

static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_sdk_capability_status::not_checked),
    render::vulkan_backend::vulkan_sdk_capability_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_sdk_capability_status::ready),
    render::vulkan_backend::vulkan_sdk_capability_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_sdk_capability_status::headers_unavailable),
    render::vulkan_backend::vulkan_sdk_capability_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_sdk_capability_status::api_version_unavailable),
    render::vulkan_backend::vulkan_sdk_capability_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_sdk_capability_status::api_version_too_old),
    render::vulkan_backend::vulkan_sdk_capability_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_sdk_capability_status::missing_required_extension),
    render::vulkan_backend::vulkan_sdk_capability_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_sdk_capability_status::native_function_table_unavailable),
    render::vulkan_backend::vulkan_sdk_capability_status>);

static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_sdk_adapter_fallback_status::none),
    render::vulkan_backend::vulkan_sdk_adapter_fallback_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_sdk_adapter_fallback_status::headers_unavailable),
    render::vulkan_backend::vulkan_sdk_adapter_fallback_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_sdk_adapter_fallback_status::api_version_unavailable),
    render::vulkan_backend::vulkan_sdk_adapter_fallback_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_sdk_adapter_fallback_status::extension_unavailable),
    render::vulkan_backend::vulkan_sdk_adapter_fallback_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_sdk_adapter_fallback_status::native_function_table_unavailable),
    render::vulkan_backend::vulkan_sdk_adapter_fallback_status>);

static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_sdk_native_path_status::not_checked),
    render::vulkan_backend::vulkan_sdk_native_path_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_sdk_native_path_status::ready),
    render::vulkan_backend::vulkan_sdk_native_path_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_sdk_native_path_status::sdk_missing),
    render::vulkan_backend::vulkan_sdk_native_path_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_sdk_native_path_status::version_mismatch),
    render::vulkan_backend::vulkan_sdk_native_path_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_sdk_native_path_status::extension_missing),
    render::vulkan_backend::vulkan_sdk_native_path_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_sdk_native_path_status::function_table_blocked),
    render::vulkan_backend::vulkan_sdk_native_path_status>);
...
static_assert(requires(
    ...
    render::vulkan_backend::vulkan_sdk_header_probe_status sdk_header_status,
    render::vulkan_backend::vulkan_sdk_capability_status sdk_capability_status,
    render::vulkan_backend::vulkan_sdk_adapter_fallback_status sdk_fallback_status,
    render::vulkan_backend::vulkan_sdk_native_path_status sdk_native_path_status) {
    ...
    { render::vulkan_backend::native_function_table_status_name(status) }
        -> std::same_as<std::string_view>;
    { render::vulkan_backend::sdk_header_probe_status_name(sdk_header_status) }
        -> std::same_as<std::string_view>;
    { render::vulkan_backend::sdk_capability_status_name(sdk_capability_status) }
        -> std::same_as<std::string_view>;
    { render::vulkan_backend::sdk_adapter_fallback_status_name(sdk_fallback_status) }
        -> std::same_as<std::string_view>;
    { render::vulkan_backend::sdk_native_path_status_name(sdk_native_path_status) }
        -> std::same_as<std::string_view>;
});
...
static_assert(requires(render::vulkan_backend::vulkan_queue_submit_present_request request) {
    ...
    { request.image_id } -> std::same_as<render::vulkan_backend::vulkan_swapchain_image_id&>;
    { request.acquired_image_index } -> std::same_as<std::size_t&>;
    { request.image_handle }
        -> std::same_as<render::vulkan_backend::vulkan_swapchain_image_handle&>;
});
...
static_assert(requires(render::vulkan_backend::vulkan_native_function_table_request request) {
    ...
    { request.required_extensions } -> std::same_as<std::vector<std::string>&>;
    { request.available_extensions } -> std::same_as<std::vector<std::string>&>;
    { request.include_default_swapchain_extension } -> std::same_as<bool&>;
});
...
static_assert(requires(render::vulkan_backend::vulkan_native_function_table_diagnostics diagnostics) {
    ...
    { diagnostics.required_extensions_ready } -> std::same_as<bool&>;
    { diagnostics.command_buffer_recording_ready } -> std::same_as<bool&>;
    { diagnostics.queue_submit_ready } -> std::same_as<bool&>;
    { diagnostics.swapchain_create_ready } -> std::same_as<bool&>;
    { diagnostics.swapchain_destroy_ready } -> std::same_as<bool&>;
    { diagnostics.swapchain_images_ready } -> std::same_as<bool&>;
    { diagnostics.swapchain_acquire_ready } -> std::same_as<bool&>;
    { diagnostics.queue_present_ready } -> std::same_as<bool&>;
    { diagnostics.required_extension_count } -> std::same_as<std::size_t&>;
    { diagnostics.available_required_extension_count } -> std::same_as<std::size_t&>;
    ...
    { diagnostics.missing_required_extension } -> std::same_as<std::string&>;
...
static_assert(requires(
    render::vulkan_backend::vulkan_native_swapchain_entrypoint_readiness readiness) {
    { readiness.checked } -> std::same_as<bool&>;
    { readiness.function_table_checked } -> std::same_as<bool&>;
    { readiness.required_extensions_ready } -> std::same_as<bool&>;
    { readiness.create_swapchain_ready } -> std::same_as<bool&>;
    { readiness.destroy_swapchain_ready } -> std::same_as<bool&>;
    { readiness.get_swapchain_images_ready } -> std::same_as<bool&>;
    { readiness.acquire_next_image_ready } -> std::same_as<bool&>;
    { readiness.queue_present_ready } -> std::same_as<bool&>;
    { readiness.function_table_status }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_table_status&>;
    { readiness.fallback_reason }
        -> std::same_as<render::vulkan_backend::vulkan_backend_fallback_reason&>;
    { readiness.required_extension_count } -> std::same_as<std::size_t&>;
    { readiness.available_required_extension_count } -> std::same_as<std::size_t&>;
    { readiness.missing_required_extension } -> std::same_as<std::string&>;
    { readiness.missing_symbol_name } -> std::same_as<std::string&>;
    { readiness.diagnostic } -> std::same_as<std::string&>;
    { readiness.ready_for_swapchain_create() } -> std::same_as<bool>;
    { readiness.ready_for_swapchain_acquire() } -> std::same_as<bool>;
    { readiness.ready_for_swapchain_present() } -> std::same_as<bool>;
    { readiness.ready_for_swapchain_path() } -> std::same_as<bool>;
    { readiness.blocked() } -> std::same_as<bool>;
});

static_assert(requires(render::vulkan_backend::vulkan_sdk_api_version version) {
    { version.variant } -> std::same_as<std::uint32_t&>;
    { version.major } -> std::same_as<std::uint32_t&>;
    { version.minor } -> std::same_as<std::uint32_t&>;
    { version.patch } -> std::same_as<std::uint32_t&>;
    { version.valid() } -> std::same_as<bool>;
    { version.packed() } -> std::same_as<std::uint32_t>;
    { version.supports(render::vulkan_backend::vulkan_sdk_api_version{}) }
        -> std::same_as<bool>;
});

static_assert(requires {
    { render::vulkan_backend::make_vulkan_sdk_api_version(1U, 4U, 0U, 0U) }
        -> std::same_as<render::vulkan_backend::vulkan_sdk_api_version>;
    { render::vulkan_backend::vulkan_sdk_api_version_1_0() }
        -> std::same_as<render::vulkan_backend::vulkan_sdk_api_version>;
    { render::vulkan_backend::vulkan_sdk_api_version_1_3() }
        -> std::same_as<render::vulkan_backend::vulkan_sdk_api_version>;
    { render::vulkan_backend::vulkan_sdk_api_version_1_4() }
        -> std::same_as<render::vulkan_backend::vulkan_sdk_api_version>;
});
...
static_assert(requires(render::vulkan_backend::vulkan_sdk_header_manifest manifest) {
    ...
    { manifest.header_version } -> std::same_as<std::uint32_t&>;
...
static_assert(requires(render::vulkan_backend::vulkan_sdk_header_probe_request request) {
    { request.manifest_name } -> std::same_as<std::string&>;
});

static_assert(requires(render::vulkan_backend::vulkan_sdk_header_probe_result result) {
    { result.checked } -> std::same_as<bool&>;
    { result.status } -> std::same_as<render::vulkan_backend::vulkan_sdk_header_probe_status&>;
    { result.manifest } -> std::same_as<render::vulkan_backend::vulkan_sdk_header_manifest&>;
    { result.available() } -> std::same_as<bool>;
});

static_assert(requires(render::vulkan_backend::fake_vulkan_sdk_header_probe_options options) {
    { options.manifest } -> std::same_as<render::vulkan_backend::vulkan_sdk_header_manifest&>;
});

static_assert(requires(render::vulkan_backend::fake_vulkan_sdk_header_probe_state state) {
    { state.probe_call_count } -> std::same_as<std::size_t&>;
    { state.requested_manifests } -> std::same_as<std::vector<std::string>&>;
});

static_assert(requires(render::vulkan_backend::vulkan_sdk_capability_request request) {
    { request.minimum_api_version }
        -> std::same_as<render::vulkan_backend::vulkan_sdk_api_version&>;
    { request.include_default_backend_extensions } -> std::same_as<bool&>;
    { request.required_extensions } -> std::same_as<std::vector<std::string>&>;
    { request.require_native_function_table } -> std::same_as<bool&>;
});

static_assert(requires(render::vulkan_backend::vulkan_sdk_capability_result result) {
    { result.checked } -> std::same_as<bool&>;
    { result.status } -> std::same_as<render::vulkan_backend::vulkan_sdk_capability_status&>;
    { result.fallback_status }
        -> std::same_as<render::vulkan_backend::vulkan_sdk_adapter_fallback_status&>;
    { result.headers } -> std::same_as<render::vulkan_backend::vulkan_sdk_header_probe_result&>;
    { result.native_functions }
    ...
    { result.native_function_table_required } -> std::same_as<bool&>;
    { result.native_function_table_ready } -> std::same_as<bool&>;
    ...
    { result.native_path_status() }
        -> std::same_as<render::vulkan_backend::vulkan_sdk_native_path_status>;
    { result.adapter_ready() } -> std::same_as<bool>;
    { result.blocked() } -> std::same_as<bool>;
});

static_assert(requires(
    render::vulkan_backend::vulkan_sdk_capability_request request,
    render::vulkan_backend::vulkan_sdk_header_probe_interface& probe,
    render::vulkan_backend::vulkan_native_function_table_diagnostics native_functions) {
    { render::vulkan_backend::default_vulkan_sdk_backend_extensions() }
        -> std::same_as<std::vector<std::string>>;
    { render::vulkan_backend::merge_vulkan_sdk_required_extensions(request) }
        -> std::same_as<std::vector<std::string>>;
    { render::vulkan_backend::collect_vulkan_sdk_capabilities(
        probe,
        native_functions,
        request) } -> std::same_as<render::vulkan_backend::vulkan_sdk_capability_result>;
});

static_assert(requires(render::vulkan_backend::vulkan_sdk_native_path_readiness readiness) {
    { readiness.checked } -> std::same_as<bool&>;
    { readiness.status } -> std::same_as<render::vulkan_backend::vulkan_sdk_native_path_status&>;
    { readiness.sdk_capability_checked } -> std::same_as<bool&>;
    { readiness.sdk_adapter_ready } -> std::same_as<bool&>;
    { readiness.sdk_capability_status }
    ...
    { readiness.required_extensions_ready } -> std::same_as<bool&>;
    { readiness.native_function_table_required } -> std::same_as<bool&>;
    { readiness.native_function_table_ready } -> std::same_as<bool&>;
    { readiness.native_function_table_status }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_table_status&>;
    { readiness.missing_required_extension } -> std::same_as<std::string&>;
    { readiness.missing_native_symbol_name } -> std::same_as<std::string&>;
    { readiness.diagnostic } -> std::same_as<std::string&>;
    { readiness.ready() } -> std::same_as<bool>;
    { readiness.blocked() } -> std::same_as<bool>;
});

static_assert(requires(render::vulkan_backend::vulkan_sdk_capability_result result) {
    { render::vulkan_backend::sdk_native_path_status_for(result) }
        -> std::same_as<render::vulkan_backend::vulkan_sdk_native_path_status>;
    { render::vulkan_backend::summarize_vulkan_sdk_native_path_readiness(result) }
        -> std::same_as<render::vulkan_backend::vulkan_sdk_native_path_readiness>;
});
...
static_assert(requires(
    ...
    { snapshot.sdk_native_path }
        -> std::same_as<render::vulkan_backend::vulkan_sdk_native_path_readiness&>;
    { snapshot.blocks_fake_execution() } -> std::same_as<bool>;
    { snapshot.native_path_ready() } -> std::same_as<bool>;
});
...
static_assert(requires(
    ...
    { render::vulkan_backend::summarize_vulkan_queue_submit_native_readiness(diagnostics) }
        -> std::same_as<
            render::vulkan_backend::vulkan_native_entrypoint_readiness_snapshot>;
    { render::vulkan_backend::summarize_vulkan_queue_submit_native_readiness(
        diagnostics,
        sdk_capabilities) } -> std::same_as<
        render::vulkan_backend::vulkan_native_entrypoint_readiness_snapshot>;
    { render::vulkan_backend::summarize_vulkan_swapchain_create_native_readiness(
        diagnostics) } -> std::same_as<
        render::vulkan_backend::vulkan_native_entrypoint_readiness_snapshot>;
    { render::vulkan_backend::summarize_vulkan_swapchain_create_native_readiness(
        diagnostics,
        sdk_capabilities) } -> std::same_as<
        render::vulkan_backend::vulkan_native_entrypoint_readiness_snapshot>;
    { render::vulkan_backend::summarize_vulkan_swapchain_destroy_native_readiness(
        diagnostics) } -> std::same_as<
        render::vulkan_backend::vulkan_native_entrypoint_readiness_snapshot>;
    { render::vulkan_backend::summarize_vulkan_swapchain_destroy_native_readiness(
        diagnostics,
        sdk_capabilities) } -> std::same_as<
        render::vulkan_backend::vulkan_native_entrypoint_readiness_snapshot>;
    { render::vulkan_backend::summarize_vulkan_swapchain_images_native_readiness(
        diagnostics) } -> std::same_as<
        render::vulkan_backend::vulkan_native_entrypoint_readiness_snapshot>;
    { render::vulkan_backend::summarize_vulkan_swapchain_images_native_readiness(
        diagnostics,
        sdk_capabilities) } -> std::same_as<
        render::vulkan_backend::vulkan_native_entrypoint_readiness_snapshot>;
    { render::vulkan_backend::summarize_vulkan_swapchain_acquire_native_readiness(
        diagnostics) } -> std::same_as<
        render::vulkan_backend::vulkan_native_entrypoint_readiness_snapshot>;
    { render::vulkan_backend::summarize_vulkan_swapchain_acquire_native_readiness(
        diagnostics,
    ...
    { render::vulkan_backend::summarize_vulkan_queue_present_native_readiness(diagnostics) }
        -> std::same_as<
            render::vulkan_backend::vulkan_native_entrypoint_readiness_snapshot>;
    { render::vulkan_backend::summarize_vulkan_queue_present_native_readiness(
        diagnostics,
        sdk_capabilities) } -> std::same_as<
        render::vulkan_backend::vulkan_native_entrypoint_readiness_snapshot>;
});
...
static_assert(requires(render::vulkan_backend::vulkan_instance_extension_diagnostic diagnostic) {
...
static_assert(requires(render::vulkan_backend::vulkan_instance_create_result result) {
    ...
    { result.required_extension_diagnostics }
        -> std::same_as<std::vector<render::vulkan_backend::vulkan_instance_extension_diagnostic>&>;
    { result.required_extension_count } -> std::same_as<std::size_t&>;
    { result.available_required_extension_count } -> std::same_as<std::size_t&>;
    { result.missing_required_extension } -> std::same_as<std::string&>;
...
static_assert(requires(render::vulkan_backend::vulkan_physical_device_handle handle) {
    { handle.value } -> std::same_as<std::uintptr_t&>;
    { handle.valid() } -> std::same_as<bool>;
});
...
static_assert(requires(render::vulkan_backend::vulkan_native_physical_device_dispatch_table table) {
    { table.checked } -> std::same_as<bool&>;
    { table.status }
        -> std::same_as<render::vulkan_backend::vulkan_native_physical_device_dispatch_table_status&>;
    { table.instance } -> std::same_as<render::vulkan_backend::vulkan_instance_handle&>;
    { table.get_instance_proc_address }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_pointer&>;
...
static_assert(requires(render::vulkan_backend::vulkan_native_physical_device_enumeration_result result) {
    { result.checked } -> std::same_as<bool&>;
    { result.status }
        -> std::same_as<render::vulkan_backend::vulkan_native_physical_device_enumeration_status&>;
    { result.dispatch_table }
        -> std::same_as<render::vulkan_backend::vulkan_native_physical_device_dispatch_table&>;
    { result.physical_devices }
        -> std::same_as<std::vector<render::vulkan_backend::vulkan_physical_device_handle>&>;
    { result.physical_device_count } -> std::same_as<std::size_t&>;
    { result.native_result } -> std::same_as<std::int32_t&>;
    { result.diagnostic } -> std::same_as<std::string&>;
    { result.ready_for_device_selection() } -> std::same_as<bool>;
});

static_assert(requires(
    render::vulkan_backend::vulkan_native_physical_device_queue_family family,
    render::vulkan_backend::vulkan_device_queue_capability capability) {
    { family.physical_device }
        -> std::same_as<render::vulkan_backend::vulkan_physical_device_handle&>;
    { family.family_index } -> std::same_as<std::size_t&>;
    { family.queue_count } -> std::same_as<std::size_t&>;
    { family.capabilities }
        -> std::same_as<std::vector<render::vulkan_backend::vulkan_device_queue_capability>&>;
    { family.supports(capability) } -> std::same_as<bool>;
    { family.usable() } -> std::same_as<bool>;
});

static_assert(requires(render::vulkan_backend::vulkan_native_physical_device_queue_family_selection selection) {
    { selection.capability }
        -> std::same_as<render::vulkan_backend::vulkan_device_queue_capability&>;
    { selection.physical_device }
        -> std::same_as<render::vulkan_backend::vulkan_physical_device_handle&>;
    { selection.family_index } -> std::same_as<std::size_t&>;
    { selection.queue_count } -> std::same_as<std::size_t&>;
    { selection.valid() } -> std::same_as<bool>;
});
...
static_assert(requires(render::vulkan_backend::vulkan_native_physical_device_selection_candidate candidate) {
    { candidate.physical_device }
        -> std::same_as<render::vulkan_backend::vulkan_physical_device_handle&>;
    { candidate.queue_families }
        -> std::same_as<std::vector<render::vulkan_backend::vulkan_native_physical_device_queue_family>&>;
    { candidate.selected_queue_families }
        -> std::same_as<std::vector<render::vulkan_backend::vulkan_native_physical_device_queue_family_selection>&>;
    { candidate.missing_required_queue } -> std::same_as<std::string&>;
    { candidate.selected } -> std::same_as<bool&>;
    { candidate.required_queues_ready() } -> std::same_as<bool>;
});

static_assert(requires(render::vulkan_backend::vulkan_native_physical_device_selection_result result) {
    { result.checked } -> std::same_as<bool&>;
    { result.status }
    ...
    { result.selected_physical_device }
        -> std::same_as<render::vulkan_backend::vulkan_physical_device_handle&>;
    { result.selected_queue_families }
        -> std::same_as<std::vector<render::vulkan_backend::vulkan_native_physical_device_queue_family_selection>&>;
    { result.candidates }
        -> std::same_as<std::vector<render::vulkan_backend::vulkan_native_physical_device_selection_candidate>&>;
    { result.missing_required_queue } -> std::same_as<std::string&>;
    { result.diagnostic } -> std::same_as<std::string&>;
    { result.ready_for_device_create() } -> std::same_as<bool>;
});

static_assert(requires(render::vulkan_backend::vulkan_native_device_dispatch_table table) {
    { table.checked } -> std::same_as<bool&>;
    { table.status }
        -> std::same_as<render::vulkan_backend::vulkan_native_device_dispatch_table_status&>;
    { table.instance } -> std::same_as<render::vulkan_backend::vulkan_instance_handle&>;
    ...
    { table.missing_symbol_name } -> std::same_as<std::string&>;
    { table.diagnostic } -> std::same_as<std::string&>;
    { table.ready_for_create() } -> std::same_as<bool>;
});

static_assert(requires(render::vulkan_backend::vulkan_native_device_extension_query_result result) {
    { result.checked } -> std::same_as<bool&>;
    { result.status }
        -> std::same_as<render::vulkan_backend::vulkan_native_device_extension_query_status&>;
    { result.dispatch_table }
        -> std::same_as<render::vulkan_backend::vulkan_native_device_dispatch_table&>;
    { result.selection }
        -> std::same_as<render::vulkan_backend::vulkan_native_physical_device_selection_result&>;
    { result.physical_device }
        -> std::same_as<render::vulkan_backend::vulkan_physical_device_handle&>;
    { result.available_extensions } -> std::same_as<std::vector<std::string>&>;
    { result.selected_extensions } -> std::same_as<std::vector<std::string>&>;
    { result.required_extension_diagnostics }
        -> std::same_as<std::vector<render::vulkan_backend::vulkan_device_extension_diagnostic>&>;
    { result.available_extension_count } -> std::same_as<std::size_t&>;
    { result.required_extension_count } -> std::same_as<std::size_t&>;
    { result.available_required_extension_count } -> std::same_as<std::size_t&>;
    { result.missing_required_extension } -> std::same_as<std::string&>;
    { result.native_result } -> std::same_as<std::int32_t&>;
...
static_assert(requires(render::vulkan_backend::vulkan_native_device_create_result result) {
    { result.checked } -> std::same_as<bool&>;
    { result.status }
        -> std::same_as<render::vulkan_backend::vulkan_native_device_create_status&>;
    { result.dispatch_table }
        -> std::same_as<render::vulkan_backend::vulkan_native_device_dispatch_table&>;
    { result.extension_query }
        -> std::same_as<render::vulkan_backend::vulkan_native_device_extension_query_result&>;
    { result.selection }
        -> std::same_as<render::vulkan_backend::vulkan_native_physical_device_selection_result&>;
    { result.handle } -> std::same_as<render::vulkan_backend::vulkan_device_handle&>;
    { result.selected_extensions } -> std::same_as<std::vector<std::string>&>;
    { result.queue_create_family_indices } -> std::same_as<std::vector<std::size_t>&>;
    { result.selected_queues }
        -> std::same_as<std::vector<render::vulkan_backend::vulkan_device_queue_selection>&>;
    { result.queue_create_family_count } -> std::same_as<std::size_t&>;
    { result.selected_queue_count } -> std::same_as<std::size_t&>;
    { result.native_result } -> std::same_as<std::int32_t&>;
    { result.diagnostic } -> std::same_as<std::string&>;
    { result.ready_for_backend() } -> std::same_as<bool>;
});
...
static_assert(requires(render::vulkan_backend::vulkan_native_swapchain_image_binding image) {
    { image.image_id } -> std::same_as<render::vulkan_backend::vulkan_swapchain_image_id&>;
    { image.handle } -> std::same_as<render::vulkan_backend::vulkan_swapchain_image_handle&>;
    { image.valid() } -> std::same_as<bool>;
});
...
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_framebuffer_dispatch_table_status::ready),
    render::vulkan_backend::vulkan_native_framebuffer_dispatch_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_framebuffer_dispatch_table_status::missing_create_symbol),
    render::vulkan_backend::vulkan_native_framebuffer_dispatch_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_framebuffer_targets_execution_status::ready),
    render::vulkan_backend::vulkan_native_framebuffer_targets_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_framebuffer_targets_execution_status::extent_mismatch),
    render::vulkan_backend::vulkan_native_framebuffer_targets_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_framebuffer_targets_destroy_status::destroyed),
    render::vulkan_backend::vulkan_native_framebuffer_targets_destroy_status>);

static_assert(requires(
    render::vulkan_backend::vulkan_native_framebuffer_dispatch_table table) {
    { table.checked } -> std::same_as<bool&>;
    { table.status }
        -> std::same_as<render::vulkan_backend::vulkan_native_framebuffer_dispatch_table_status&>;
    { table.function_table_status }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_table_status&>;
    { table.function_table_checked } -> std::same_as<bool&>;
    { table.create_framebuffer }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_pointer&>;
    { table.destroy_framebuffer }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_pointer&>;
    { table.missing_symbol_name } -> std::same_as<std::string&>;
    { table.diagnostic } -> std::same_as<std::string&>;
    { table.ready_for_create() } -> std::same_as<bool>;
...
static_assert(requires(
    render::vulkan_backend::vulkan_native_framebuffer_target_intent intent) {
    { intent.attachments } -> std::same_as<
        std::vector<render::vulkan_backend::vulkan_render_pass_attachment_request>&>;
    { intent.layers } -> std::same_as<std::uint32_t&>;
});

static_assert(requires(render::vulkan_backend::vulkan_native_framebuffer_target target) {
    { target.image_index } -> std::same_as<std::size_t&>;
    { target.image_id } -> std::same_as<render::vulkan_backend::vulkan_swapchain_image_id&>;
    { target.image_view }
        -> std::same_as<render::vulkan_backend::vulkan_swapchain_image_view_handle&>;
    { target.render_pass } -> std::same_as<render::vulkan_backend::vulkan_render_pass_handle&>;
    { target.framebuffer } -> std::same_as<render::vulkan_backend::vulkan_framebuffer_handle&>;
    { target.extent } -> std::same_as<render::vulkan_backend::vulkan_surface_extent&>;
    { target.layers } -> std::same_as<std::uint32_t&>;
    { target.attachments } -> std::same_as<
        std::vector<render::vulkan_backend::vulkan_render_pass_attachment_request>&>;
    { target.lifecycle_status }
        -> std::same_as<render::vulkan_backend::vulkan_native_framebuffer_target_lifecycle_status&>;
    { target.render_pass_ready } -> std::same_as<bool&>;
    { target.image_view_ready } -> std::same_as<bool&>;
    { target.extent_ready } -> std::same_as<bool&>;
    { target.attachment_ready } -> std::same_as<bool&>;
    { target.framebuffer_ready } -> std::same_as<bool&>;
    { target.vk_create_framebuffer_called } -> std::same_as<bool&>;
    { target.vk_destroy_framebuffer_called } -> std::same_as<bool&>;
    { target.native_result } -> std::same_as<std::int32_t&>;
    { target.ready() } -> std::same_as<bool>;
});

static_assert(requires(
    render::vulkan_backend::vulkan_native_framebuffer_targets_execution_request request) {
    { request.image_view_targets } -> std::same_as<
        render::vulkan_backend::vulkan_native_swapchain_image_view_targets_execution_result&>;
    { request.render_pass }
        -> std::same_as<render::vulkan_backend::vulkan_render_pass_create_result&>;
    { request.dispatch_table }
        -> std::same_as<render::vulkan_backend::vulkan_native_framebuffer_dispatch_table&>;
    { request.intent }
        -> std::same_as<render::vulkan_backend::vulkan_native_framebuffer_target_intent&>;
});

static_assert(requires(
    render::vulkan_backend::vulkan_native_framebuffer_targets_execution_result result) {
    { result.checked } -> std::same_as<bool&>;
    { result.status }
        -> std::same_as<render::vulkan_backend::vulkan_native_framebuffer_targets_execution_status&>;
    { result.image_view_targets } -> std::same_as<
        render::vulkan_backend::vulkan_native_swapchain_image_view_targets_execution_result&>;
    { result.render_pass }
        -> std::same_as<render::vulkan_backend::vulkan_render_pass_create_result&>;
    { result.dispatch_table }
    ...
    { result.layers } -> std::same_as<std::uint32_t&>;
    { result.attachments } -> std::same_as<
        std::vector<render::vulkan_backend::vulkan_render_pass_attachment_request>&>;
    { result.target_count } -> std::same_as<std::size_t&>;
    { result.ready_framebuffer_count } -> std::same_as<std::size_t&>;
    { result.targets }
        -> std::same_as<std::vector<render::vulkan_backend::vulkan_native_framebuffer_target>&>;
    { result.create_framebuffer_symbol }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_pointer&>;
    { result.destroy_framebuffer_symbol }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_pointer&>;
    { result.image_view_targets_ready } -> std::same_as<bool&>;
    ...
    { result.vk_create_framebuffer_called } -> std::same_as<bool&>;
    { result.native_result } -> std::same_as<std::int32_t&>;
    { result.diagnostic } -> std::same_as<std::string&>;
...
static_assert(requires(
    render::vulkan_backend::vulkan_native_framebuffer_targets_destroy_request request) {
    { request.targets }
        -> std::same_as<render::vulkan_backend::vulkan_native_framebuffer_targets_execution_result&>;
    { request.dispatch_table }
        -> std::same_as<render::vulkan_backend::vulkan_native_framebuffer_dispatch_table&>;
...
static_assert(requires(
    render::vulkan_backend::vulkan_native_framebuffer_targets_destroy_result result) {
    { result.checked } -> std::same_as<bool&>;
    { result.status }
        -> std::same_as<render::vulkan_backend::vulkan_native_framebuffer_targets_destroy_status&>;
    { result.targets }
        -> std::same_as<render::vulkan_backend::vulkan_native_framebuffer_targets_execution_result&>;
    { result.dispatch_table }
        -> std::same_as<render::vulkan_backend::vulkan_native_framebuffer_dispatch_table&>;
    { result.device } -> std::same_as<render::vulkan_backend::vulkan_device_handle&>;
    { result.requested_framebuffer_count } -> std::same_as<std::size_t&>;
    { result.destroyed_framebuffer_count } -> std::same_as<std::size_t&>;
    { result.destroy_framebuffer_symbol }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_pointer&>;
    { result.targets_ready } -> std::same_as<bool&>;
    { result.dispatch_table_ready } -> std::same_as<bool&>;
    { result.vk_destroy_framebuffer_called } -> std::same_as<bool&>;
    { result.native_result } -> std::same_as<std::int32_t&>;
    { result.diagnostic } -> std::same_as<std::string&>;
    { result.destroyed() } -> std::same_as<bool>;
    { result.blocked() } -> std::same_as<bool>;
...
static_assert(requires(render::vulkan_backend::vulkan_queue_submit_adapter_submit_call call) {
    ...
    { call.wait_intent_count } -> std::same_as<std::size_t&>;
    { call.signal_intent_count } -> std::same_as<std::size_t&>;
    { call.command_submit_ready } -> std::same_as<bool&>;
    { call.submitted_frame_ready } -> std::same_as<bool&>;
    { call.valid() } -> std::same_as<bool>;
});

static_assert(requires(render::vulkan_backend::vulkan_queue_submit_adapter_present_call call) {
    { call.queue } -> std::same_as<render::vulkan_backend::vulkan_queue_handle&>;
    { call.queue_family_index } -> std::same_as<std::size_t&>;
    { call.queue_family_ready } -> std::same_as<bool&>;
    { call.swapchain } -> std::same_as<render::vulkan_backend::vulkan_swapchain_handle&>;
    { call.acquired_image_index } -> std::same_as<std::size_t&>;
...
static_assert(requires(render::vulkan_backend::vulkan_queue_submit_present_result result) {
    ...
    { result.acquired_image_index } -> std::same_as<std::size_t&>;
    { result.image_handle }
        -> std::same_as<render::vulkan_backend::vulkan_swapchain_image_handle&>;
    { result.present_queue_family_index } -> std::same_as<std::size_t&>;
    { result.acquired_image_index_ready } -> std::same_as<bool&>;
    { result.acquired_image_handle_ready } -> std::same_as<bool&>;
    { result.present_queue_family_ready } -> std::same_as<bool&>;
    { result.command_submit_ready } -> std::same_as<bool&>;
    { result.submitted_frame_ready } -> std::same_as<bool&>;
    { result.present_wait_intent_ready } -> std::same_as<bool&>;
    { result.submit_signal_intent_ready } -> std::same_as<bool&>;
    { result.present_execution_ready } -> std::same_as<bool&>;
    { result.diagnostic } -> std::same_as<std::string&>;
...
static_assert(requires(render::vulkan_backend::fake_vulkan_native_physical_device_enumerator_options options) {
    { options.physical_devices }
        -> std::same_as<std::vector<render::vulkan_backend::vulkan_physical_device_handle>&>;
    { options.fail_enumeration } -> std::same_as<bool&>;
    { options.failure_result } -> std::same_as<std::int32_t&>;
});

static_assert(requires(render::vulkan_backend::fake_vulkan_native_physical_device_enumerator_state state) {
    { state.enumerate_call_count } -> std::same_as<std::size_t&>;
    { state.last_instance } -> std::same_as<render::vulkan_backend::vulkan_instance_handle&>;
    { state.last_enumerate_physical_devices }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_pointer&>;
});
...
static_assert(requires(render::vulkan_backend::fake_vulkan_native_physical_device_selector_state state) {
    { state.select_call_count } -> std::same_as<std::size_t&>;
    { state.inspected_physical_devices }
        -> std::same_as<std::vector<render::vulkan_backend::vulkan_physical_device_handle>&>;
});

static_assert(requires(render::vulkan_backend::fake_vulkan_native_device_creator_options options) {
    { options.fail_creation } -> std::same_as<bool&>;
    { options.failure_result } -> std::same_as<std::int32_t&>;
    { options.handle } -> std::same_as<render::vulkan_backend::vulkan_device_handle&>;
    { options.queue_handle_base } -> std::same_as<std::uintptr_t&>;
    { options.unavailable_queue_family_indices } -> std::same_as<std::vector<std::size_t>&>;
});

static_assert(requires(render::vulkan_backend::fake_vulkan_native_device_extension_query_options options) {
    { options.available_extensions } -> std::same_as<std::vector<std::string>&>;
    { options.fail_enumeration } -> std::same_as<bool&>;
    { options.failure_result } -> std::same_as<std::int32_t&>;
});

static_assert(requires(render::vulkan_backend::fake_vulkan_native_device_extension_query_state state) {
    { state.query_call_count } -> std::same_as<std::size_t&>;
    { state.requested_physical_device }
        -> std::same_as<render::vulkan_backend::vulkan_physical_device_handle&>;
    { state.last_enumerate_device_extension_properties }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_pointer&>;
});

static_assert(requires(render::vulkan_backend::fake_vulkan_native_device_creator_state state) {
    { state.create_call_count } -> std::same_as<std::size_t&>;
    { state.get_queue_call_count } -> std::same_as<std::size_t&>;
    { state.destroy_call_count } -> std::same_as<std::size_t&>;
    { state.requested_physical_device }
        -> std::same_as<render::vulkan_backend::vulkan_physical_device_handle&>;
    { state.destroyed_device } -> std::same_as<render::vulkan_backend::vulkan_device_handle&>;
    { state.last_create_device }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_pointer&>;
    { state.last_get_device_queue }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_pointer&>;
    { state.last_destroy_device }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_pointer&>;
    { state.requested_queue_family_indices } -> std::same_as<std::vector<std::size_t>&>;
    { state.requested_extensions } -> std::same_as<std::vector<std::string>&>;
});
...
static_assert(std::default_initializable<render::vulkan_backend::fake_vulkan_native_physical_device_enumerator>);
static_assert(std::constructible_from<
    render::vulkan_backend::fake_vulkan_native_physical_device_enumerator,
    render::vulkan_backend::fake_vulkan_native_physical_device_enumerator_options>);
static_assert(std::default_initializable<render::vulkan_backend::vulkan_native_physical_device_enumerator>);
static_assert(requires(
    render::vulkan_backend::fake_vulkan_native_physical_device_enumerator fake,
    const render::vulkan_backend::vulkan_native_physical_device_dispatch_table& dispatch_table) {
    { fake.enumerate_physical_devices(dispatch_table) }
        -> std::same_as<render::vulkan_backend::vulkan_native_physical_device_enumeration_result>;
    { fake.state() }
        -> std::same_as<const render::vulkan_backend::fake_vulkan_native_physical_device_enumerator_state&>;
});
static_assert(requires(
    render::vulkan_backend::vulkan_native_physical_device_enumerator enumerator,
    const render::vulkan_backend::vulkan_native_physical_device_dispatch_table& dispatch_table) {
    { enumerator.enumerate_physical_devices(dispatch_table) }
        -> std::same_as<render::vulkan_backend::vulkan_native_physical_device_enumeration_result>;
});
...
static_assert(std::constructible_from<
    ...
    render::vulkan_backend::fake_vulkan_native_physical_device_selector_options>);
static_assert(requires(
...
static_assert(std::default_initializable<render::vulkan_backend::fake_vulkan_native_device_extension_query>);
static_assert(std::constructible_from<
    render::vulkan_backend::fake_vulkan_native_device_extension_query,
    render::vulkan_backend::fake_vulkan_native_device_extension_query_options>);
static_assert(std::default_initializable<render::vulkan_backend::vulkan_native_device_extension_query>);
static_assert(requires(
    render::vulkan_backend::fake_vulkan_native_device_extension_query fake,
    const render::vulkan_backend::vulkan_native_device_dispatch_table& dispatch_table,
    const render::vulkan_backend::vulkan_native_physical_device_selection_result& selection) {
    { fake.query_device_extensions(dispatch_table, selection) }
        -> std::same_as<render::vulkan_backend::vulkan_native_device_extension_query_result>;
    { fake.state() }
        -> std::same_as<const render::vulkan_backend::fake_vulkan_native_device_extension_query_state&>;
});
static_assert(requires(
    render::vulkan_backend::vulkan_native_device_extension_query query,
    const render::vulkan_backend::vulkan_native_device_dispatch_table& dispatch_table,
    const render::vulkan_backend::vulkan_native_physical_device_selection_result& selection) {
    { query.query_device_extensions(dispatch_table, selection) }
        -> std::same_as<render::vulkan_backend::vulkan_native_device_extension_query_result>;
});

static_assert(std::default_initializable<render::vulkan_backend::fake_vulkan_native_device_creator>);
static_assert(std::constructible_from<
    render::vulkan_backend::fake_vulkan_native_device_creator,
    render::vulkan_backend::fake_vulkan_native_device_creator_options>);
static_assert(std::default_initializable<render::vulkan_backend::vulkan_native_device_creator>);
static_assert(requires(
    render::vulkan_backend::fake_vulkan_native_device_creator fake,
    const render::vulkan_backend::vulkan_native_device_dispatch_table& dispatch_table,
    const render::vulkan_backend::vulkan_native_device_extension_query_result& extension_query,
    const render::vulkan_backend::vulkan_native_physical_device_selection_result& selection) {
    { fake.create_device(dispatch_table, extension_query, selection) }
        -> std::same_as<render::vulkan_backend::vulkan_native_device_create_result>;
    { fake.state() }
        -> std::same_as<const render::vulkan_backend::fake_vulkan_native_device_creator_state&>;
});
static_assert(requires(
    render::vulkan_backend::vulkan_native_device_creator creator,
    const render::vulkan_backend::vulkan_native_device_dispatch_table& dispatch_table,
    const render::vulkan_backend::vulkan_native_device_extension_query_result& extension_query,
    const render::vulkan_backend::vulkan_native_physical_device_selection_result& selection) {
    { creator.create_device(dispatch_table, extension_query, selection) }
        -> std::same_as<render::vulkan_backend::vulkan_native_device_create_result>;
});
...
static_assert(requires(
    ...
    const render::vulkan_backend::vulkan_native_function_table_diagnostics& diagnostics) {
    { render::vulkan_backend::default_vulkan_native_backend_entrypoints() }
        -> std::same_as<std::vector<render::vulkan_backend::vulkan_native_entrypoint_symbol_request>>;
    { render::vulkan_backend::default_vulkan_native_swapchain_entrypoints() }
        -> std::same_as<std::vector<render::vulkan_backend::vulkan_native_entrypoint_symbol_request>>;
    ...
    { render::vulkan_backend::summarize_vulkan_native_swapchain_entrypoints(diagnostics) }
...
static_assert(requires(
    ...
    render::vulkan_backend::vulkan_native_device_extension_query_interface& native_device_extension_query,
    render::vulkan_backend::vulkan_native_device_creator_interface& native_device_creator,
    const render::vulkan_backend::vulkan_instance_create_result& instance_result,
    const render::vulkan_backend::vulkan_native_instance_create_result& native_instance_create_result,
    ...
    const render::vulkan_backend::vulkan_native_physical_device_selection_result& physical_device_selection,
    const render::vulkan_backend::vulkan_native_device_dispatch_table& native_device_dispatch_table,
    const render::vulkan_backend::vulkan_native_device_extension_query_result& native_device_extension_query_result,
    const render::vulkan_backend::vulkan_device_create_request& request) {
    { render::vulkan_backend::create_vulkan_device(
        factory,
        instance_result,
        request) } -> std::same_as<render::vulkan_backend::vulkan_device_create_result>;
    { render::vulkan_backend::collect_vulkan_native_physical_device_dispatch_table(
        native_instance_resolver,
        native_instance_create_result) }
        -> std::same_as<render::vulkan_backend::vulkan_native_physical_device_dispatch_table>;
    { render::vulkan_backend::enumerate_native_vulkan_physical_devices(
    ...
    { render::vulkan_backend::select_native_vulkan_physical_device(
        ...
        request) }
        -> std::same_as<render::vulkan_backend::vulkan_native_physical_device_selection_result>;
    { render::vulkan_backend::collect_vulkan_native_device_dispatch_table(
        native_instance_resolver,
        physical_device_selection) }
        -> std::same_as<render::vulkan_backend::vulkan_native_device_dispatch_table>;
    { render::vulkan_backend::query_native_vulkan_device_extensions(
        native_device_extension_query,
        native_device_dispatch_table,
        physical_device_selection) }
        -> std::same_as<render::vulkan_backend::vulkan_native_device_extension_query_result>;
    { render::vulkan_backend::create_native_vulkan_device(
        native_device_creator,
        native_device_dispatch_table,
        native_device_extension_query_result,
        physical_device_selection) }
        -> std::same_as<render::vulkan_backend::vulkan_native_device_create_result>;
});
...
static_assert(requires(
    ...
    const render::vulkan_backend::vulkan_native_framebuffer_targets_execution_request&
        framebuffer_request,
    const render::vulkan_backend::vulkan_native_framebuffer_targets_destroy_request&
        framebuffer_destroy_request) {
    { render::vulkan_backend::collect_vulkan_native_framebuffer_dispatch_table(
        native_function_diagnostics) } -> std::same_as<
        render::vulkan_backend::vulkan_native_framebuffer_dispatch_table>;
    { render::vulkan_backend::create_native_vulkan_framebuffer_targets(
        framebuffer_operation,
        framebuffer_request) } -> std::same_as<
        render::vulkan_backend::vulkan_native_framebuffer_targets_execution_result>;
    { render::vulkan_backend::destroy_native_vulkan_framebuffer_targets(
        framebuffer_operation,
        framebuffer_destroy_request) } -> std::same_as<
        render::vulkan_backend::vulkan_native_framebuffer_targets_destroy_result>;
});
...
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_surface_query_dispatch_table_status::not_checked),
    render::vulkan_backend::vulkan_native_surface_query_dispatch_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_surface_query_dispatch_table_status::ready),
    render::vulkan_backend::vulkan_native_surface_query_dispatch_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_surface_query_dispatch_table_status::device_unavailable),
    render::vulkan_backend::vulkan_native_surface_query_dispatch_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_surface_query_dispatch_table_status::get_instance_proc_address_unavailable),
    render::vulkan_backend::vulkan_native_surface_query_dispatch_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_surface_query_dispatch_table_status::missing_surface_support_symbol),
    render::vulkan_backend::vulkan_native_surface_query_dispatch_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_surface_query_dispatch_table_status::missing_surface_capabilities_symbol),
    render::vulkan_backend::vulkan_native_surface_query_dispatch_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_surface_query_dispatch_table_status::missing_surface_formats_symbol),
    render::vulkan_backend::vulkan_native_surface_query_dispatch_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_surface_query_dispatch_table_status::missing_surface_present_modes_symbol),
    render::vulkan_backend::vulkan_native_surface_query_dispatch_table_status>);

static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_surface_capability_query_status::not_checked),
    render::vulkan_backend::vulkan_native_surface_capability_query_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_surface_capability_query_status::ready),
    render::vulkan_backend::vulkan_native_surface_capability_query_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_surface_capability_query_status::dispatch_table_unavailable),
    render::vulkan_backend::vulkan_native_surface_capability_query_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_surface_capability_query_status::device_unavailable),
    render::vulkan_backend::vulkan_native_surface_capability_query_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_surface_capability_query_status::missing_surface_handle),
    render::vulkan_backend::vulkan_native_surface_capability_query_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_surface_capability_query_status::headers_unavailable),
    render::vulkan_backend::vulkan_native_surface_capability_query_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_surface_capability_query_status::support_query_failed),
    render::vulkan_backend::vulkan_native_surface_capability_query_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_surface_capability_query_status::capabilities_query_failed),
    render::vulkan_backend::vulkan_native_surface_capability_query_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_surface_capability_query_status::formats_query_failed),
    render::vulkan_backend::vulkan_native_surface_capability_query_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_surface_capability_query_status::present_modes_query_failed),
    render::vulkan_backend::vulkan_native_surface_capability_query_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_surface_capability_query_status::unsupported_present_queue),
    render::vulkan_backend::vulkan_native_surface_capability_query_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_surface_capability_query_status::zero_surface_formats),
    render::vulkan_backend::vulkan_native_surface_capability_query_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_surface_capability_query_status::zero_present_modes),
    render::vulkan_backend::vulkan_native_surface_capability_query_status>);
...
static_assert(std::same_as<
    ...
    render::vulkan_backend::vulkan_native_swapchain_create_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_create_operation_status::surface_query_unavailable),
    render::vulkan_backend::vulkan_native_swapchain_create_operation_status>);
static_assert(std::same_as<
...
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_operation_dispatch_table_status::not_checked),
    render::vulkan_backend::vulkan_native_swapchain_operation_dispatch_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_operation_dispatch_table_status::ready),
    render::vulkan_backend::vulkan_native_swapchain_operation_dispatch_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_operation_dispatch_table_status::function_table_unavailable),
    render::vulkan_backend::vulkan_native_swapchain_operation_dispatch_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_operation_dispatch_table_status::required_extension_unavailable),
    render::vulkan_backend::vulkan_native_swapchain_operation_dispatch_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_operation_dispatch_table_status::missing_create_symbol),
    render::vulkan_backend::vulkan_native_swapchain_operation_dispatch_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_operation_dispatch_table_status::missing_destroy_symbol),
    render::vulkan_backend::vulkan_native_swapchain_operation_dispatch_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_operation_dispatch_table_status::missing_images_symbol),
    render::vulkan_backend::vulkan_native_swapchain_operation_dispatch_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_operation_dispatch_table_status::missing_acquire_symbol),
    render::vulkan_backend::vulkan_native_swapchain_operation_dispatch_table_status>);

static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_create_execution_status::not_requested),
    render::vulkan_backend::vulkan_native_swapchain_create_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_create_execution_status::created),
    render::vulkan_backend::vulkan_native_swapchain_create_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_create_execution_status::create_operation_unavailable),
    render::vulkan_backend::vulkan_native_swapchain_create_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_create_execution_status::dispatch_table_unavailable),
    render::vulkan_backend::vulkan_native_swapchain_create_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_create_execution_status::creation_failed),
    render::vulkan_backend::vulkan_native_swapchain_create_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_create_execution_status::invalid_created_handle),
    render::vulkan_backend::vulkan_native_swapchain_create_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_create_execution_status::headers_unavailable),
    render::vulkan_backend::vulkan_native_swapchain_create_execution_status>);

static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_destroy_execution_status::not_requested),
    render::vulkan_backend::vulkan_native_swapchain_destroy_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_destroy_execution_status::destroyed),
    render::vulkan_backend::vulkan_native_swapchain_destroy_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_destroy_execution_status::dispatch_table_unavailable),
    render::vulkan_backend::vulkan_native_swapchain_destroy_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_destroy_execution_status::invalid_device),
    render::vulkan_backend::vulkan_native_swapchain_destroy_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_destroy_execution_status::missing_swapchain_handle),
    render::vulkan_backend::vulkan_native_swapchain_destroy_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_destroy_execution_status::destroy_failed),
    render::vulkan_backend::vulkan_native_swapchain_destroy_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_destroy_execution_status::headers_unavailable),
    render::vulkan_backend::vulkan_native_swapchain_destroy_execution_status>);

static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_images_execution_status::not_requested),
    render::vulkan_backend::vulkan_native_swapchain_images_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_images_execution_status::enumerated),
    render::vulkan_backend::vulkan_native_swapchain_images_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_images_execution_status::create_execution_unavailable),
    render::vulkan_backend::vulkan_native_swapchain_images_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_images_execution_status::dispatch_table_unavailable),
    render::vulkan_backend::vulkan_native_swapchain_images_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_images_execution_status::invalid_device),
    render::vulkan_backend::vulkan_native_swapchain_images_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_images_execution_status::missing_swapchain_handle),
    render::vulkan_backend::vulkan_native_swapchain_images_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_images_execution_status::image_count_unavailable),
    render::vulkan_backend::vulkan_native_swapchain_images_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_images_execution_status::enumeration_failed),
    render::vulkan_backend::vulkan_native_swapchain_images_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_images_execution_status::zero_images),
    render::vulkan_backend::vulkan_native_swapchain_images_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_images_execution_status::headers_unavailable),
    render::vulkan_backend::vulkan_native_swapchain_images_execution_status>);

static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_acquire_execution_status::not_requested),
    render::vulkan_backend::vulkan_native_swapchain_acquire_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_acquire_execution_status::acquired),
    render::vulkan_backend::vulkan_native_swapchain_acquire_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_acquire_execution_status::images_execution_unavailable),
    render::vulkan_backend::vulkan_native_swapchain_acquire_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_acquire_execution_status::acquire_plan_unavailable),
    render::vulkan_backend::vulkan_native_swapchain_acquire_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_acquire_execution_status::dispatch_table_unavailable),
    render::vulkan_backend::vulkan_native_swapchain_acquire_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_acquire_execution_status::invalid_device),
    render::vulkan_backend::vulkan_native_swapchain_acquire_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_acquire_execution_status::missing_swapchain_handle),
    render::vulkan_backend::vulkan_native_swapchain_acquire_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_acquire_execution_status::sync_unavailable),
    render::vulkan_backend::vulkan_native_swapchain_acquire_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_acquire_execution_status::image_binding_unavailable),
    render::vulkan_backend::vulkan_native_swapchain_acquire_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_acquire_execution_status::timeout),
    render::vulkan_backend::vulkan_native_swapchain_acquire_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_acquire_execution_status::out_of_date),
    render::vulkan_backend::vulkan_native_swapchain_acquire_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_acquire_execution_status::suboptimal),
    render::vulkan_backend::vulkan_native_swapchain_acquire_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_acquire_execution_status::acquire_failed),
    render::vulkan_backend::vulkan_native_swapchain_acquire_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_acquire_execution_status::headers_unavailable),
    render::vulkan_backend::vulkan_native_swapchain_acquire_execution_status>);

static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_images_operation_status::not_checked),
    render::vulkan_backend::vulkan_native_swapchain_images_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_images_operation_status::ready),
    render::vulkan_backend::vulkan_native_swapchain_images_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_images_operation_status::create_operation_unavailable),
    render::vulkan_backend::vulkan_native_swapchain_images_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_images_operation_status::invalid_device),
    render::vulkan_backend::vulkan_native_swapchain_images_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_images_operation_status::missing_swapchain_handle),
    render::vulkan_backend::vulkan_native_swapchain_images_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_images_operation_status::native_entrypoints_unavailable),
    render::vulkan_backend::vulkan_native_swapchain_images_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_images_operation_status::required_extension_unavailable),
    render::vulkan_backend::vulkan_native_swapchain_images_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_images_operation_status::missing_images_symbol),
    render::vulkan_backend::vulkan_native_swapchain_images_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_images_operation_status::image_count_unavailable),
    render::vulkan_backend::vulkan_native_swapchain_images_operation_status>);

static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_acquire_operation_status::not_checked),
    render::vulkan_backend::vulkan_native_swapchain_acquire_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_acquire_operation_status::ready),
    render::vulkan_backend::vulkan_native_swapchain_acquire_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_acquire_operation_status::images_operation_unavailable),
    render::vulkan_backend::vulkan_native_swapchain_acquire_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_acquire_operation_status::acquire_plan_unavailable),
    render::vulkan_backend::vulkan_native_swapchain_acquire_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_acquire_operation_status::invalid_device),
    render::vulkan_backend::vulkan_native_swapchain_acquire_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_acquire_operation_status::missing_swapchain_handle),
    render::vulkan_backend::vulkan_native_swapchain_acquire_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_acquire_operation_status::native_entrypoints_unavailable),
    render::vulkan_backend::vulkan_native_swapchain_acquire_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_acquire_operation_status::required_extension_unavailable),
    render::vulkan_backend::vulkan_native_swapchain_acquire_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_acquire_operation_status::missing_acquire_symbol),
    render::vulkan_backend::vulkan_native_swapchain_acquire_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_acquire_operation_status::image_binding_unavailable),
    render::vulkan_backend::vulkan_native_swapchain_acquire_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_acquire_operation_status::timeout),
    render::vulkan_backend::vulkan_native_swapchain_acquire_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_acquire_operation_status::out_of_date),
    render::vulkan_backend::vulkan_native_swapchain_acquire_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_acquire_operation_status::suboptimal),
    render::vulkan_backend::vulkan_native_swapchain_acquire_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_acquire_operation_status::error),
    render::vulkan_backend::vulkan_native_swapchain_acquire_operation_status>);
...
static_assert(requires(
    ...
    render::vulkan_backend::vulkan_native_swapchain_images_operation_status
        native_images_status,
    render::vulkan_backend::vulkan_native_swapchain_acquire_operation_status
        native_acquire_status) {
    ...
    { render::vulkan_backend::native_swapchain_images_operation_status_name(
        native_images_status) } -> std::same_as<std::string_view>;
    { render::vulkan_backend::native_swapchain_acquire_operation_status_name(
        native_acquire_status) } -> std::same_as<std::string_view>;
});
...
static_assert(requires(render::vulkan_backend::vulkan_native_surface_query_dispatch_table table) {
    { table.checked } -> std::same_as<bool&>;
    { table.status }
        -> std::same_as<render::vulkan_backend::vulkan_native_surface_query_dispatch_table_status&>;
    { table.instance } -> std::same_as<render::vulkan_backend::vulkan_instance_handle&>;
    { table.physical_device }
        -> std::same_as<render::vulkan_backend::vulkan_physical_device_handle&>;
    { table.get_instance_proc_address }
    ...
    { table.missing_symbol_name } -> std::same_as<std::string&>;
    { table.diagnostic } -> std::same_as<std::string&>;
    { table.ready_for_query() } -> std::same_as<bool>;
});

static_assert(requires(render::vulkan_backend::vulkan_native_surface_capability_query_result result) {
    { result.checked } -> std::same_as<bool&>;
    { result.status }
        -> std::same_as<render::vulkan_backend::vulkan_native_surface_capability_query_status&>;
    { result.dispatch_table }
        -> std::same_as<render::vulkan_backend::vulkan_native_surface_query_dispatch_table&>;
    { result.device }
        -> std::same_as<render::vulkan_backend::vulkan_native_device_create_result&>;
    { result.surface } -> std::same_as<render::vulkan_backend::vulkan_surface_handle&>;
    { result.physical_device }
    ...
    { result.support_query_checked } -> std::same_as<bool&>;
    { result.capabilities_query_checked } -> std::same_as<bool&>;
    { result.formats_query_checked } -> std::same_as<bool&>;
    { result.present_modes_query_checked } -> std::same_as<bool&>;
    { result.present_queue_supported } -> std::same_as<bool&>;
    { result.surface_format_count } -> std::same_as<std::size_t&>;
    { result.present_mode_count } -> std::same_as<std::size_t&>;
    { result.native_result } -> std::same_as<std::int32_t&>;
    { result.diagnostic } -> std::same_as<std::string&>;
    { result.ready_for_swapchain_create() } -> std::same_as<bool>;
});

static_assert(requires(render::vulkan_backend::fake_vulkan_native_surface_capability_query_options options) {
    { options.capabilities }
        -> std::same_as<render::vulkan_backend::vulkan_swapchain_surface_capabilities_snapshot&>;
    { options.present_queue_supported } -> std::same_as<bool&>;
    { options.fail_support_query } -> std::same_as<bool&>;
    { options.fail_capabilities_query } -> std::same_as<bool&>;
    { options.fail_formats_query } -> std::same_as<bool&>;
    { options.fail_present_modes_query } -> std::same_as<bool&>;
    { options.failure_result } -> std::same_as<std::int32_t&>;
});

static_assert(requires(render::vulkan_backend::fake_vulkan_native_surface_capability_query_state state) {
    { state.query_call_count } -> std::same_as<std::size_t&>;
    { state.requested_surface }
        -> std::same_as<render::vulkan_backend::vulkan_surface_handle&>;
    { state.requested_physical_device }
        -> std::same_as<render::vulkan_backend::vulkan_physical_device_handle&>;
    { state.requested_present_queue_family_index } -> std::same_as<std::size_t&>;
    { state.last_get_physical_device_surface_support }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_pointer&>;
    { state.last_get_physical_device_surface_capabilities }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_pointer&>;
    { state.last_get_physical_device_surface_formats }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_pointer&>;
    { state.last_get_physical_device_surface_present_modes }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_pointer&>;
});

static_assert(std::default_initializable<render::vulkan_backend::fake_vulkan_native_surface_capability_query>);
static_assert(std::constructible_from<
    render::vulkan_backend::fake_vulkan_native_surface_capability_query,
    render::vulkan_backend::fake_vulkan_native_surface_capability_query_options>);
static_assert(std::default_initializable<render::vulkan_backend::vulkan_native_surface_capability_query>);
static_assert(requires(
    render::vulkan_backend::fake_vulkan_native_surface_capability_query fake,
    const render::vulkan_backend::vulkan_native_surface_query_dispatch_table& dispatch_table,
    const render::vulkan_backend::vulkan_native_device_create_result& device,
    render::vulkan_backend::vulkan_surface_handle surface,
    std::size_t present_queue_family_index) {
    { fake.query_surface_capabilities(
        dispatch_table,
        device,
        surface,
        present_queue_family_index) }
        -> std::same_as<render::vulkan_backend::vulkan_native_surface_capability_query_result>;
    { fake.state() }
        -> std::same_as<const render::vulkan_backend::fake_vulkan_native_surface_capability_query_state&>;
});
static_assert(requires(
    render::vulkan_backend::vulkan_native_surface_capability_query query,
    const render::vulkan_backend::vulkan_native_surface_query_dispatch_table& dispatch_table,
    const render::vulkan_backend::vulkan_native_device_create_result& device,
    render::vulkan_backend::vulkan_surface_handle surface,
    std::size_t present_queue_family_index) {
    { query.query_surface_capabilities(
        dispatch_table,
        device,
        surface,
        present_queue_family_index) }
...
static_assert(requires(
    ...
    { summary.surface_query_checked } -> std::same_as<bool&>;
    { summary.surface_query_ready } -> std::same_as<bool&>;
    { summary.present_queue_supported } -> std::same_as<bool&>;
    { summary.surface_format_count } -> std::same_as<std::size_t&>;
    { summary.present_mode_count } -> std::same_as<std::size_t&>;
...
static_assert(requires(
    ...
    { result.surface_query_checked } -> std::same_as<bool&>;
    { result.surface_query_ready } -> std::same_as<bool&>;
    { result.present_queue_supported } -> std::same_as<bool&>;
    { result.surface_format_count } -> std::same_as<std::size_t&>;
    { result.present_mode_count } -> std::same_as<std::size_t&>;
    { result.required_extensions_ready } -> std::same_as<bool&>;
...
static_assert(requires(
    render::vulkan_backend::vulkan_native_swapchain_operation_dispatch_table table) {
    { table.checked } -> std::same_as<bool&>;
    { table.status } -> std::same_as<
        render::vulkan_backend::vulkan_native_swapchain_operation_dispatch_table_status&>;
    { table.function_table_status }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_table_status&>;
    { table.function_table_checked } -> std::same_as<bool&>;
    { table.required_extensions_ready } -> std::same_as<bool&>;
    { table.create_swapchain }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_pointer&>;
    { table.destroy_swapchain }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_pointer&>;
    { table.get_swapchain_images }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_pointer&>;
    { table.acquire_next_image }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_pointer&>;
    { table.missing_required_extension } -> std::same_as<std::string&>;
    { table.missing_symbol_name } -> std::same_as<std::string&>;
    { table.diagnostic } -> std::same_as<std::string&>;
    { table.ready_for_create() } -> std::same_as<bool>;
    { table.ready_for_destroy() } -> std::same_as<bool>;
    { table.ready_for_images() } -> std::same_as<bool>;
    { table.ready_for_acquire() } -> std::same_as<bool>;
});

static_assert(requires(
    render::vulkan_backend::vulkan_native_swapchain_create_execution_request request) {
    { request.create_operation }
        -> std::same_as<render::vulkan_backend::vulkan_native_swapchain_create_operation_result&>;
    { request.dispatch_table } -> std::same_as<
        render::vulkan_backend::vulkan_native_swapchain_operation_dispatch_table&>;
});

static_assert(requires(
    render::vulkan_backend::vulkan_native_swapchain_create_execution_result result) {
    { result.checked } -> std::same_as<bool&>;
    { result.status }
        -> std::same_as<render::vulkan_backend::vulkan_native_swapchain_create_execution_status&>;
    ...
    { result.selected_present_mode }
        -> std::same_as<render::vulkan_backend::vulkan_swapchain_present_mode&>;
    { result.selected_image_count } -> std::same_as<std::size_t&>;
    { result.selected_queue_family_indices } -> std::same_as<std::vector<std::size_t>&>;
    { result.selected_queue_family_count } -> std::same_as<std::size_t&>;
    { result.create_swapchain_symbol }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_pointer&>;
    { result.destroy_swapchain_symbol }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_pointer&>;
    { result.create_operation_ready } -> std::same_as<bool&>;
    { result.dispatch_table_ready } -> std::same_as<bool&>;
    { result.vk_create_swapchain_called } -> std::same_as<bool&>;
    { result.old_swapchain_handoff } -> std::same_as<bool&>;
    { result.native_result } -> std::same_as<std::int32_t&>;
    { result.diagnostic } -> std::same_as<std::string&>;
    { result.ready_for_images() } -> std::same_as<bool>;
    { result.blocked() } -> std::same_as<bool>;
});

static_assert(requires(
    render::vulkan_backend::vulkan_native_swapchain_destroy_execution_request request) {
    { request.dispatch_table } -> std::same_as<
        render::vulkan_backend::vulkan_native_swapchain_operation_dispatch_table&>;
    { request.device } -> std::same_as<render::vulkan_backend::vulkan_device_handle&>;
...
static_assert(requires(
    render::vulkan_backend::vulkan_native_swapchain_destroy_execution_result result) {
    { result.checked } -> std::same_as<bool&>;
    { result.status }
        -> std::same_as<render::vulkan_backend::vulkan_native_swapchain_destroy_execution_status&>;
    { result.dispatch_table } -> std::same_as<
        render::vulkan_backend::vulkan_native_swapchain_operation_dispatch_table&>;
    { result.device } -> std::same_as<render::vulkan_backend::vulkan_device_handle&>;
    ...
    { result.destroy_swapchain_symbol }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_pointer&>;
    { result.dispatch_table_ready } -> std::same_as<bool&>;
    { result.vk_destroy_swapchain_called } -> std::same_as<bool&>;
    { result.diagnostic } -> std::same_as<std::string&>;
    { result.destroyed() } -> std::same_as<bool>;
    { result.blocked() } -> std::same_as<bool>;
});
...
static_assert(requires(
    render::vulkan_backend::vulkan_native_swapchain_images_execution_request request) {
...
static_assert(requires(
    render::vulkan_backend::vulkan_native_swapchain_images_execution_result result) {
    { result.checked } -> std::same_as<bool&>;
    { result.status }
        -> std::same_as<render::vulkan_backend::vulkan_native_swapchain_images_execution_status&>;
    ...
    { result.images }
        -> std::same_as<std::vector<render::vulkan_backend::vulkan_native_swapchain_image_binding>&>;
    { result.selected_extent } -> std::same_as<render::vulkan_backend::vulkan_surface_extent&>;
    { result.selected_surface_format }
        -> std::same_as<render::vulkan_backend::vulkan_swapchain_surface_format&>;
    { result.selected_present_mode }
    ...
    { result.native_result } -> std::same_as<std::int32_t&>;
    { result.diagnostic } -> std::same_as<std::string&>;
    { result.ready_for_acquire() } -> std::same_as<bool>;
    { result.blocked() } -> std::same_as<bool>;
});

static_assert(requires(render::vulkan_backend::vulkan_native_sync_handle handle) {
    { handle.value } -> std::same_as<std::uintptr_t&>;
    { handle.valid() } -> std::same_as<bool>;
});

static_assert(requires(
    render::vulkan_backend::vulkan_native_swapchain_acquire_execution_request request) {
    ...
    { request.dispatch_table } -> std::same_as<
        render::vulkan_backend::vulkan_native_swapchain_operation_dispatch_table&>;
    { request.image_available_semaphore }
        -> std::same_as<render::vulkan_backend::vulkan_native_sync_handle&>;
    { request.fence } -> std::same_as<render::vulkan_backend::vulkan_native_sync_handle&>;
});

static_assert(requires(
    render::vulkan_backend::vulkan_native_swapchain_acquire_execution_result result) {
    { result.checked } -> std::same_as<bool&>;
    { result.status }
        -> std::same_as<render::vulkan_backend::vulkan_native_swapchain_acquire_execution_status&>;
    { result.images_execution }
        -> std::same_as<render::vulkan_backend::vulkan_native_swapchain_images_execution_result&>;
    { result.acquire_plan }
        -> std::same_as<render::vulkan_backend::vulkan_swapchain_image_acquire_plan_result&>;
    { result.dispatch_table } -> std::same_as<
    ...
    { result.image_handle }
        -> std::same_as<render::vulkan_backend::vulkan_swapchain_image_handle&>;
    { result.timeout_nanoseconds } -> std::same_as<std::uint64_t&>;
    { result.acquire_status }
        -> std::same_as<render::vulkan_backend::vulkan_swapchain_acquire_status&>;
    { result.acquire_plan_status }
        -> std::same_as<render::vulkan_backend::vulkan_swapchain_image_acquire_plan_status&>;
    { result.image_available_semaphore }
        -> std::same_as<render::vulkan_backend::vulkan_native_sync_handle&>;
    { result.fence } -> std::same_as<render::vulkan_backend::vulkan_native_sync_handle&>;
    { result.acquire_next_image_symbol }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_pointer&>;
    { result.images_execution_ready } -> std::same_as<bool&>;
    { result.acquire_plan_checked } -> std::same_as<bool&>;
    ...
    { result.vk_acquire_next_image_called } -> std::same_as<bool&>;
    { result.command_recording_may_consume_acquired_image } -> std::same_as<bool&>;
    { result.native_result } -> std::same_as<std::int32_t&>;
    { result.diagnostic } -> std::same_as<std::string&>;
    { result.ready_for_command_recording() } -> std::same_as<bool>;
    { result.blocked() } -> std::same_as<bool>;
...
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_image_view_dispatch_table_status::ready),
    render::vulkan_backend::vulkan_native_image_view_dispatch_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_image_view_dispatch_table_status::missing_create_symbol),
    render::vulkan_backend::vulkan_native_image_view_dispatch_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_image_view_dispatch_table_status::missing_destroy_symbol),
    render::vulkan_backend::vulkan_native_image_view_dispatch_table_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_image_view_target_lifecycle_status::ready),
    render::vulkan_backend::vulkan_native_swapchain_image_view_target_lifecycle_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_image_view_targets_execution_status::ready),
    render::vulkan_backend::vulkan_native_swapchain_image_view_targets_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_swapchain_image_view_targets_destroy_status::destroyed),
    render::vulkan_backend::vulkan_native_swapchain_image_view_targets_destroy_status>);

static_assert(requires(render::vulkan_backend::vulkan_swapchain_image_view_handle handle) {
    { handle.value } -> std::same_as<std::uintptr_t&>;
    { handle.valid() } -> std::same_as<bool>;
});

static_assert(requires(
    render::vulkan_backend::vulkan_swapchain_image_view_target_intent intent) {
    { intent.usage }
        -> std::same_as<render::vulkan_backend::vulkan_swapchain_image_view_usage_intent&>;
    { intent.aspect }
        -> std::same_as<render::vulkan_backend::vulkan_swapchain_image_view_aspect_intent&>;
});

static_assert(requires(
    render::vulkan_backend::vulkan_native_image_view_dispatch_table table) {
    { table.checked } -> std::same_as<bool&>;
    { table.status }
        -> std::same_as<render::vulkan_backend::vulkan_native_image_view_dispatch_table_status&>;
    { table.function_table_status }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_table_status&>;
    { table.function_table_checked } -> std::same_as<bool&>;
    { table.create_image_view }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_pointer&>;
    { table.destroy_image_view }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_pointer&>;
    { table.missing_symbol_name } -> std::same_as<std::string&>;
    { table.diagnostic } -> std::same_as<std::string&>;
    { table.ready_for_create() } -> std::same_as<bool>;
...
static_assert(requires(
    render::vulkan_backend::vulkan_native_swapchain_image_view_target target) {
    { target.image_index } -> std::same_as<std::size_t&>;
    { target.image_id } -> std::same_as<render::vulkan_backend::vulkan_swapchain_image_id&>;
    { target.image_handle }
        -> std::same_as<render::vulkan_backend::vulkan_swapchain_image_handle&>;
    { target.selected_image_format }
        -> std::same_as<render::vulkan_backend::vulkan_swapchain_image_format&>;
    { target.extent } -> std::same_as<render::vulkan_backend::vulkan_surface_extent&>;
    { target.usage_intent }
        -> std::same_as<render::vulkan_backend::vulkan_swapchain_image_view_usage_intent&>;
    { target.aspect_intent }
        -> std::same_as<render::vulkan_backend::vulkan_swapchain_image_view_aspect_intent&>;
    { target.image_view }
        -> std::same_as<render::vulkan_backend::vulkan_swapchain_image_view_handle&>;
    { target.lifecycle_status } -> std::same_as<
        render::vulkan_backend::vulkan_native_swapchain_image_view_target_lifecycle_status&>;
    { target.image_ready } -> std::same_as<bool&>;
    { target.image_view_ready } -> std::same_as<bool&>;
    { target.render_target_ready } -> std::same_as<bool&>;
    { target.vk_create_image_view_called } -> std::same_as<bool&>;
    { target.vk_destroy_image_view_called } -> std::same_as<bool&>;
    { target.native_result } -> std::same_as<std::int32_t&>;
    { target.ready() } -> std::same_as<bool>;
});

static_assert(requires(
    render::vulkan_backend::vulkan_native_swapchain_image_view_targets_execution_request request) {
    { request.images_execution }
        -> std::same_as<render::vulkan_backend::vulkan_native_swapchain_images_execution_result&>;
    { request.dispatch_table }
        -> std::same_as<render::vulkan_backend::vulkan_native_image_view_dispatch_table&>;
    { request.intent }
        -> std::same_as<render::vulkan_backend::vulkan_swapchain_image_view_target_intent&>;
});

static_assert(requires(
    render::vulkan_backend::vulkan_native_swapchain_image_view_targets_execution_result result) {
    { result.checked } -> std::same_as<bool&>;
    { result.status } -> std::same_as<
        render::vulkan_backend::vulkan_native_swapchain_image_view_targets_execution_status&>;
    { result.images_execution }
        -> std::same_as<render::vulkan_backend::vulkan_native_swapchain_images_execution_result&>;
    { result.dispatch_table }
    ...
    { result.swapchain } -> std::same_as<render::vulkan_backend::vulkan_swapchain_handle&>;
    { result.extent } -> std::same_as<render::vulkan_backend::vulkan_surface_extent&>;
    { result.selected_image_format }
        -> std::same_as<render::vulkan_backend::vulkan_swapchain_image_format&>;
    { result.usage_intent }
        -> std::same_as<render::vulkan_backend::vulkan_swapchain_image_view_usage_intent&>;
    { result.aspect_intent }
        -> std::same_as<render::vulkan_backend::vulkan_swapchain_image_view_aspect_intent&>;
    { result.image_count } -> std::same_as<std::size_t&>;
    { result.ready_image_view_count } -> std::same_as<std::size_t&>;
    { result.targets } -> std::same_as<
        std::vector<render::vulkan_backend::vulkan_native_swapchain_image_view_target>&>;
    { result.create_image_view_symbol }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_pointer&>;
    { result.destroy_image_view_symbol }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_pointer&>;
    { result.images_execution_ready } -> std::same_as<bool&>;
    { result.dispatch_table_ready } -> std::same_as<bool&>;
    { result.vk_create_image_view_called } -> std::same_as<bool&>;
    { result.native_result } -> std::same_as<std::int32_t&>;
    { result.diagnostic } -> std::same_as<std::string&>;
    { result.ready_for_render_targets() } -> std::same_as<bool>;
    { result.blocked() } -> std::same_as<bool>;
});

static_assert(requires(
    render::vulkan_backend::vulkan_native_swapchain_image_view_targets_destroy_request request) {
    { request.targets } -> std::same_as<
        render::vulkan_backend::vulkan_native_swapchain_image_view_targets_execution_result&>;
    { request.dispatch_table }
        -> std::same_as<render::vulkan_backend::vulkan_native_image_view_dispatch_table&>;
});
...
static_assert(requires(
    render::vulkan_backend::vulkan_native_swapchain_image_view_targets_destroy_result result) {
    { result.checked } -> std::same_as<bool&>;
    { result.status } -> std::same_as<
        render::vulkan_backend::vulkan_native_swapchain_image_view_targets_destroy_status&>;
    { result.targets } -> std::same_as<
    ...
    { result.dispatch_table }
        -> std::same_as<render::vulkan_backend::vulkan_native_image_view_dispatch_table&>;
    { result.device } -> std::same_as<render::vulkan_backend::vulkan_device_handle&>;
    { result.requested_image_view_count } -> std::same_as<std::size_t&>;
    { result.destroyed_image_view_count } -> std::same_as<std::size_t&>;
    { result.destroy_image_view_symbol }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_pointer&>;
    { result.targets_ready } -> std::same_as<bool&>;
    { result.dispatch_table_ready } -> std::same_as<bool&>;
    { result.vk_destroy_image_view_called } -> std::same_as<bool&>;
    { result.native_result } -> std::same_as<std::int32_t&>;
    { result.diagnostic } -> std::same_as<std::string&>;
    { result.destroyed() } -> std::same_as<bool>;
    { result.blocked() } -> std::same_as<bool>;
...
static_assert(requires(
    render::vulkan_backend::vulkan_native_swapchain_images_operation_request request) {
    { request.create_operation }
        -> std::same_as<render::vulkan_backend::vulkan_native_swapchain_create_operation_result&>;
    { request.native_entrypoints }
        -> std::same_as<render::vulkan_backend::vulkan_native_swapchain_entrypoint_readiness&>;
...
static_assert(requires(
    render::vulkan_backend::vulkan_native_swapchain_images_operation_summary summary) {
    { summary.checked } -> std::same_as<bool&>;
    { summary.status }
        -> std::same_as<render::vulkan_backend::vulkan_native_swapchain_images_operation_status&>;
    { summary.entrypoint_name } -> std::same_as<std::string&>;
    { summary.vk_get_swapchain_images_callable } -> std::same_as<bool&>;
    { summary.device } -> std::same_as<render::vulkan_backend::vulkan_device_handle&>;
    { summary.swapchain } -> std::same_as<render::vulkan_backend::vulkan_swapchain_handle&>;
    { summary.expected_image_count } -> std::same_as<std::size_t&>;
    { summary.enumerated_image_count } -> std::same_as<std::size_t&>;
    { summary.images }
        -> std::same_as<std::vector<render::vulkan_backend::vulkan_native_swapchain_image_binding>&>;
    { summary.selected_extent }
        -> std::same_as<render::vulkan_backend::vulkan_surface_extent&>;
    ...
    { summary.selected_present_mode }
        -> std::same_as<render::vulkan_backend::vulkan_swapchain_present_mode&>;
    { summary.create_operation_checked } -> std::same_as<bool&>;
    { summary.create_operation_ready } -> std::same_as<bool&>;
    { summary.native_entrypoints_checked } -> std::same_as<bool&>;
    { summary.required_extensions_ready } -> std::same_as<bool&>;
    { summary.get_images_symbol_ready } -> std::same_as<bool&>;
    { summary.device_valid } -> std::same_as<bool&>;
    { summary.swapchain_valid } -> std::same_as<bool&>;
    { summary.missing_required_extension } -> std::same_as<std::string&>;
    { summary.missing_symbol_name } -> std::same_as<std::string&>;
    { summary.diagnostic } -> std::same_as<std::string&>;
    { summary.ready_for_frame_lifecycle_setup() } -> std::same_as<bool>;
});

static_assert(requires(
    render::vulkan_backend::vulkan_native_swapchain_images_operation_result result) {
    { result.checked } -> std::same_as<bool&>;
    { result.status }
        -> std::same_as<render::vulkan_backend::vulkan_native_swapchain_images_operation_status&>;
    { result.create_operation }
    ...
    { result.selected_present_mode }
        -> std::same_as<render::vulkan_backend::vulkan_swapchain_present_mode&>;
    { result.create_operation_checked } -> std::same_as<bool&>;
    { result.create_operation_ready } -> std::same_as<bool&>;
    { result.native_entrypoints_checked } -> std::same_as<bool&>;
    { result.required_extensions_ready } -> std::same_as<bool&>;
    { result.get_images_symbol_ready } -> std::same_as<bool&>;
    { result.device_valid } -> std::same_as<bool&>;
    { result.swapchain_valid } -> std::same_as<bool&>;
    { result.vk_get_swapchain_images_callable } -> std::same_as<bool&>;
    { result.missing_required_extension } -> std::same_as<std::string&>;
    { result.missing_symbol_name } -> std::same_as<std::string&>;
    { result.diagnostic } -> std::same_as<std::string&>;
    { result.operation }
        -> std::same_as<render::vulkan_backend::vulkan_native_swapchain_images_operation_summary&>;
    { result.can_call_vk_get_swapchain_images() } -> std::same_as<bool>;
    { result.blocked() } -> std::same_as<bool>;
});

static_assert(requires(
    render::vulkan_backend::vulkan_native_swapchain_acquire_operation_request request) {
    { request.images_operation }
        -> std::same_as<render::vulkan_backend::vulkan_native_swapchain_images_operation_result&>;
    { request.acquire_plan }
        -> std::same_as<render::vulkan_backend::vulkan_swapchain_image_acquire_plan_result&>;
    { request.native_entrypoints }
        -> std::same_as<render::vulkan_backend::vulkan_native_swapchain_entrypoint_readiness&>;
...
static_assert(requires(
    render::vulkan_backend::vulkan_native_swapchain_acquire_operation_summary summary) {
    { summary.checked } -> std::same_as<bool&>;
    { summary.status }
        -> std::same_as<render::vulkan_backend::vulkan_native_swapchain_acquire_operation_status&>;
    { summary.entrypoint_name } -> std::same_as<std::string&>;
    { summary.vk_acquire_next_image_callable } -> std::same_as<bool&>;
    { summary.command_recording_may_consume_acquired_image } -> std::same_as<bool&>;
    { summary.device } -> std::same_as<render::vulkan_backend::vulkan_device_handle&>;
    { summary.swapchain } -> std::same_as<render::vulkan_backend::vulkan_swapchain_handle&>;
    { summary.selected_image_index } -> std::same_as<std::size_t&>;
    { summary.image_id } -> std::same_as<render::vulkan_backend::vulkan_swapchain_image_id&>;
    { summary.image_handle }
        -> std::same_as<render::vulkan_backend::vulkan_swapchain_image_handle&>;
    { summary.timeout_nanoseconds } -> std::same_as<std::uint64_t&>;
    { summary.acquire_status }
        -> std::same_as<render::vulkan_backend::vulkan_swapchain_acquire_status&>;
    { summary.acquire_plan_status }
        -> std::same_as<render::vulkan_backend::vulkan_swapchain_image_acquire_plan_status&>;
    { summary.images_operation_checked } -> std::same_as<bool&>;
    { summary.images_operation_ready } -> std::same_as<bool&>;
    { summary.acquire_plan_checked } -> std::same_as<bool&>;
    { summary.acquire_plan_ready_for_command_recording } -> std::same_as<bool&>;
    { summary.native_entrypoints_checked } -> std::same_as<bool&>;
    { summary.required_extensions_ready } -> std::same_as<bool&>;
    { summary.acquire_symbol_ready } -> std::same_as<bool&>;
    { summary.device_valid } -> std::same_as<bool&>;
    { summary.swapchain_valid } -> std::same_as<bool&>;
    { summary.image_binding_ready } -> std::same_as<bool&>;
    { summary.image_available } -> std::same_as<bool&>;
    { summary.image_acquired } -> std::same_as<bool&>;
    { summary.timed_out } -> std::same_as<bool&>;
    { summary.out_of_date } -> std::same_as<bool&>;
    { summary.suboptimal } -> std::same_as<bool&>;
    { summary.error } -> std::same_as<bool&>;
    { summary.missing_required_extension } -> std::same_as<std::string&>;
    { summary.missing_symbol_name } -> std::same_as<std::string&>;
    { summary.diagnostic } -> std::same_as<std::string&>;
    { summary.ready_for_command_recording() } -> std::same_as<bool>;
});

static_assert(requires(
    render::vulkan_backend::vulkan_native_swapchain_acquire_operation_result result) {
    { result.checked } -> std::same_as<bool&>;
    { result.status }
        -> std::same_as<render::vulkan_backend::vulkan_native_swapchain_acquire_operation_status&>;
    { result.images_operation }
        -> std::same_as<render::vulkan_backend::vulkan_native_swapchain_images_operation_result&>;
    { result.acquire_plan }
        -> std::same_as<render::vulkan_backend::vulkan_swapchain_image_acquire_plan_result&>;
    { result.native_entrypoints }
    ...
    { result.acquire_plan_status }
        -> std::same_as<render::vulkan_backend::vulkan_swapchain_image_acquire_plan_status&>;
    { result.images_operation_checked } -> std::same_as<bool&>;
    { result.images_operation_ready } -> std::same_as<bool&>;
    { result.acquire_plan_checked } -> std::same_as<bool&>;
    { result.acquire_plan_ready_for_command_recording } -> std::same_as<bool&>;
    { result.native_entrypoints_checked } -> std::same_as<bool&>;
    { result.required_extensions_ready } -> std::same_as<bool&>;
    { result.acquire_symbol_ready } -> std::same_as<bool&>;
    { result.device_valid } -> std::same_as<bool&>;
    { result.swapchain_valid } -> std::same_as<bool&>;
    { result.image_binding_ready } -> std::same_as<bool&>;
    { result.image_available } -> std::same_as<bool&>;
    ...
    { result.suboptimal } -> std::same_as<bool&>;
    { result.error } -> std::same_as<bool&>;
    { result.vk_acquire_next_image_callable } -> std::same_as<bool&>;
    { result.command_recording_may_consume_acquired_image } -> std::same_as<bool&>;
    { result.missing_required_extension } -> std::same_as<std::string&>;
    { result.missing_symbol_name } -> std::same_as<std::string&>;
    { result.diagnostic } -> std::same_as<std::string&>;
    { result.operation }
        -> std::same_as<render::vulkan_backend::vulkan_native_swapchain_acquire_operation_summary&>;
    { result.ready_for_command_recording() } -> std::same_as<bool>;
    { result.blocked() } -> std::same_as<bool>;
});
...
static_assert(requires(
    ...
    render::vulkan_backend::vulkan_native_swapchain_create_operation_request
        native_request,
    render::vulkan_backend::vulkan_native_swapchain_create_execution_request
        native_create_execution_request,
    render::vulkan_backend::vulkan_native_swapchain_destroy_execution_request
        native_destroy_execution_request,
    render::vulkan_backend::vulkan_native_swapchain_images_execution_request
        native_images_execution_request,
    render::vulkan_backend::vulkan_native_swapchain_acquire_execution_request
        native_acquire_execution_request,
    render::vulkan_backend::vulkan_native_swapchain_image_view_targets_execution_request
        native_image_view_targets_request,
    render::vulkan_backend::vulkan_native_swapchain_image_view_targets_destroy_request
        native_image_view_targets_destroy_request,
    render::vulkan_backend::vulkan_native_swapchain_images_operation_request
        native_images_request,
    render::vulkan_backend::vulkan_native_swapchain_acquire_operation_request
        native_acquire_request,
    render::vulkan_backend::vulkan_native_function_table_diagnostics
        native_function_diagnostics,
    render::vulkan_backend::vulkan_native_swapchain_operation_interface&
        native_swapchain_operation,
    render::vulkan_backend::vulkan_native_instance_symbol_resolver_interface&
        native_instance_resolver,
    render::vulkan_backend::vulkan_native_surface_capability_query_interface&
        surface_query,
    const render::vulkan_backend::vulkan_native_device_create_result& native_device,
    const render::vulkan_backend::vulkan_native_surface_query_dispatch_table&
        surface_dispatch,
    render::vulkan_backend::vulkan_surface_handle surface,
    std::size_t present_queue_family_index) {
    { render::vulkan_backend::build_vulkan_swapchain_create_plan(request) }
        -> std::same_as<render::vulkan_backend::vulkan_swapchain_create_plan_result>;
    { render::vulkan_backend::collect_vulkan_native_surface_query_dispatch_table(
        native_instance_resolver,
        native_device) }
        -> std::same_as<render::vulkan_backend::vulkan_native_surface_query_dispatch_table>;
    { render::vulkan_backend::query_native_vulkan_surface_capabilities(
        surface_query,
        surface_dispatch,
        native_device,
        surface,
    ...
    { render::vulkan_backend::collect_vulkan_native_swapchain_operation_dispatch_table(
        native_function_diagnostics) } -> std::same_as<
        render::vulkan_backend::vulkan_native_swapchain_operation_dispatch_table>;
    { render::vulkan_backend::collect_vulkan_native_image_view_dispatch_table(
        native_function_diagnostics) } -> std::same_as<
        render::vulkan_backend::vulkan_native_image_view_dispatch_table>;
    { render::vulkan_backend::create_native_vulkan_swapchain(
        native_swapchain_operation,
        native_create_execution_request) } -> std::same_as<
        render::vulkan_backend::vulkan_native_swapchain_create_execution_result>;
    { render::vulkan_backend::destroy_native_vulkan_swapchain(
        native_swapchain_operation,
        native_destroy_execution_request) } -> std::same_as<
        render::vulkan_backend::vulkan_native_swapchain_destroy_execution_result>;
    { render::vulkan_backend::enumerate_native_vulkan_swapchain_images(
        native_swapchain_operation,
        native_images_execution_request) } -> std::same_as<
        render::vulkan_backend::vulkan_native_swapchain_images_execution_result>;
    { render::vulkan_backend::acquire_native_vulkan_swapchain_image(
        native_swapchain_operation,
        native_acquire_execution_request) } -> std::same_as<
        render::vulkan_backend::vulkan_native_swapchain_acquire_execution_result>;
    { render::vulkan_backend::create_native_vulkan_swapchain_image_view_targets(
        native_swapchain_operation,
        native_image_view_targets_request) } -> std::same_as<
        render::vulkan_backend::vulkan_native_swapchain_image_view_targets_execution_result>;
    { render::vulkan_backend::destroy_native_vulkan_swapchain_image_view_targets(
        native_swapchain_operation,
        native_image_view_targets_destroy_request) } -> std::same_as<
        render::vulkan_backend::vulkan_native_swapchain_image_view_targets_destroy_result>;
    { render::vulkan_backend::build_vulkan_native_swapchain_images_operation_plan(
        native_images_request) } -> std::same_as<
        render::vulkan_backend::vulkan_native_swapchain_images_operation_result>;
    { render::vulkan_backend::build_vulkan_native_swapchain_acquire_operation_plan(
        native_acquire_request) } -> std::same_as<
        render::vulkan_backend::vulkan_native_swapchain_acquire_operation_result>;
});
...
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_command_packet_execution_status::completed),
...
static_assert(requires(render::vulkan_backend::vulkan_native_command_packet_execution_status status) {
    { render::vulkan_backend::native_command_packet_execution_status_name(status) }
        -> std::same_as<std::string_view>;
});
...
static_assert(std::same_as<
    ...
    render::vulkan_backend::vulkan_native_command_packet_call_kind>);
static_assert(requires(render::vulkan_backend::vulkan_native_command_packet_call_kind kind) {
    { render::vulkan_backend::native_command_packet_call_kind_name(kind) }
        -> std::same_as<std::string_view>;
});

static_assert(requires(render::vulkan_backend::vulkan_native_descriptor_set_handle handle) {
    { handle.value } -> std::same_as<std::uintptr_t&>;
    { handle.valid() } -> std::same_as<bool>;
});

static_assert(requires(render::vulkan_backend::vulkan_native_command_packet_descriptor_set descriptor_set) {
    { descriptor_set.packet_index } -> std::same_as<std::size_t&>;
    { descriptor_set.set } -> std::same_as<std::size_t&>;
...
static_assert(requires(render::vulkan_backend::vulkan_native_descriptor_image_view_handle handle) {
    { handle.value } -> std::same_as<std::uintptr_t&>;
    { handle.valid() } -> std::same_as<bool>;
});

static_assert(requires(render::vulkan_backend::vulkan_native_descriptor_sampler_handle handle) {
    { handle.value } -> std::same_as<std::uintptr_t&>;
    { handle.valid() } -> std::same_as<bool>;
});

static_assert(requires(render::vulkan_backend::vulkan_native_descriptor_image_layout layout) {
    { layout.value } -> std::same_as<std::uint32_t&>;
    { layout.valid() } -> std::same_as<bool>;
});

static_assert(requires(render::vulkan_backend::vulkan_native_image_descriptor_resource resource) {
    { resource.texture_resource_id } -> std::same_as<std::string&>;
    { resource.sampler_resource_id } -> std::same_as<std::string&>;
    { resource.image_view }
    ...
    { resource.available } -> std::same_as<bool&>;
    { resource.diagnostic } -> std::same_as<std::string&>;
    { resource.completed() } -> std::same_as<bool>;
});

static_assert(requires(render::vulkan_backend::vulkan_native_image_descriptor_resource_evidence evidence) {
    { evidence.checked } -> std::same_as<bool&>;
    { evidence.resources }
        -> std::same_as<std::vector<render::vulkan_backend::vulkan_native_image_descriptor_resource>&>;
    { evidence.diagnostic } -> std::same_as<std::string&>;
    { evidence.completed() } -> std::same_as<bool>;
});

static_assert(requires(render::vulkan_backend::vulkan_native_descriptor_buffer_handle handle) {
    { handle.value } -> std::same_as<std::uintptr_t&>;
    { handle.valid() } -> std::same_as<bool>;
});

static_assert(requires(render::vulkan_backend::vulkan_native_command_packet_descriptor_buffer_bind bind) {
    { bind.packet_index } -> std::same_as<std::size_t&>;
    { bind.command_index } -> std::same_as<std::size_t&>;
    { bind.set } -> std::same_as<std::size_t&>;
    { bind.binding } -> std::same_as<std::size_t&>;
    { bind.descriptor_kind }
        -> std::same_as<render::vulkan_backend::vulkan_resource_binding_kind&>;
    { bind.resource_id } -> std::same_as<std::string&>;
    { bind.payload_identity } -> std::same_as<std::string&>;
    { bind.descriptor_set }
        -> std::same_as<render::vulkan_backend::vulkan_native_descriptor_set_handle&>;
    { bind.buffer }
        -> std::same_as<render::vulkan_backend::vulkan_native_descriptor_buffer_handle&>;
    { bind.offset } -> std::same_as<std::size_t&>;
    { bind.range } -> std::same_as<std::size_t&>;
    { bind.required } -> std::same_as<bool&>;
    { bind.available } -> std::same_as<bool&>;
    { bind.allocation_ready } -> std::same_as<bool&>;
    { bind.bind_ready } -> std::same_as<bool&>;
    { bind.draw_ready } -> std::same_as<bool&>;
    { bind.diagnostic } -> std::same_as<std::string&>;
    { bind.completed() } -> std::same_as<bool>;
...
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_buffer_descriptor_allocation_status::ready),
    render::vulkan_backend::vulkan_native_buffer_descriptor_allocation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_buffer_descriptor_allocation_status::
...
static_assert(std::same_as<
    ...
    render::vulkan_backend::vulkan_native_buffer_descriptor_allocation_status>);
static_assert(requires(render::vulkan_backend::vulkan_native_buffer_descriptor_allocation_status status) {
    { render::vulkan_backend::native_buffer_descriptor_allocation_status_name(status) }
        -> std::same_as<std::string_view>;
});

static_assert(requires(render::vulkan_backend::vulkan_native_buffer_descriptor_fake_allocator_options options) {
    { options.first_buffer_handle } -> std::same_as<std::uintptr_t&>;
    { options.offset } -> std::same_as<std::size_t&>;
    { options.range } -> std::same_as<std::size_t&>;
});

static_assert(requires(render::vulkan_backend::vulkan_native_buffer_descriptor_allocation_operation operation) {
    ...
    { operation.set } -> std::same_as<std::size_t&>;
    { operation.binding } -> std::same_as<std::size_t&>;
    { operation.descriptor_kind }
        -> std::same_as<render::vulkan_backend::vulkan_resource_binding_kind&>;
    { operation.symbol_name } -> std::same_as<std::string&>;
    { operation.resource_id } -> std::same_as<std::string&>;
    { operation.payload_identity } -> std::same_as<std::string&>;
    { operation.native_function_table_checked } -> std::same_as<bool&>;
    { operation.native_descriptor_write_symbol_ready } -> std::same_as<bool&>;
    { operation.descriptor_payload_ready } -> std::same_as<bool&>;
    { operation.allocation_ready } -> std::same_as<bool&>;
    { operation.bind_ready } -> std::same_as<bool&>;
    { operation.draw_ready } -> std::same_as<bool&>;
    { operation.blocked } -> std::same_as<bool&>;
    { operation.diagnostic } -> std::same_as<std::string&>;
    { operation.descriptor_buffer_bind }
        -> std::same_as<render::vulkan_backend::vulkan_native_command_packet_descriptor_buffer_bind&>;
    { operation.completed() } -> std::same_as<bool>;
});

static_assert(requires(render::vulkan_backend::vulkan_native_buffer_descriptor_allocation_result result) {
    { result.checked } -> std::same_as<bool&>;
    { result.status }
        -> std::same_as<render::vulkan_backend::vulkan_native_buffer_descriptor_allocation_status&>;
    { result.fallback_reason }
        -> std::same_as<render::vulkan_backend::vulkan_backend_fallback_reason&>;
    { result.descriptor_write_payload_checked } -> std::same_as<bool&>;
    { result.descriptor_write_payload_ready } -> std::same_as<bool&>;
    { result.native_function_table_checked } -> std::same_as<bool&>;
    { result.native_descriptor_write_symbol_ready } -> std::same_as<bool&>;
    { result.missing_native_symbol_name } -> std::same_as<std::string&>;
    { result.planned_payload_count } -> std::same_as<std::size_t&>;
    { result.planned_buffer_descriptor_count } -> std::same_as<std::size_t&>;
    { result.operation_count } -> std::same_as<std::size_t&>;
    { result.allocated_buffer_descriptor_count } -> std::same_as<std::size_t&>;
    { result.bound_buffer_descriptor_count } -> std::same_as<std::size_t&>;
    { result.failed_operation_index } -> std::same_as<std::size_t&>;
    { result.failed_packet_index } -> std::same_as<std::size_t&>;
    { result.failed_command_index } -> std::same_as<std::size_t&>;
    { result.failed_set } -> std::same_as<std::size_t&>;
    { result.failed_binding } -> std::same_as<std::size_t&>;
    { result.failed_descriptor_kind }
        -> std::same_as<render::vulkan_backend::vulkan_resource_binding_kind&>;
    { result.failed_resource_id } -> std::same_as<std::string&>;
    { result.failed_payload_identity } -> std::same_as<std::string&>;
    { result.diagnostic } -> std::same_as<std::string&>;
    { result.operations }
        -> std::same_as<std::vector<render::vulkan_backend::vulkan_native_buffer_descriptor_allocation_operation>&>;
    { result.descriptor_buffer_binds }
        -> std::same_as<std::vector<render::vulkan_backend::vulkan_native_command_packet_descriptor_buffer_bind>&>;
    { result.completed() } -> std::same_as<bool>;
});

static_assert(requires(render::vulkan_backend::vulkan_native_descriptor_write_payload payload) {
    { payload.packet_index } -> std::same_as<std::size_t&>;
    { payload.command_index } -> std::same_as<std::size_t&>;
    { payload.set } -> std::same_as<std::size_t&>;
    { payload.binding } -> std::same_as<std::size_t&>;
    { payload.descriptor_kind }
        -> std::same_as<render::vulkan_backend::vulkan_resource_binding_kind&>;
    { payload.resource_id } -> std::same_as<std::string&>;
    ...
    { payload.image_layout }
        -> std::same_as<render::vulkan_backend::vulkan_native_descriptor_image_layout&>;
    { payload.required } -> std::same_as<bool&>;
    { payload.available } -> std::same_as<bool&>;
    { payload.blocked } -> std::same_as<bool&>;
    { payload.diagnostic } -> std::same_as<std::string&>;
    { payload.completed() } -> std::same_as<bool>;
});

static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_descriptor_write_payload_status::ready),
    render::vulkan_backend::vulkan_native_descriptor_write_payload_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_descriptor_write_payload_status::
...
static_assert(std::same_as<
    ...
    render::vulkan_backend::vulkan_native_descriptor_write_payload_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_descriptor_write_payload_status::duplicate_payload),
    render::vulkan_backend::vulkan_native_descriptor_write_payload_status>);
static_assert(requires(render::vulkan_backend::vulkan_native_descriptor_write_payload_status status) {
    { render::vulkan_backend::native_descriptor_write_payload_status_name(status) }
        -> std::same_as<std::string_view>;
});

static_assert(requires(render::vulkan_backend::vulkan_native_descriptor_write_payload_handoff_result result) {
    { result.checked } -> std::same_as<bool&>;
    { result.status }
        -> std::same_as<render::vulkan_backend::vulkan_native_descriptor_write_payload_status&>;
    { result.fallback_reason }
        -> std::same_as<render::vulkan_backend::vulkan_backend_fallback_reason&>;
    { result.packet_bridge_checked } -> std::same_as<bool&>;
    { result.packet_bridge_ready } -> std::same_as<bool&>;
    { result.descriptor_set_allocation_checked } -> std::same_as<bool&>;
    { result.descriptor_set_allocation_ready } -> std::same_as<bool&>;
    { result.image_descriptor_resources_checked } -> std::same_as<bool&>;
    { result.image_descriptor_resources_ready } -> std::same_as<bool&>;
    { result.planned_packet_count } -> std::same_as<std::size_t&>;
    { result.planned_payload_count } -> std::same_as<std::size_t&>;
    { result.payload_count } -> std::same_as<std::size_t&>;
    { result.required_image_descriptor_payload_count } -> std::same_as<std::size_t&>;
    { result.ready_image_descriptor_payload_count } -> std::same_as<std::size_t&>;
    { result.failed_packet_index } -> std::same_as<std::size_t&>;
    { result.failed_command_index } -> std::same_as<std::size_t&>;
    { result.failed_set } -> std::same_as<std::size_t&>;
    { result.failed_binding } -> std::same_as<std::size_t&>;
...
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_descriptor_payload_command_recording_status::ready),
    render::vulkan_backend::vulkan_native_descriptor_payload_command_recording_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_descriptor_payload_command_recording_status::
                 descriptor_write_payload_unavailable),
    render::vulkan_backend::vulkan_native_descriptor_payload_command_recording_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_descriptor_payload_command_recording_status::
...
static_assert(std::same_as<
    ...
    render::vulkan_backend::vulkan_native_descriptor_payload_command_recording_status>);
static_assert(requires(render::vulkan_backend::vulkan_native_descriptor_payload_command_recording_status status) {
    { render::vulkan_backend::native_descriptor_payload_command_recording_status_name(status) }
        -> std::same_as<std::string_view>;
});

static_assert(requires(render::vulkan_backend::vulkan_native_descriptor_payload_command_recording_packet packet) {
    ...
    { packet.descriptor_set_count } -> std::same_as<std::size_t&>;
    { packet.descriptor_write_payload_count } -> std::same_as<std::size_t&>;
    { packet.image_descriptor_write_payload_count } -> std::same_as<std::size_t&>;
    { packet.ready_image_descriptor_write_payload_count } -> std::same_as<std::size_t&>;
    { packet.operation_ready } -> std::same_as<bool&>;
    { packet.descriptor_sets_ready } -> std::same_as<bool&>;
    { packet.descriptor_write_payloads_ready } -> std::same_as<bool&>;
    { packet.image_descriptor_payloads_ready } -> std::same_as<bool&>;
    { packet.bind_ready } -> std::same_as<bool&>;
    { packet.draw_ready } -> std::same_as<bool&>;
...
static_assert(requires(render::vulkan_backend::vulkan_native_descriptor_payload_command_recording_result result) {
    { result.checked } -> std::same_as<bool&>;
    { result.status }
        -> std::same_as<render::vulkan_backend::vulkan_native_descriptor_payload_command_recording_status&>;
    { result.fallback_reason }
        -> std::same_as<render::vulkan_backend::vulkan_backend_fallback_reason&>;
    { result.packet_bridge_checked } -> std::same_as<bool&>;
    { result.packet_bridge_ready } -> std::same_as<bool&>;
    ...
    { result.planned_descriptor_set_count } -> std::same_as<std::size_t&>;
    { result.planned_descriptor_write_payload_count } -> std::same_as<std::size_t&>;
    { result.packet_count } -> std::same_as<std::size_t&>;
    { result.ready_packet_count } -> std::same_as<std::size_t&>;
    { result.bind_ready_packet_count } -> std::same_as<std::size_t&>;
    { result.draw_ready_packet_count } -> std::same_as<std::size_t&>;
    { result.descriptor_set_count } -> std::same_as<std::size_t&>;
    { result.descriptor_write_payload_count } -> std::same_as<std::size_t&>;
    { result.image_descriptor_write_payload_count } -> std::same_as<std::size_t&>;
    { result.ready_image_descriptor_write_payload_count } -> std::same_as<std::size_t&>;
    { result.failed_operation_index } -> std::same_as<std::size_t&>;
    { result.failed_packet_index } -> std::same_as<std::size_t&>;
    { result.failed_command_index } -> std::same_as<std::size_t&>;
    { result.failed_set } -> std::same_as<std::size_t&>;
    ...
    { result.failed_operation_kind }
        -> std::same_as<render::vulkan_backend::vulkan_command_recorder_operation_kind&>;
    { result.diagnostic } -> std::same_as<std::string&>;
    { result.packets }
        -> std::same_as<std::vector<render::vulkan_backend::vulkan_native_descriptor_payload_command_recording_packet>&>;
    { result.completed() } -> std::same_as<bool>;
});
...
static_assert(requires(render::vulkan_backend::vulkan_native_command_packet_executor_evidence evidence) {
    ...
    { evidence.command_buffer }
        -> std::same_as<render::vulkan_backend::vulkan_command_recording_command_buffer_handle&>;
    { evidence.pipeline }
        -> std::same_as<render::vulkan_backend::vulkan_graphics_pipeline_handle&>;
    { evidence.pipeline_layout }
        -> std::same_as<render::vulkan_backend::vulkan_pipeline_layout_handle&>;
    { evidence.viewport } -> std::same_as<render::render_rect&>;
...
static_assert(requires(
    ...
    const render::vulkan_backend::vulkan_native_image_descriptor_resource_evidence& image_descriptor_resources,
    ...
    const render::vulkan_backend::vulkan_native_buffer_descriptor_allocation_result& buffer_descriptors,
    render::vulkan_backend::vulkan_native_buffer_descriptor_fake_allocator_options buffer_options,
    ...
    { render::vulkan_backend::build_vulkan_native_command_packet_executor_evidence(
        ...
        render::vulkan_backend::vulkan_native_command_packet_executor_evidence>;
    { render::vulkan_backend::build_vulkan_native_descriptor_write_payload_handoff_result(
        bridge,
        allocation,
        image_descriptor_resources) } -> std::same_as<
        render::vulkan_backend::vulkan_native_descriptor_write_payload_handoff_result>;
    { render::vulkan_backend::merge_vulkan_native_descriptor_write_payload_handoff_result(
        evidence,
        descriptor_write_payloads) } -> std::same_as<
        render::vulkan_backend::vulkan_native_command_packet_executor_evidence>;
    { render::vulkan_backend::build_fake_vulkan_native_buffer_descriptor_allocation_result(
        descriptor_write_payloads,
        native_functions,
        buffer_options) } -> std::same_as<
        render::vulkan_backend::vulkan_native_buffer_descriptor_allocation_result>;
    { render::vulkan_backend::merge_vulkan_native_buffer_descriptor_allocation_result(
        evidence,
        buffer_descriptors) } -> std::same_as<
        render::vulkan_backend::vulkan_native_command_packet_executor_evidence>;
    { render::vulkan_backend::build_vulkan_native_descriptor_payload_command_recording_result(
        bridge,
        allocation,
        descriptor_write_payloads,
...
static_assert(requires(render::vulkan_backend::vulkan_native_command_packet_call_evidence call) {
    { call.kind }
        -> std::same_as<render::vulkan_backend::vulkan_native_command_packet_call_kind&>;
    { call.symbol_name } -> std::same_as<std::string&>;
    { call.command_buffer }
        -> std::same_as<render::vulkan_backend::vulkan_command_recording_command_buffer_handle&>;
    { call.pipeline }
        -> std::same_as<render::vulkan_backend::vulkan_graphics_pipeline_handle&>;
    { call.pipeline_layout }
        -> std::same_as<render::vulkan_backend::vulkan_pipeline_layout_handle&>;
...
static_assert(requires(render::vulkan_backend::vulkan_native_command_packet_execution_result result) {
    ...
    { result.packet_bridge_ready } -> std::same_as<bool&>;
    { result.native_function_table_checked } -> std::same_as<bool&>;
    { result.native_command_symbols_ready } -> std::same_as<bool&>;
    ...
    { result.first_failed_category }
        -> std::same_as<render::vulkan_backend::vulkan_command_packet_category&>;
    { result.first_failed_batch_kind }
        -> std::same_as<render::vulkan_backend::vulkan_batch_kind&>;
    { result.first_failed_packet_index } -> std::same_as<std::size_t&>;
    { result.first_failed_command_index } -> std::same_as<std::size_t&>;
    { result.planned_packet_count } -> std::same_as<std::size_t&>;
    { result.attempted_packet_count } -> std::same_as<std::size_t&>;
    { result.translated_packet_count } -> std::same_as<std::size_t&>;
    { result.attempted_native_call_count } -> std::same_as<std::size_t&>;
    { result.completed_native_call_count } -> std::same_as<std::size_t&>;
    { result.diagnostic } -> std::same_as<std::string&>;
    { result.calls }
...
static_assert(VulkanCommandPacketExecutorInterface<
              render::vulkan_backend::vulkan_native_command_packet_executor>);
...
static_assert(std::constructible_from<
    render::vulkan_backend::vulkan_native_command_packet_executor,
    render::vulkan_backend::vulkan_native_command_packet_executor_evidence>);
static_assert(requires(render::vulkan_backend::vulkan_native_command_packet_executor executor) {
    { executor.native_execution_result() }
        -> std::same_as<const render::vulkan_backend::vulkan_native_command_packet_execution_result&>;
});

static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_scoped_command_packet_execution_status::completed),
    render::vulkan_backend::vulkan_scoped_command_packet_execution_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_scoped_command_packet_execution_status::packet_failed),
    render::vulkan_backend::vulkan_scoped_command_packet_execution_status>);
static_assert(requires(
    render::vulkan_backend::vulkan_scoped_command_packet_execution_status status) {
    { render::vulkan_backend::scoped_command_packet_execution_status_name(status) }
        -> std::same_as<std::string_view>;
});

static_assert(requires(
    render::vulkan_backend::vulkan_scoped_command_packet_execution_request request) {
    { request.render_pass_scope }
        -> std::same_as<render::vulkan_backend::vulkan_native_render_pass_scope_record_result&>;
    { request.packet_bridge }
        -> std::same_as<render::vulkan_backend::vulkan_command_packet_bridge_result&>;
});

static_assert(requires(
    render::vulkan_backend::vulkan_scoped_command_packet_execution_result result) {
    { result.checked } -> std::same_as<bool&>;
    { result.status }
        -> std::same_as<render::vulkan_backend::vulkan_scoped_command_packet_execution_status&>;
    { result.fallback_reason }
        -> std::same_as<render::vulkan_backend::vulkan_backend_fallback_reason&>;
    { result.render_pass_scope }
        -> std::same_as<render::vulkan_backend::vulkan_native_render_pass_scope_record_result&>;
    { result.packet_bridge }
        -> std::same_as<render::vulkan_backend::vulkan_command_packet_bridge_result&>;
    { result.packet_execution }
        -> std::same_as<render::vulkan_backend::vulkan_command_packet_execution_result&>;
    { result.operation_plan }
        -> std::same_as<render::vulkan_backend::vulkan_command_recorder_operation_plan&>;
    { result.render_pass_scope_id } -> std::same_as<std::size_t&>;
    { result.selected_framebuffer_target_index } -> std::same_as<std::size_t&>;
    { result.image_id } -> std::same_as<render::vulkan_backend::vulkan_swapchain_image_id&>;
    { result.framebuffer } -> std::same_as<render::vulkan_backend::vulkan_framebuffer_handle&>;
    { result.command_buffer }
        -> std::same_as<render::vulkan_backend::vulkan_command_recording_command_buffer_handle&>;
    { result.render_pass_scope_checked } -> std::same_as<bool&>;
    { result.render_pass_scope_ready } -> std::same_as<bool&>;
    { result.command_buffer_ready } -> std::same_as<bool&>;
    { result.packet_bridge_checked } -> std::same_as<bool&>;
    { result.packet_bridge_ready } -> std::same_as<bool&>;
    { result.scoped_execution_empty } -> std::same_as<bool&>;
    { result.render_pass_begin_attempted } -> std::same_as<bool&>;
    { result.render_pass_begin_completed } -> std::same_as<bool&>;
    { result.render_pass_end_attempted } -> std::same_as<bool&>;
    { result.render_pass_end_completed } -> std::same_as<bool&>;
    { result.render_pass_end_skipped } -> std::same_as<bool&>;
    { result.packet_execution_checked } -> std::same_as<bool&>;
    { result.packet_execution_ready } -> std::same_as<bool&>;
    { result.operation_plan_checked } -> std::same_as<bool&>;
    { result.operation_plan_ready } -> std::same_as<bool&>;
    { result.has_failed_packet } -> std::same_as<bool&>;
    { result.first_failed_category }
...
static_assert(requires(
    render::vulkan_backend::vulkan_command_packet_executor_interface& executor,
    const render::vulkan_backend::vulkan_scoped_command_packet_execution_request& request) {
    { render::vulkan_backend::execute_vulkan_scoped_command_packets(executor, request) }
        -> std::same_as<render::vulkan_backend::vulkan_scoped_command_packet_execution_result>;
});
...
static_assert(requires(render::vulkan_backend::vulkan_command_buffer_record_result result) {
    ...
    { result.native_function_table_status }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_table_status&>;
    { result.missing_native_symbol_name } -> std::same_as<std::string&>;
    { result.sdk_native_path_checked } -> std::same_as<bool&>;
    { result.sdk_adapter_ready } -> std::same_as<bool&>;
    { result.sdk_native_path_status }
        -> std::same_as<render::vulkan_backend::vulkan_sdk_native_path_status&>;
    { result.sdk_capability_status }
        -> std::same_as<render::vulkan_backend::vulkan_sdk_capability_status&>;
    { result.sdk_adapter_fallback_status }
        -> std::same_as<render::vulkan_backend::vulkan_sdk_adapter_fallback_status&>;
    { result.sdk_diagnostic } -> std::same_as<std::string&>;
    { result.begin_attempted } -> std::same_as<bool&>;
    { result.begin_completed } -> std::same_as<bool&>;
    { result.end_attempted } -> std::same_as<bool&>;
    { result.end_completed } -> std::same_as<bool&>;
...
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_queue_present_operation_status::not_checked),
    render::vulkan_backend::vulkan_native_queue_present_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_queue_present_operation_status::ready),
    render::vulkan_backend::vulkan_native_queue_present_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_queue_present_operation_status::acquire_operation_unavailable),
    render::vulkan_backend::vulkan_native_queue_present_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_queue_present_operation_status::submit_batch_unavailable),
    render::vulkan_backend::vulkan_native_queue_present_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_queue_present_operation_status::present_completion_unavailable),
    render::vulkan_backend::vulkan_native_queue_present_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_queue_present_operation_status::native_entrypoints_unavailable),
    render::vulkan_backend::vulkan_native_queue_present_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_queue_present_operation_status::required_extension_unavailable),
    render::vulkan_backend::vulkan_native_queue_present_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_queue_present_operation_status::missing_queue_present_symbol),
    render::vulkan_backend::vulkan_native_queue_present_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_queue_present_operation_status::present_queue_unavailable),
    render::vulkan_backend::vulkan_native_queue_present_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_queue_present_operation_status::swapchain_unavailable),
    render::vulkan_backend::vulkan_native_queue_present_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_queue_present_operation_status::acquired_image_unavailable),
    render::vulkan_backend::vulkan_native_queue_present_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_queue_present_operation_status::submitted_frame_unavailable),
    render::vulkan_backend::vulkan_native_queue_present_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_queue_present_operation_status::present_result_unavailable),
    render::vulkan_backend::vulkan_native_queue_present_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_queue_present_operation_status::out_of_date),
    render::vulkan_backend::vulkan_native_queue_present_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_queue_present_operation_status::suboptimal),
    render::vulkan_backend::vulkan_native_queue_present_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_queue_present_operation_status::present_failed_recoverable),
    render::vulkan_backend::vulkan_native_queue_present_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_queue_present_operation_status::present_failed_fatal),
    render::vulkan_backend::vulkan_native_queue_present_operation_status>);

static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_frame_operation_stage::not_started),
    render::vulkan_backend::vulkan_native_frame_operation_stage>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_frame_operation_stage::native_function_table),
    render::vulkan_backend::vulkan_native_frame_operation_stage>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_frame_operation_stage::swapchain_create),
    render::vulkan_backend::vulkan_native_frame_operation_stage>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_frame_operation_stage::swapchain_images),
    render::vulkan_backend::vulkan_native_frame_operation_stage>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_frame_operation_stage::acquire),
    render::vulkan_backend::vulkan_native_frame_operation_stage>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_frame_operation_stage::command_recording),
    render::vulkan_backend::vulkan_native_frame_operation_stage>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_frame_operation_stage::submit),
    render::vulkan_backend::vulkan_native_frame_operation_stage>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_frame_operation_stage::present),
    render::vulkan_backend::vulkan_native_frame_operation_stage>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_frame_operation_stage::frame_completion),
    render::vulkan_backend::vulkan_native_frame_operation_stage>);

static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_frame_operation_status::not_checked),
    render::vulkan_backend::vulkan_native_frame_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_frame_operation_status::ready),
    render::vulkan_backend::vulkan_native_frame_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_frame_operation_status::native_function_table_unavailable),
    render::vulkan_backend::vulkan_native_frame_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_frame_operation_status::swapchain_create_unavailable),
    render::vulkan_backend::vulkan_native_frame_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_frame_operation_status::swapchain_images_unavailable),
    render::vulkan_backend::vulkan_native_frame_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_frame_operation_status::acquire_unavailable),
    render::vulkan_backend::vulkan_native_frame_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_frame_operation_status::command_recording_unavailable),
    render::vulkan_backend::vulkan_native_frame_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_frame_operation_status::submit_unavailable),
    render::vulkan_backend::vulkan_native_frame_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_frame_operation_status::present_unavailable),
    render::vulkan_backend::vulkan_native_frame_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_frame_operation_status::frame_completion_unavailable),
    render::vulkan_backend::vulkan_native_frame_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_frame_operation_status::recoverable_failure),
    render::vulkan_backend::vulkan_native_frame_operation_status>);
static_assert(std::same_as<
    decltype(render::vulkan_backend::vulkan_native_frame_operation_status::fatal_failure),
    render::vulkan_backend::vulkan_native_frame_operation_status>);
...
static_assert(requires(
    ...
    render::vulkan_backend::vulkan_native_queue_present_operation_status native_present_status,
    render::vulkan_backend::vulkan_native_frame_operation_stage native_frame_stage,
    render::vulkan_backend::vulkan_native_frame_operation_status native_frame_status) {
    ...
    { render::vulkan_backend::frame_completion_status_name(frame_status) }
        -> std::same_as<std::string_view>;
    { render::vulkan_backend::native_queue_present_operation_status_name(native_present_status) }
        -> std::same_as<std::string_view>;
    { render::vulkan_backend::native_frame_operation_stage_name(native_frame_stage) }
        -> std::same_as<std::string_view>;
    { render::vulkan_backend::native_frame_operation_status_name(native_frame_status) }
        -> std::same_as<std::string_view>;
});
...
static_assert(requires(render::vulkan_backend::vulkan_submit_batch_plan_result plan) {
    ...
    { plan.sdk_native_path_checked } -> std::same_as<bool&>;
    { plan.sdk_adapter_ready } -> std::same_as<bool&>;
    { plan.sdk_native_path_status }
        -> std::same_as<render::vulkan_backend::vulkan_sdk_native_path_status&>;
    { plan.sdk_capability_status }
        -> std::same_as<render::vulkan_backend::vulkan_sdk_capability_status&>;
    { plan.sdk_adapter_fallback_status }
        -> std::same_as<render::vulkan_backend::vulkan_sdk_adapter_fallback_status&>;
    { plan.sdk_diagnostic } -> std::same_as<std::string&>;
...
static_assert(requires(render::vulkan_backend::vulkan_present_request_summary request) {
    ...
    { request.present_queue_family_index } -> std::same_as<std::size_t&>;
    { request.present_queue_family_ready } -> std::same_as<bool&>;
    { request.swapchain } -> std::same_as<render::vulkan_backend::vulkan_swapchain_handle&>;
    { request.acquired_image_index } -> std::same_as<std::size_t&>;
    { request.image_id } -> std::same_as<render::vulkan_backend::vulkan_swapchain_image_id&>;
    { request.image_handle }
    ...
    { request.wait_render_finished_semaphore }
        -> std::same_as<render::vulkan_backend::vulkan_command_submit_sync_handle&>;
    { request.wait_intent_count } -> std::same_as<std::size_t&>;
    { request.signal_intent_count } -> std::same_as<std::size_t&>;
    { request.command_submit_ready } -> std::same_as<bool&>;
    { request.submitted_frame_ready } -> std::same_as<bool&>;
...
static_assert(requires(render::vulkan_backend::vulkan_native_queue_present_operation_request request) {
    { request.acquire_operation }
        -> std::same_as<render::vulkan_backend::vulkan_native_swapchain_acquire_operation_result&>;
    { request.submit_batch }
        -> std::same_as<render::vulkan_backend::vulkan_submit_batch_plan_result&>;
    { request.present_completion }
        -> std::same_as<render::vulkan_backend::vulkan_present_completion_plan_result&>;
    { request.native_entrypoints }
        -> std::same_as<render::vulkan_backend::vulkan_native_swapchain_entrypoint_readiness&>;
    { request.present_result }
        -> std::same_as<render::vulkan_backend::vulkan_swapchain_present_result&>;
    { request.allow_suboptimal } -> std::same_as<bool&>;
});

static_assert(requires(render::vulkan_backend::vulkan_native_queue_present_operation_summary summary) {
    { summary.checked } -> std::same_as<bool&>;
    { summary.status }
        -> std::same_as<render::vulkan_backend::vulkan_native_queue_present_operation_status&>;
    { summary.entrypoint_name } -> std::same_as<std::string&>;
    { summary.vk_queue_present_callable } -> std::same_as<bool&>;
    { summary.frame_lifecycle_may_complete } -> std::same_as<bool&>;
    { summary.device } -> std::same_as<render::vulkan_backend::vulkan_device_handle&>;
    { summary.swapchain } -> std::same_as<render::vulkan_backend::vulkan_swapchain_handle&>;
    { summary.present_queue } -> std::same_as<render::vulkan_backend::vulkan_queue_handle&>;
    { summary.present_queue_family_index } -> std::same_as<std::size_t&>;
    { summary.present_queue_family_ready } -> std::same_as<bool&>;
    { summary.acquired_image_index } -> std::same_as<std::size_t&>;
    { summary.image_id } -> std::same_as<render::vulkan_backend::vulkan_swapchain_image_id&>;
    { summary.image_handle } -> std::same_as<render::vulkan_backend::vulkan_swapchain_image_handle&>;
    { summary.wait_render_finished_semaphore }
        -> std::same_as<render::vulkan_backend::vulkan_command_submit_sync_handle&>;
    { summary.present_status }
        -> std::same_as<render::vulkan_backend::vulkan_swapchain_present_status&>;
    { summary.acquire_operation_checked } -> std::same_as<bool&>;
    { summary.acquired_image_ready } -> std::same_as<bool&>;
    { summary.submit_batch_checked } -> std::same_as<bool&>;
    { summary.submit_batch_ready } -> std::same_as<bool&>;
    { summary.present_completion_checked } -> std::same_as<bool&>;
    { summary.present_completion_ready } -> std::same_as<bool&>;
    { summary.native_entrypoints_checked } -> std::same_as<bool&>;
    { summary.required_extensions_ready } -> std::same_as<bool&>;
    { summary.queue_present_symbol_ready } -> std::same_as<bool&>;
    { summary.present_queue_ready } -> std::same_as<bool&>;
    { summary.swapchain_ready } -> std::same_as<bool&>;
    { summary.submitted_frame_ready } -> std::same_as<bool&>;
    { summary.present_request_ready } -> std::same_as<bool&>;
    { summary.present_adapter_result_ready } -> std::same_as<bool&>;
    { summary.acquired_image_index_ready } -> std::same_as<bool&>;
    { summary.acquired_image_handle_ready } -> std::same_as<bool&>;
    { summary.command_submit_ready } -> std::same_as<bool&>;
    { summary.present_wait_intent_ready } -> std::same_as<bool&>;
    { summary.present_signal_intent_ready } -> std::same_as<bool&>;
    { summary.present_execution_ready } -> std::same_as<bool&>;
    { summary.present_result_checked } -> std::same_as<bool&>;
    { summary.present_result_completed } -> std::same_as<bool&>;
    { summary.submit_before_present } -> std::same_as<bool&>;
    { summary.out_of_date } -> std::same_as<bool&>;
    { summary.suboptimal } -> std::same_as<bool&>;
    { summary.recoverable_failure } -> std::same_as<bool&>;
    ...
    { summary.missing_symbol_name } -> std::same_as<std::string&>;
    { summary.diagnostic } -> std::same_as<std::string&>;
    { summary.ready_for_frame_completion() } -> std::same_as<bool>;
});

static_assert(requires(render::vulkan_backend::vulkan_native_queue_present_operation_result result) {
    { result.checked } -> std::same_as<bool&>;
    { result.status }
        -> std::same_as<render::vulkan_backend::vulkan_native_queue_present_operation_status&>;
    ...
    { result.submit_batch }
        -> std::same_as<render::vulkan_backend::vulkan_submit_batch_plan_result&>;
    { result.present_completion }
        -> std::same_as<render::vulkan_backend::vulkan_present_completion_plan_result&>;
    { result.native_entrypoints }
        -> std::same_as<render::vulkan_backend::vulkan_native_swapchain_entrypoint_readiness&>;
    { result.device } -> std::same_as<render::vulkan_backend::vulkan_device_handle&>;
    { result.swapchain } -> std::same_as<render::vulkan_backend::vulkan_swapchain_handle&>;
    { result.present_queue } -> std::same_as<render::vulkan_backend::vulkan_queue_handle&>;
    { result.present_queue_family_index } -> std::same_as<std::size_t&>;
    { result.present_queue_family_ready } -> std::same_as<bool&>;
    { result.acquired_image_index } -> std::same_as<std::size_t&>;
    { result.image_id } -> std::same_as<render::vulkan_backend::vulkan_swapchain_image_id&>;
    { result.image_handle } -> std::same_as<render::vulkan_backend::vulkan_swapchain_image_handle&>;
    { result.wait_render_finished_semaphore }
        -> std::same_as<render::vulkan_backend::vulkan_command_submit_sync_handle&>;
    { result.present_status }
        -> std::same_as<render::vulkan_backend::vulkan_swapchain_present_status&>;
    { result.acquire_operation_checked } -> std::same_as<bool&>;
    { result.acquired_image_ready } -> std::same_as<bool&>;
    { result.submit_batch_checked } -> std::same_as<bool&>;
    { result.submit_batch_ready } -> std::same_as<bool&>;
    { result.present_completion_checked } -> std::same_as<bool&>;
    { result.present_completion_ready } -> std::same_as<bool&>;
    { result.native_entrypoints_checked } -> std::same_as<bool&>;
    { result.required_extensions_ready } -> std::same_as<bool&>;
    { result.queue_present_symbol_ready } -> std::same_as<bool&>;
    { result.present_queue_ready } -> std::same_as<bool&>;
    { result.swapchain_ready } -> std::same_as<bool&>;
    { result.submitted_frame_ready } -> std::same_as<bool&>;
    { result.present_request_ready } -> std::same_as<bool&>;
    { result.present_adapter_result_ready } -> std::same_as<bool&>;
    { result.acquired_image_index_ready } -> std::same_as<bool&>;
    { result.acquired_image_handle_ready } -> std::same_as<bool&>;
    { result.command_submit_ready } -> std::same_as<bool&>;
    { result.present_wait_intent_ready } -> std::same_as<bool&>;
    { result.present_signal_intent_ready } -> std::same_as<bool&>;
    { result.present_execution_ready } -> std::same_as<bool&>;
    { result.present_result_checked } -> std::same_as<bool&>;
    { result.present_result_completed } -> std::same_as<bool&>;
    { result.submit_before_present } -> std::same_as<bool&>;
    { result.out_of_date } -> std::same_as<bool&>;
    { result.suboptimal } -> std::same_as<bool&>;
    { result.recoverable_failure } -> std::same_as<bool&>;
    { result.fatal_failure } -> std::same_as<bool&>;
    { result.vk_queue_present_callable } -> std::same_as<bool&>;
    { result.frame_lifecycle_may_complete } -> std::same_as<bool&>;
    { result.missing_required_extension } -> std::same_as<std::string&>;
    { result.missing_symbol_name } -> std::same_as<std::string&>;
    { result.diagnostic } -> std::same_as<std::string&>;
    { result.operation }
        -> std::same_as<render::vulkan_backend::vulkan_native_queue_present_operation_summary&>;
    { result.can_call_vk_queue_present() } -> std::same_as<bool>;
    { result.ready_for_frame_completion() } -> std::same_as<bool>;
    { result.blocked() } -> std::same_as<bool>;
});

static_assert(requires(render::vulkan_backend::vulkan_native_frame_operation_stage_summary stage) {
    { stage.stage } -> std::same_as<render::vulkan_backend::vulkan_native_frame_operation_stage&>;
    { stage.checked } -> std::same_as<bool&>;
    { stage.ready } -> std::same_as<bool&>;
    { stage.blocked } -> std::same_as<bool&>;
    { stage.fallback_reason } -> std::same_as<render::vulkan_backend::vulkan_backend_fallback_reason&>;
    { stage.diagnostic } -> std::same_as<std::string&>;
    { stage.completed() } -> std::same_as<bool>;
});

static_assert(requires(render::vulkan_backend::vulkan_native_frame_operation_request request) {
    { request.native_functions }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_table_diagnostics&>;
    { request.swapchain_create }
        -> std::same_as<render::vulkan_backend::vulkan_native_swapchain_create_operation_result&>;
    { request.swapchain_images }
        -> std::same_as<render::vulkan_backend::vulkan_native_swapchain_images_operation_result&>;
    { request.acquire_operation }
        -> std::same_as<render::vulkan_backend::vulkan_native_swapchain_acquire_operation_result&>;
    { request.command_buffer_recording }
        -> std::same_as<render::vulkan_backend::vulkan_command_buffer_record_result&>;
    { request.submit_batch }
        -> std::same_as<render::vulkan_backend::vulkan_submit_batch_plan_result&>;
    { request.present_operation }
        -> std::same_as<render::vulkan_backend::vulkan_native_queue_present_operation_result&>;
    { request.cpu_fallback_available } -> std::same_as<bool&>;
});

static_assert(requires(render::vulkan_backend::vulkan_native_frame_operation_summary summary) {
    { summary.checked } -> std::same_as<bool&>;
    { summary.status }
        -> std::same_as<render::vulkan_backend::vulkan_native_frame_operation_status&>;
    { summary.reached_stage }
        -> std::same_as<render::vulkan_backend::vulkan_native_frame_operation_stage&>;
    { summary.blocker_stage }
        -> std::same_as<render::vulkan_backend::vulkan_native_frame_operation_stage&>;
    { summary.fallback_reason } -> std::same_as<render::vulkan_backend::vulkan_backend_fallback_reason&>;
    { summary.native_function_table_checked } -> std::same_as<bool&>;
    { summary.native_function_table_ready } -> std::same_as<bool&>;
    { summary.swapchain_create_checked } -> std::same_as<bool&>;
    { summary.swapchain_create_ready } -> std::same_as<bool&>;
    { summary.swapchain_images_checked } -> std::same_as<bool&>;
    { summary.swapchain_images_ready } -> std::same_as<bool&>;
    { summary.acquire_checked } -> std::same_as<bool&>;
    { summary.acquire_ready } -> std::same_as<bool&>;
    { summary.command_recording_checked } -> std::same_as<bool&>;
    { summary.command_recording_ready } -> std::same_as<bool&>;
    { summary.submit_batch_checked } -> std::same_as<bool&>;
    { summary.submit_batch_ready } -> std::same_as<bool&>;
    { summary.present_operation_checked } -> std::same_as<bool&>;
    { summary.present_operation_ready } -> std::same_as<bool&>;
    { summary.frame_completion_ready } -> std::same_as<bool&>;
    { summary.recoverable_failure } -> std::same_as<bool&>;
    { summary.fatal_failure } -> std::same_as<bool&>;
    { summary.swapchain_out_of_date } -> std::same_as<bool&>;
    { summary.suboptimal } -> std::same_as<bool&>;
    { summary.cpu_fallback_available } -> std::same_as<bool&>;
    { summary.cpu_fallback_should_remain_active } -> std::same_as<bool&>;
    { summary.native_function_table_status }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_table_status&>;
    { summary.missing_required_extension } -> std::same_as<std::string&>;
    { summary.missing_symbol_name } -> std::same_as<std::string&>;
    { summary.stages }
        -> std::same_as<std::vector<render::vulkan_backend::vulkan_native_frame_operation_stage_summary>&>;
    { summary.diagnostic } -> std::same_as<std::string&>;
    { summary.completed() } -> std::same_as<bool>;
});

static_assert(requires(render::vulkan_backend::vulkan_native_frame_operation_result result) {
    { result.checked } -> std::same_as<bool&>;
    { result.status }
        -> std::same_as<render::vulkan_backend::vulkan_native_frame_operation_status&>;
    { result.native_functions }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_table_diagnostics&>;
    { result.swapchain_create }
        -> std::same_as<render::vulkan_backend::vulkan_native_swapchain_create_operation_result&>;
    { result.swapchain_images }
        -> std::same_as<render::vulkan_backend::vulkan_native_swapchain_images_operation_result&>;
    { result.acquire_operation }
        -> std::same_as<render::vulkan_backend::vulkan_native_swapchain_acquire_operation_result&>;
    ...
    { result.submit_batch }
        -> std::same_as<render::vulkan_backend::vulkan_submit_batch_plan_result&>;
    { result.present_operation }
        -> std::same_as<render::vulkan_backend::vulkan_native_queue_present_operation_result&>;
    { result.reached_stage }
        -> std::same_as<render::vulkan_backend::vulkan_native_frame_operation_stage&>;
    { result.blocker_stage }
        -> std::same_as<render::vulkan_backend::vulkan_native_frame_operation_stage&>;
    { result.fallback_reason } -> std::same_as<render::vulkan_backend::vulkan_backend_fallback_reason&>;
    { result.native_function_table_checked } -> std::same_as<bool&>;
    { result.native_function_table_ready } -> std::same_as<bool&>;
    { result.swapchain_create_checked } -> std::same_as<bool&>;
    { result.swapchain_create_ready } -> std::same_as<bool&>;
    { result.swapchain_images_checked } -> std::same_as<bool&>;
    { result.swapchain_images_ready } -> std::same_as<bool&>;
    { result.acquire_checked } -> std::same_as<bool&>;
    { result.acquire_ready } -> std::same_as<bool&>;
    { result.command_recording_checked } -> std::same_as<bool&>;
    { result.command_recording_ready } -> std::same_as<bool&>;
    { result.submit_batch_checked } -> std::same_as<bool&>;
    { result.submit_batch_ready } -> std::same_as<bool&>;
    { result.present_operation_checked } -> std::same_as<bool&>;
    { result.present_operation_ready } -> std::same_as<bool&>;
    { result.frame_completion_ready } -> std::same_as<bool&>;
    { result.recoverable_failure } -> std::same_as<bool&>;
    { result.fatal_failure } -> std::same_as<bool&>;
    { result.swapchain_out_of_date } -> std::same_as<bool&>;
    { result.suboptimal } -> std::same_as<bool&>;
    { result.cpu_fallback_available } -> std::same_as<bool&>;
    { result.cpu_fallback_should_remain_active } -> std::same_as<bool&>;
    { result.native_function_table_status }
        -> std::same_as<render::vulkan_backend::vulkan_native_function_table_status&>;
    { result.missing_required_extension } -> std::same_as<std::string&>;
    { result.missing_symbol_name } -> std::same_as<std::string&>;
...
static_assert(requires(
    ...
    { summary.fallback_reason }
        -> std::same_as<render::vulkan_backend::vulkan_backend_fallback_reason&>;
    { summary.render_pass_scope_ready } -> std::same_as<bool&>;
    { summary.command_buffer_ready } -> std::same_as<bool&>;
    { summary.packet_bridge_ready } -> std::same_as<bool&>;
    { summary.packet_execution_ready } -> std::same_as<bool&>;
    { summary.operation_plan_ready } -> std::same_as<bool&>;
    { summary.render_pass_begin_completed } -> std::same_as<bool&>;
    { summary.render_pass_end_completed } -> std::same_as<bool&>;
    ...
    { summary.first_failed_category }
        -> std::same_as<render::vulkan_backend::vulkan_command_packet_category&>;
    { summary.first_failed_batch_kind }
        -> std::same_as<render::vulkan_backend::vulkan_batch_kind&>;
    { summary.first_failed_packet_index } -> std::same_as<std::size_t&>;
    { summary.first_failed_command_index } -> std::same_as<std::size_t&>;
    { summary.render_pass_scope_id } -> std::same_as<std::size_t&>;
    { summary.selected_framebuffer_target_index } -> std::same_as<std::size_t&>;
    { summary.image_id } -> std::same_as<render::vulkan_backend::vulkan_swapchain_image_id&>;
    { summary.framebuffer } -> std::same_as<render::vulkan_backend::vulkan_framebuffer_handle&>;
    { summary.command_buffer }
        -> std::same_as<render::vulkan_backend::vulkan_command_recording_command_buffer_handle&>;
    { summary.planned_packet_count } -> std::same_as<std::size_t&>;
    { summary.attempted_packet_count } -> std::same_as<std::size_t&>;
    { summary.executed_packet_count } -> std::same_as<std::size_t&>;
    { summary.rect_packet_count } -> std::same_as<std::size_t&>;
    { summary.text_packet_count } -> std::same_as<std::size_t&>;
    { summary.image_packet_count } -> std::same_as<std::size_t&>;
    { summary.debug_bounds_packet_count } -> std::same_as<std::size_t&>;
    { summary.diagnostic } -> std::same_as<std::string&>;
    { summary.completed() } -> std::same_as<bool>;
    { summary.failed() } -> std::same_as<bool>;
});
...
static_assert(requires(render::vulkan_backend::vulkan_backend_frame_pipeline_handoff handoff) {
    ...
    { handoff.native_function_table_checked } -> std::same_as<bool&>;
    { handoff.native_command_buffer_recording_ready } -> std::same_as<bool&>;
    { handoff.native_queue_submit_ready } -> std::same_as<bool&>;
    { handoff.native_queue_present_ready } -> std::same_as<bool&>;
    ...
    { handoff.scoped_command_packets }
        -> std::same_as<render::vulkan_backend::vulkan_backend_frame_scoped_command_packet_summary&>;
    { handoff.sdk_native_path_checked } -> std::same_as<bool&>;
    { handoff.sdk_adapter_ready } -> std::same_as<bool&>;
    { handoff.sdk_native_path_status }
        -> std::same_as<render::vulkan_backend::vulkan_sdk_native_path_status&>;
    { handoff.sdk_capability_status }
        -> std::same_as<render::vulkan_backend::vulkan_sdk_capability_status&>;
...
static_assert(requires(render::vulkan_backend::vulkan_backend_frame_result result) {
    ...
    { result.present_completion_plan }
        -> std::same_as<render::vulkan_backend::vulkan_present_completion_plan_result&>;
    { result.sdk_capabilities }
        -> std::same_as<render::vulkan_backend::vulkan_sdk_capability_result&>;
...
static_assert(requires(
    ...
    { render::vulkan_backend::build_vulkan_present_completion_plan(
        ...
        sdk_capabilities) }
        -> std::same_as<render::vulkan_backend::vulkan_present_completion_plan_result>;
    { render::vulkan_backend::build_vulkan_native_queue_present_operation_plan(
        render::vulkan_backend::vulkan_native_queue_present_operation_request{}) }
        -> std::same_as<render::vulkan_backend::vulkan_native_queue_present_operation_result>;
...
static_assert(requires(
    ...
    render::vulkan_backend::vulkan_scoped_command_packet_execution_result scoped_command_packets,
    render::vulkan_backend::vulkan_sdk_capability_result sdk_capabilities) {
    ...
    { render::vulkan_backend::apply_vulkan_scoped_command_packet_execution_result_to_frame(
        frame,
        scoped_command_packets) } -> std::same_as<render::vulkan_backend::vulkan_backend_frame_result>;
    { render::vulkan_backend::apply_vulkan_sdk_capability_result_to_frame(
        frame,
        sdk_capabilities) } -> std::same_as<render::vulkan_backend::vulkan_backend_frame_result>;
