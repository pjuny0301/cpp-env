...
```powershell
.\build\external\tools\bootstrap\setup_codex_env.ps1
```
...
For multi-agent work, keep the shared task brief in `codex/common/agent/shared_command.json` and have local agents read that file first.
