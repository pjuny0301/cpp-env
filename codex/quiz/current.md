...
- Latest integrated baseline includes architecture boundary locks, text line-break/glyph cache policy, image sampler/cache and decoder diagnostics, asset pack/manifest/runtime resolver validation, Vulkan frame lifecycle/resource diagnostics, input routing/action policy diagnostics, and procedural audio mixer event unification.
