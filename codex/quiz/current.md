...
- Latest verification: Windows MinGW focused Vulkan CTest passed 5/5 after `d229547` plus swapchain CMake FILE_SET registration; focused image CTest passed 3/3 after `f7c5bf1`; focused text CTest passed 2/2 after `d144683`; full CTest passed 52/52 after `c12ec31`; current `ctest -N` reports 54 tests.
