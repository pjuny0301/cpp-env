...
- Latest verification: Windows MinGW focused image CTest passed 2/2 after integrating standard decoder-backed texture pipeline. Current `ctest -N` reports 70 tests. Most recent full CTest remains 60/60 after `ddf7271`.
