...
- Latest verification: Windows MinGW focused text/image CTest passed 3/3 after `7004837` and `67d0552`; focused input CTest passed 3/3 after `e50a2b0`; focused Vulkan CTest passed 5/5 after `6bd7973`. Most recent full CTest passed 81/81 after `2656970`; current `ctest -N` reports 87 tests.
