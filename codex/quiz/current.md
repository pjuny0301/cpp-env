...
- Latest verification: Windows MinGW focused Vulkan CTest passed 3/3 after integrating shader module readiness boundary and registering its public header. Current `ctest -N` reports 72 tests. Most recent full CTest remains 60/60 after `ddf7271`.
