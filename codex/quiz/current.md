...
- Latest verification: Windows MinGW full CTest passed 60/60 after `ddf7271` plus command-recording CMake FILE_SET registration; focused Vulkan CTest passed 4/4, focused image CTest passed 2/2, focused text CTest passed 3/3; current `ctest -N` reports 60 tests.
