...
- Latest verification: Windows MinGW focused tests passed for Vulkan loader/renderer 2/2 and image cache/uploader/pipeline 4/4 after `977e907` and `554ea90`; current `ctest -N` reports 47 tests. The most recent full run before these focused changes passed 45/45.
