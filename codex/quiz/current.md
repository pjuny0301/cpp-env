...
- Latest verification: Windows MinGW focused text CTest passed 2/2 after `5c4d0d9`; focused image CTest passed 3/3 after `6201935`; focused input CTest passed 5/5 after `ba8bc04`; focused Vulkan CTest passed 4/4 after `85dd390`. Most recent full CTest passed 81/81 after `2656970`; current `ctest -N` reports 88 tests.
