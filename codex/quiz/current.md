...
- Latest verification: Windows MinGW focused text/Vulkan CTest passed 6/6 after integrating font backend capability diagnostics and Vulkan pipeline layout readiness boundary. Current `ctest -N` reports 75 tests. Most recent full CTest remains 60/60 after `ddf7271`.
