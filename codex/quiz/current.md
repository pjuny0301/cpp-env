...
- Latest verification: Windows MinGW focused text CTest passed 3/3 after `2751777` plus shaping-backend CMake FILE_SET registration; full CTest passed 60/60 after `ddf7271`; current `ctest -N` reports 61 tests.
