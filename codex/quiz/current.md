...
- Latest verification: Windows MinGW focused Vulkan CTest passed 2/2 after integrating queue submit adapter summary diagnostics. Current `ctest -N` reports 69 tests. Most recent full CTest remains 60/60 after `ddf7271`.
