...
- Latest integrated baseline includes architecture boundary locks, text line-break/glyph cache/font-resolution readiness policy, image sampler/cache/lifetime eviction and decoder diagnostics, asset pack index/validation/manifest/runtime resolver validation, Vulkan frame/pipeline lifecycle/resource diagnostics, input routing/action/text-edit/IME preedit policy diagnostics, and procedural audio mixer event unification.
