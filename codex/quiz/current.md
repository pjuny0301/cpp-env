...
- Latest verification: Windows MinGW focused image CTest passed 3/3 after `f7c5bf1` plus cache snapshot CMake FILE_SET registration; focused text CTest passed 2/2 after `d144683`; full CTest passed 52/52 after `c12ec31`; focused Vulkan CTest passed 4/4 after `8f80b6e`; current `ctest -N` reports 52 tests.
