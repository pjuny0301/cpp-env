...
- Latest verification: Windows MinGW focused tests passed for Vulkan instance/loader/renderer 3/3 after `e668cca`; current `ctest -N` reports 49 tests. The most recent full run before the latest focused changes passed 45/45.
