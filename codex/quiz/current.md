...
- Latest verification: Windows MinGW full build passed after the 2026-05-07 worker integrations, then full CTest passed with 45/45 tests. Use `ctest -N` for the authoritative current test list before editing docs.
