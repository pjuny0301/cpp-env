...
- Latest verification: Windows MinGW focused image/input CTest passed 13/13 after `85f4b86` and `7f3710b`; focused text CTest passed 1/1 after `fb8e404`; focused Vulkan CTest passed 5/5 after `9c8e7ed`. Most recent full CTest passed 81/81 after `2656970`; current `ctest -N` reports 86 tests.
