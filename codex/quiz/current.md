...
- Latest verification note: Windows MinGW full CTest passed `99/99` after input/text/image/Vulkan worker integrations; public FILE_SET registration scan reports 0 missing headers for input, render text, render image, render Vulkan, and assets.
