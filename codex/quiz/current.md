...
- Latest verification: Windows MinGW focused Vulkan CTest passed 2/2 after integrating queue submit/present adapter and CMake FILE_SET registration. Current `ctest -N` reports 67 tests. Most recent full CTest remains 60/60 after `ddf7271`.
