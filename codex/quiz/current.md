...
- Latest verification: Windows MinGW full CTest passed 54/54 after `695e323`; focused Vulkan CTest passed 5/5 after `d229547`; focused image CTest passed 3/3 after `f7c5bf1`; focused text CTest passed 2/2 after `d144683`; current `ctest -N` reports 54 tests.
