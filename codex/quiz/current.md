...
- Latest verification: Windows MinGW focused image build and CTest passed 5/5 for BMP decoder and related image cache/pipeline tests after `bbd8ecf`; current `ctest -N` reports 46 tests. The most recent full run before the BMP-focused change passed 45/45.
