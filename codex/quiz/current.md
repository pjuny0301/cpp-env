...
- Latest verification: Windows MinGW focused text CTest passed 3/3 after `c83ed69`; latest focused Vulkan CTest passed 3/3 after `20fc3e6`; latest full CTest passed 50/50 after `4f6af6e` and `1839aa5`; current `ctest -N` reports 51 tests.
