...
- Latest verification: Windows MinGW focused text/image CTest passed 5/5 after integrating font backend capability probe and image manifest texture pipeline boundary. Current `ctest -N` reports 73 tests. Most recent full CTest remains 60/60 after `ddf7271`.
