...
- Latest verification: Windows MinGW focused text CTest passed 3/3 after `ecacbb9`; focused image CTest passed 2/2 after `f9205e6` plus PNG chunk scanner CMake FILE_SET registration; full CTest passed 57/57 after `34af925`; current `ctest -N` reports 58 tests.
