...
- Latest verification: Windows MinGW focused image CTest passed 4/4 after splitting image manifest texture pipeline into its own public header and registering it. Current `ctest -N` reports 74 tests. Most recent full CTest remains 60/60 after `ddf7271`.
