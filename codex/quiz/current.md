...
- Latest verification: Windows MinGW focused text/image CTest passed 6/6 after integrating glyph-id resolver, standard image decoder chain, and CMake FILE_SET registrations. Current `ctest -N` reports 69 tests. Most recent full CTest remains 60/60 after `ddf7271`.
