...
- Latest verification: Windows MinGW focused image CTest passed 2/2 after integrating PNG zlib stored-block inflater and CMake FILE_SET registration. Current `ctest -N` reports 66 tests. Most recent full CTest remains 60/60 after `ddf7271`.
