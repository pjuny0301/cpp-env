...
- Latest verification: Windows MinGW full CTest passed 57/57 after `34af925` plus render-pass CMake FILE_SET registration; focused Vulkan CTest passed 6/6, focused image CTest passed 1/1, focused text CTest passed 1/1; current `ctest -N` reports 57 tests.
