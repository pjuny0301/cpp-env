...
- Latest verification: Windows MinGW focused image CTest passed 2/2 after `ce93465` plus PNG decode-boundary CMake FILE_SET registration; focused text CTest passed 3/3 after `ecacbb9`; full CTest passed 57/57 after `34af925`; current `ctest -N` reports 59 tests.
