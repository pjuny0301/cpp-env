...
- Latest verification: Windows MinGW focused tests passed for text SFNT/font-source byte loader 2/2 after `98a5e3d`; current `ctest -N` reports 48 tests. The most recent full run before the latest focused changes passed 45/45.
