...
- Latest verification: Windows MinGW focused text/Vulkan CTest passed 5/5 after integrating real font backend adapter and Vulkan graphics pipeline readiness boundary. Current `ctest -N` reports 77 tests. Most recent full CTest passed 76/76 after `be66895`.
