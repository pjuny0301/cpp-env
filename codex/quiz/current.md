...
- Latest verification: Windows MinGW focused input CTest passed 8/8 after integrating platform input translator boundary and registering its public header. Current `ctest -N` reports 74 tests. Most recent full CTest remains 60/60 after `ddf7271`.
