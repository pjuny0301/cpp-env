...
- Latest verification: Windows MinGW focused image CTest passed 4/4 after `31275c0`; focused Vulkan CTest passed 4/4 after `8f80b6e`; focused text CTest passed 2/2 after `87935ed`; latest full CTest passed 50/50 after `4f6af6e` and `1839aa5`; current `ctest -N` reports 52 tests.
