...
- Latest verification: Windows MinGW full CTest passed 52/52 after `c12ec31`; focused image CTest passed 4/4 after `31275c0`; focused Vulkan CTest passed 4/4 after `8f80b6e`; focused text CTest passed 2/2 after `87935ed`; current `ctest -N` reports 52 tests.
