...
- Latest verification: Windows MinGW focused text/image CTest passed 7/7 after integrating standard image pipeline cache-reuse diagnostics and resolved glyph-id atlas diagnostics. Current `ctest -N` reports 70 tests. Most recent full CTest remains 60/60 after `ddf7271`.
