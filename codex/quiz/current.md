...
- Latest verification: Windows MinGW focused text CTest passed 1/1 after `2f60e89`; focused Vulkan CTest passed 4/4 after `85dd390`; focused text/image CTest passed 4/4 after `ada6db8` and `f61ffe2`; focused input CTest passed 3/3 after `4afdd42`. Most recent full CTest passed 81/81 after `2656970`; current `ctest -N` reports 88 tests.
