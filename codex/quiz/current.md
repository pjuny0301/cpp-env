...
- Latest verification: Windows MinGW focused image CTest passed 2/2 after `e2dc64a` plus PNG unfilter CMake FILE_SET registration; focused text CTest passed 3/3 after `2751777`; full CTest passed 60/60 after `ddf7271`; current `ctest -N` reports 62 tests.
