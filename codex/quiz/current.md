...
- Latest verification: Windows MinGW focused input CTest passed 10/10 after integrating platform input boundary contract tests. Current `ctest -N` reports 78 tests. Most recent full CTest passed 76/76 after `be66895`.
