...
- 기준 검증 예시: 2026-05-07 Windows MinGW focused Vulkan CTest 5/5, focused image CTest 3/3, focused text CTest 2/2 통과 후, 직전 full CTest 52/52 통과. 현재 `ctest -N`이 54개 테스트를 보고한다. 권위 있는 테스트 목록은 항상 실행 시점의 `ctest -N`으로 확인한다.
