...
- Asset system: `apps/quiz/quiz-vulkan/src/assets/*`, `apps/quiz/quiz-vulkan/tests/assets/*`, asset manifest/runtime resolver/materialization/pack index/pack lookup/fallback/pack validation/catalog cache-key/cache-policy diagnostics
