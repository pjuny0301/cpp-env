...
- 기준 검증 예시: 2026-04-30 Windows MinGW full CTest `29/29` 통과. 현재 권위 있는 테스트 목록은 항상 `ctest -N`으로 확인한다.
...
- Text/Image engines: `apps/quiz/quiz-vulkan/src/render/text/*`, `apps/quiz/quiz-vulkan/src/render/image/*`, `apps/quiz/quiz-vulkan/tests/render/fake_text_engine_tests.cpp`, `apps/quiz/quiz-vulkan/tests/render/fake_image_texture_cache_tests.cpp`, glyph cache policy and decoder format diagnostics
