# Track A Stretch - Deck View Script Migration

## Completed

- Added `make_deck_view_screen_script_document` for selected-deck, missing-selection, and empty-days states.
- Routed `make_deck_view_screen_patch` and deck-view modifier updates through the app scene script compiler.
- Added a direct-vs-scripted placed-render equivalence test for the deck view screen.

## Commit

- `8481001` - Migrate deck view screen to scene script
